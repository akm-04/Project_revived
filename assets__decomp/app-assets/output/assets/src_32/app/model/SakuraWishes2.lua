local var_0_0 = class("SakuraWishes2", import(".BaseModel"))
local var_0_1 = xyd.Activities.SAKURA_WISHES2
...
function var_0_0.summonOne(arg_5_0, arg_5_1)
	...
	xyd.Backend.get():request(xyd.mid.CHEST_US2_AWARD, var_5_0, function(arg_6_0, arg_6_1)
		if arg_5_1 then
...
function var_0_0.summonTen(arg_7_0, arg_7_1)
	...
	xyd.Backend.get():request(xyd.mid.CHEST_US2_AWARD, var_7_0, function(arg_8_0, arg_8_1)
		if arg_7_1 then
...
function var_0_0.summonOneTicket(arg_9_0, arg_9_1)
	...
	xyd.Backend.get():request(xyd.mid.CHEST_US2_AWARD, var_9_0, function(arg_10_0, arg_10_1)
		if arg_9_1 then
...
function var_0_0.summonTenTicket(arg_11_0, arg_11_1)
	...
	xyd.Backend.get():request(xyd.mid.CHEST_US2_AWARD, var_11_0, function(arg_12_0, arg_12_1)
		if arg_11_1 then
...
function var_0_0.summonSuperRare(arg_13_0, arg_13_1)
	xyd.Backend.get():request(xyd.mid.SAKURA_WISHES2_SUPER_BONUS, {}, function(arg_14_0, arg_14_1)
		if arg_13_1 then
