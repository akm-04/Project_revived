local var_0_0 = class("StoneCampaignItem", function()
...
function var_0_0.layout(arg_5_0)
	...
	if arg_5_0.campaignType == 24 and not arg_5_0.isActivityItem then
		arg_5_0.contentView_:nodeByName(var_0_0.CAMPAIGN_TYPE):setString(var_0_1:translation("CHALLENGE"))
		arg_5_0.contentView_:nodeByName("left_times"):setString("")
	end
	...
	if arg_5_0.monsters and next(arg_5_0.monsters) and arg_5_0.monsters[#arg_5_0.monsters] > 0 then
		...
		xyd.setAvatarBorderNewUI(arg_5_0.monsters[var_5_2], arg_5_0.contentView_:nodeByName(var_0_0.ICON), arg_5_0.qualitys[var_5_2], arg_5_0.stars[var_5_2])
...
function var_0_0.contentView(arg_6_0)
	if arg_6_0.contentView_ == nil then
		...
		arg_6_0.contentView_:setupContentView_(xyd.AssetLoader.get():loadNodeFromJson("windows/hero/stone_campaign.csb"))
