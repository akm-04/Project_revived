...
function var_0_0.show(arg_1_0, arg_1_1)
	...
	local var_1_0 = xyd.AssetLoader.get():loadNodeFromJson("windows/activities/1006/1006.csb")
	...
	var_1_1:getChildByName("txt_2"):setString(xyd.tables.translation:translation("ACTIVITY_DESC"))
	...
	var_1_1:getChildByName("txt_name"):enableShadow(cc.c4b(134, 26, 26, 255), cc.size(2, -2))
	var_1_1:getChildByName("txt_intro"):enableShadow(cc.c4b(134, 26, 26, 255), cc.size(2, -2))
end
