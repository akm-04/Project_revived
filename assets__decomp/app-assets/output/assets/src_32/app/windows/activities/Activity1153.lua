...
function var_0_0.show(arg_2_0, arg_2_1)
	...
	var_2_1:getChildByName("desc"):setString(var_0_1:translation("VALENTINE2_TIPS_TXT5"))
	var_2_1:getChildByName("desc"):enableOutline(cc.c4b(255, 255, 255, 255), 2)
	...
	arg_2_0:initItems()
	var_2_1:getChildByName("item_list"):getChildByName("item_num_txt"):enableOutline(cc.c4b(145, 10, 64, 255), 2)
...
function var_0_0.registerButtons(arg_5_0)
	...
	var_5_0:getChildByName("give_btn"):addTouchEventListener(function(arg_6_0, arg_6_1)
		if arg_6_1 == ccui.TouchEventType.ended then
			if arg_5_0:checkActivityNotOpen() then
				return
			end

			xyd.WindowManager.get():openWindow("valentine2_give_gift_alert")
		end
	end)
	var_5_0:getChildByName("rank_btn"):addTouchEventListener(function(arg_7_0, arg_7_1)
		if arg_7_1 == ccui.TouchEventType.ended then
			if arg_5_0:checkActivityNotOpen() then
				return
			end

			xyd.Backend.get():request(xyd.mid.NEW_WHITE_DAY_RANK, {}, function(arg_8_0, arg_8_1)
...
function var_0_0.initItems(arg_10_0)
	local var_10_0 = arg_10_0.detail:getChildByName("container"):getChildByName("item_list")
	local var_10_1 = xyd.tables.misc.valentine2PresentItem
	local var_10_2 = var_10_0:getChildByName("item1")
	local var_10_3 = var_10_0:getChildByName("item_desc1")
	local var_10_4 = var_10_0:getChildByName("item_desc2")
	local var_10_5 = var_10_0:getChildByName("item_num_txt")

	var_10_2:setAnchorPoint(0.5, 0.5)
	var_10_2:setContentSize(95, 95)
	var_10_2:removeAllChildren()
	xyd.setItemAndAddTips(var_10_2, var_10_1)

	local var_10_6 = arg_10_0.selfPlayer:getBackpack():getItemNumByID(var_10_1)

	var_10_3:setString(xyd.tables.item:name(var_10_1))
	var_10_4:setString(var_0_1:translation("STICK_BLESS_FU_NUM"))
	var_10_5:setString(var_10_6)
end
