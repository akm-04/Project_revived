...
function var_0_0.show(arg_1_0, arg_1_1)
	...
	local var_1_0 = xyd.AssetLoader.get():loadNodeFromJson("windows/activities/1012/1012.csb")
	...
	var_1_1:getChildByName("txt_1"):enableShadow(cc.c4b(152, 66, 119, 255), cc.size(2, -2))
	var_1_1:getChildByName("txt_2"):enableShadow(cc.c4b(152, 66, 119, 255), cc.size(2, -2))
	var_1_1:getChildByName("txt_3"):enableShadow(cc.c4b(152, 66, 119, 255), cc.size(2, -2))
	var_1_1:getChildByName("txt_name"):enableShadow(cc.c4b(111, 75, 178, 255), cc.size(2, -2))
	var_1_1:getChildByName("txt_intro"):enableShadow(cc.c4b(111, 75, 178, 255), cc.size(2, -2))
	var_1_1:getChildByName("txt_tip"):enableShadow(cc.c4b(111, 75, 178, 255), cc.size(2, -2))
end
