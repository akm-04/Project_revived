...
local var_0_4 = xyd.tables.activityDongyunSouvenir2Login
...
function var_0_0.show(arg_2_0, arg_2_1)
	...
	arg_2_0.charge_id = 80008802
	arg_2_0.buyEndTime = xyd.tables.misc:getValue("activity_dongyun_souvenir2_day") * 60 * 60 * 24 + arg_2_0.activity.start_time
...
function var_0_0.layout(arg_3_0, arg_3_1, arg_3_2)
	...
	local var_3_21 = var_3_0:getContentSize()

	arg_3_0.awardList = cc.ui.UIListView.new({
		viewRect = cc.rect(0, 0, var_3_21.width, var_3_21.height),
		padding_ = {
			top = 0,
			bottom = 0,
			left = 0,
	...
	arg_3_0:addActivityAwardList(var_3_22)
end
...
function var_0_0.createAwardList(arg_6_0, arg_6_1)
	...
	for iter_6_0 = 1, var_6_2 do
		if arg_6_0:checkInitItem(iter_6_0, arg_6_1) then
			...
			local var_6_6 = xyd.AssetLoader.get():loadNodeFromJson("windows/activities/1181/activity_item.csb")
			local var_6_7 = var_6_6:getChildByName("container")

			arg_6_0:rewardItemLayout(var_6_1, var_6_7, var_6_3, iter_6_0)
			...
			var_6_5:setContentSize(667, 159)
			var_6_4:addContent(var_6_5)
			var_6_4:setItemSize(667, 166)
...
function var_0_0.rewardItemLayout(arg_7_0, arg_7_1, arg_7_2, arg_7_3, arg_7_4)
	...
	var_7_11:setPosition(0, -1)

	local var_7_12 = var_0_4:name(arg_7_4)
	...
	arg_7_0:rewardFormat(var_7_8, var_0_4:gift(arg_7_4))
