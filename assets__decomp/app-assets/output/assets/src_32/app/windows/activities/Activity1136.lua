...
local var_0_2 = xyd.tables.activityLevelChargeGift
...
function var_0_0.layout(arg_3_0, arg_3_1)
	...
	arg_3_0.list = cc.ui.UIListView.new({
		async = true,
		viewRect = cc.rect(0, 0, var_3_1.width - 20, var_3_1.height),
		padding_ = {
			top = 0,
			bottom = 0,
			left = 0,
	...
	arg_3_0.list:reload()
	arg_3_1:getChildByName("word_bottom"):setVisible(true)

	local var_3_2 = xyd.createLabel(18, cc.c3b(132, 41, 103))

	var_3_2:addTo(arg_3_1:getChildByName("label_node"))
	var_3_2:setString(var_0_1:translation("ACTIVITY_1136_TXT"))
	var_3_2:setWidth(580)
...
function var_0_0.giftBoxState(arg_6_0, arg_6_1)
	...
	local var_6_1 = {
		isDiscounting = arg_6_0.details.award_infos[arg_6_1].is_awarded == 0 and arg_6_0.details.award_infos[arg_6_1].open_time > 0 and var_6_0 - arg_6_0.details.award_infos[arg_6_1].open_time <= xyd.tables.misc.levelChargeDiscountTime,
		afterDiscounting = arg_6_0.details.award_infos[arg_6_1].is_awarded == 0 and arg_6_0.details.award_infos[arg_6_1].open_time > 0 and var_6_0 - arg_6_0.details.award_infos[arg_6_1].open_time > xyd.tables.misc.levelChargeDiscountTime,
...
function var_0_0.initCell(arg_8_0, arg_8_1, arg_8_2)
	...
	local var_8_0 = xyd.AssetLoader.get():loadNodeFromJson("windows/activities/1136/level_charge_item.csb")
	...
	var_8_1:getChildByName("lev_text"):enableOutline(cc.c4b(103, 50, 140, 255), 2)
	...
	if var_8_2 == var_0_7.isDiscounting then
		...
		local var_8_4 = arg_8_0.details.award_infos[tostring(arg_8_0.listInfo[arg_8_2])].open_time + xyd.tables.misc.levelChargeDiscountTime - xyd.ServerTime.get():getServerTime()
		...
		var_0_5 = xyd.EventDispatcher.get():addEventListener(xyd.event.LEVEL_CHARGE_TIME_UPDATE, function(arg_9_0)
			if var_8_3 and not tolua.isnull(var_8_3) then
				local var_9_0 = arg_8_0.details.award_infos[tostring(arg_8_0.listInfo[arg_8_2])].open_time + xyd.tables.misc.levelChargeDiscountTime - xyd.ServerTime.get():getServerTime()
...
function var_0_0.rewardLayer(arg_13_0, arg_13_1, arg_13_2)
	...
	local var_13_16 = xyd.tables.gift:energy(arg_13_2)

	if var_13_16 and var_13_16 > 0 then
		local var_13_17 = display.newNode()

		var_13_17:setContentSize(var_13_3, var_13_3)
		xyd.setItemBorder(var_13_17, -13, false, false, var_13_16)
		var_13_17:addTo(arg_13_1)
		var_13_17:setAnchorPoint(cc.p(0, 0))
		var_13_17:setPosition((1 - var_13_9 % 2) * (var_13_3 + var_13_4), (3 - math.ceil(var_13_9 / 2)) * (var_13_3 + var_13_4))

		local var_13_18 = {}

		var_13_18.id = -13
		var_13_18.hasNum = arg_13_0.selfPlayer.energy

		xyd.addTips(var_13_17, var_13_18)

		var_13_9 = var_13_9 + 1
	end

	local var_13_19 = xyd.tables.gift:drops(arg_13_2)
	local var_13_20 = false

	if var_13_19 and next(var_13_19) then
		var_13_20 = #var_13_19 ~= 1 or var_13_19[1] ~= 0
	end

	if var_13_20 then
		local var_13_21 = display.newNode()

		var_13_21:addTo(arg_13_1)
		var_13_21:setAnchorPoint(cc.p(0, 0))
		var_13_21:setPosition((1 - var_13_9 % 2) * (var_13_3 + var_13_4), (3 - math.ceil(var_13_9 / 2)) * (var_13_3 + var_13_4))
		var_13_21:setContentSize(var_13_3, var_13_3)

		local var_13_22 = xyd.AssetLoader.get():loadSprite("images/icon/black_bg.png")

		if var_13_22 then
			local var_13_23 = var_13_21:getWidth()
			local var_13_24 = var_13_21:getHeight()
			local var_13_25 = var_13_23 / var_13_22:getWidth()

			var_13_22:setScale(var_13_25)
			var_13_22:addTo(var_13_21)
			var_13_22:setAnchorPoint(cc.p(0, 0))
			var_13_22:setPosition(0, 0)

			local var_13_26 = xyd.getBorder(0, false)

			xyd.displaySpriteOnContainer(var_13_26, var_13_21, true)
		end

		local var_13_27 = {}

		var_13_27.id = -13
		var_13_27.tipsType = 1

		arg_13_0:addTips(var_13_21, var_13_27)

		local var_13_28 = var_13_9 + 1
	end
