...
function var_0_0.createAwardList(arg_4_0, arg_4_1)
	...
	for iter_4_0 = 1, var_4_2 do
		...
		local var_4_6 = xyd.AssetLoader.get():loadNodeFromJson("windows/activities/1208/item.csb")
...
function var_0_0.rewardItemLayout(arg_6_0, arg_6_1, arg_6_2, arg_6_3, arg_6_4)
	local var_6_0 = xyd.tables.activityCharge2:name(arg_6_4)
	...
	if xyd.tables.activityCharge2:recharge(arg_6_4) > arg_6_1.details.charge_count then
	...
	arg_6_0:rewardFormat(var_6_3, xyd.tables.activityCharge2:gift(arg_6_4), arg_6_0.activity, 15)
