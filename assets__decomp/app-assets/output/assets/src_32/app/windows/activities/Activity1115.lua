...
function var_0_0.layout(arg_3_0, arg_3_1, arg_3_2)
	local var_3_0 = xyd.AssetLoader.get():loadNodeFromJson("windows/activities/1115/limit_to_buy.csb")

	var_3_0:addTo(arg_3_0.parent)

	arg_3_0.isCanBuy = arg_3_1.details.is_can_buy or 0
	arg_3_0.chargeId = var_0_2:chargeId(1)
	...
	local var_3_7 = xyd.tables.gift:vipExp(var_0_2:giftId(arg_3_0.chargeId))
	local var_3_8 = {
		size = 18,
	...
	local var_3_9 = xyd.ServerTime.get():getServerTime()
	local var_3_10 = var_0_4.NOT_BUY

	if var_3_9 < arg_3_1.start_time or var_3_9 > arg_3_1.end_time then
		var_3_10 = var_0_4.NOT_BUY
	elseif arg_3_0.isCanBuy == 1 then
		var_3_10 = var_0_4.CAN_BUY
	else
		var_3_10 = var_0_4.HAVE_BUY
	end

	arg_3_0:updateBtnType(var_3_1:getChildByName("btn_buy"), var_3_10)
