local var_0_0 = class("LvbuRuleWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.layout(arg_4_0)
	arg_4_0:nodeByName("title"):setString(var_0_1:translation("LVBU_CAMPAIGN_RULER_TITLE"))
...
function var_0_0.createRuleLabel(arg_6_0)
	local var_6_0 = var_0_1:translation("LVBU_CAMPAIGN_RULER")
