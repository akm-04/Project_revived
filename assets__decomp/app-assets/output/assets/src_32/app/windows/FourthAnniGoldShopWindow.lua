local var_0_0 = class("FourthAnniGoldShopWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.updateAsset(arg_2_0)
	arg_2_0:nodeByName("star_txt"):setString(arg_2_0.gold.point)
end
...
function var_0_0.layout(arg_5_0)
	...
	arg_5_0:nodeByName("star_txt"):enableOutline(cc.c4b(46, 25, 58, 255), 2)
...
function var_0_0.createExchangeItem(arg_9_0, arg_9_1, arg_9_2)
	...
	local var_9_1 = xyd.AssetLoader.get():loadNodeFromJson("windows/anniversary4th/gold_catch/gold_shop/exchange_item.csb")
	local var_9_2 = var_9_1:getChildByName("container")
	local var_9_3 = var_0_3:itemId(var_9_0)
	local var_9_4 = var_0_3:itemNum(var_9_0)
	local var_9_5 = var_0_3:limitNum(var_9_0)
	...
	local function var_9_6()
		arg_9_0:updateAsset()
		var_9_2:getChildByName("limit_txt"):setString("(" .. (arg_9_0.gold.exchange_times[var_9_0] or 0) .. "/" .. var_9_5 .. ")")
	end
	...
	var_9_2:getChildByName("exchange_btn"):addTouchEventListener(function(arg_11_0, arg_11_1)
		if arg_11_1 == ccui.TouchEventType.ended then
			if var_0_3:price(var_9_0) > arg_9_0.gold.point then
			...
			xyd.WindowManager.get():openWindow("gold_sure_exchange", var_11_1)
		end
	end)
