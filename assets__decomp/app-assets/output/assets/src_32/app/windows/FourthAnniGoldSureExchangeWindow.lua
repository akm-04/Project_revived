local var_0_0 = class("FourthAnniGoldSureExchangeWindow", import("app.common.ui.BaseWindow"))
local var_0_1 = require("framework.scheduler")
local var_0_2 = xyd.tables.translation
local var_0_3 = xyd.tables.activityAnni4thGoldShop
...
function var_0_0.ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0.gold = arg_1_0.fourthAnni.gold
	arg_1_0.buyNum = 1
...
function var_0_0.layout(arg_4_0)
	...
	local var_4_2 = var_0_3:limitNum(var_4_0)
...
function var_0_0.updateNum(arg_5_0)
	...
	if (var_0_3:limitNum(arg_5_0.id) or 0) > 0 then
		arg_5_0:nodeByName("progress_txt"):setString("(" .. (arg_5_0.gold.exchange_times[id] or 0) .. "/" .. var_0_3:limitNum(arg_5_0.id) .. ")")
	else
...
function var_0_0.getCanBuyNum(arg_6_0)
	arg_6_0.canBuyNum = math.floor(arg_6_0.gold.point / var_0_3:price(arg_6_0.id))
	...
	local var_6_1 = var_0_3:limitNum(arg_6_0.id) - (arg_6_0.gold.exchange_times[arg_6_0.id] or 0)
...
function var_0_0.didOpen(arg_9_0)
	...
	arg_9_0:nodeByName("exchange_btn"):addTouchEventListener(function(arg_18_0, arg_18_1)
		...
		if arg_18_1 == ccui.TouchEventType.ended then
			...
			arg_9_0.fourthAnni:fourthAnniGoldExchange(var_18_1, function(arg_19_0, arg_19_1)
				if arg_19_0 == xyd.error.OK then
					arg_9_0.gold.exchange_times[arg_9_0.id] = (arg_9_0.gold.exchange_times[arg_9_0.id] or 0) + var_18_1.num
