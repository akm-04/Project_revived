local var_0_0 = class("WorldBossRuleWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.layout(arg_4_0)
	arg_4_0:nodeByName("rules_words"):setVisible(false)
...
function var_0_0.createRuleLabel(arg_5_0)
	local var_5_0 = var_0_2:translation("WORLD_BOSS_RULES")
