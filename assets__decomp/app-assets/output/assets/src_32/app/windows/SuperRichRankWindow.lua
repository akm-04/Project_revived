local var_0_0 = class("SuperRichRankWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.layout(arg_4_0)
	...
	arg_4_0:nodeByName("total_reward_text"):setString(var_0_1:translation("SUPER_RICH_RANK_TEXT1"))

	if arg_4_0.selfRank.rank and arg_4_0.selfRank.rank > 0 then
		local var_4_0 = xyd.AssetLoader.get():loadLabel(nil, "tacit_rank")

		var_4_0:setString(arg_4_0.selfRank.rank)
		var_4_0:setAnchorPoint(cc.p(0, 0.5))
		var_4_0:addTo(arg_4_0:nodeByName("rank_pos"))
	else
	...
	local var_4_1 = arg_4_0.scroll:getContentSize()
...
function var_0_0.createListContent(arg_6_0, arg_6_1)
	...
	var_6_3:getChildByName("total_reward_text"):setString(var_0_1:translation("SUPER_RICH_RANK_TEXT2"))

	if arg_6_1 <= 3 then
		rank = xyd.AssetLoader.get():loadSprite("windows/single_day/rank/" .. arg_6_1 .. ".png")
	else
		rank = xyd.AssetLoader.get():loadLabel(nil, "tacit_rank")
