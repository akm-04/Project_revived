local var_0_0 = class("TeamCampaignRuleWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.willOpen(arg_3_0, arg_3_1)
	...
	arg_3_0:nodeByName("title"):setString(var_0_1:translation("TEAM_RULE_TITLE"))
	arg_3_0:layout()
end

function var_0_0.layout(arg_4_0)
	arg_4_0:nodeByName("title"):setString(var_0_1:translation("GUILD_ACTIVITY_TITLE"))
...
function var_0_0.createRuleLabel(arg_5_0)
	local var_5_0 = var_0_1:translation("team_rule")
