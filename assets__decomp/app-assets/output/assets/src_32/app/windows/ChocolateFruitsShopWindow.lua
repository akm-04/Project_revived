local var_0_0 = class("ChocolateFruitsShopWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.updateAsset(arg_2_0)
	arg_2_0:nodeByName("star_txt"):setString(arg_2_0.fruit.point)
end
...
function var_0_0.layout(arg_5_0)
	...
	arg_5_0.list:reload()
	arg_5_0:nodeByName("star_txt"):enableOutline(cc.c4b(255, 93, 29, 255), 2)
	arg_5_0:updateAsset()
end
...
function var_0_0.createExchangeItem(arg_9_0, arg_9_1, arg_9_2)
	...
	local var_9_1 = xyd.AssetLoader.get():loadNodeFromJson("windows/chocolate_fruits/shop/exchange_item.csb")
	...
	var_9_2:getChildByName("limit_txt"):enableOutline(cc.c4b(255, 93, 29, 255), 2)

	local function var_9_6()
		arg_9_0:updateAsset()
		var_9_2:getChildByName("limit_txt"):setString("(" .. (arg_9_0.fruit.exchange_times[var_9_0] or 0) .. "/" .. var_9_5 .. ")")
	end
	...
	var_9_2:getChildByName("exchange_btn"):addTouchEventListener(function(arg_11_0, arg_11_1)
		xyd.buttonScaleAnim(var_9_2:getChildByName("exchange_btn"), arg_11_1)

		if arg_11_1 == ccui.TouchEventType.ended then
			if var_0_3:sellPrice(var_9_0) > arg_9_0.fruit.point then
				local var_11_0 = var_0_1:translation("POINT_NOT_ENOUGH")
			...
			xyd.WindowManager.get():openWindow("chocolate_fruits_sure_exchange", var_11_1)
		end
	end)
