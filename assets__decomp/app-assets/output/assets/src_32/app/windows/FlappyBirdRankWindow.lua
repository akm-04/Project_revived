local var_0_0 = class("FlappyBirdRankWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.layout(arg_3_0)
	...
	if not arg_3_0.rankInfo.self_info.self_rank then
		arg_3_0.rankInfo.self_info.self_rank = 0
	end

	if not arg_3_0.rankInfo.self_info.score then
		arg_3_0.rankInfo.self_info.score = 0
	end

	if arg_3_0.rankInfo.self_info.self_rank > 0 then
		arg_3_0:nodeByName("myrank_txt"):setString(arg_3_0.rankInfo.self_info.self_rank)
	else
...
function var_0_0.createListContent(arg_5_0, arg_5_1)
	...
	local var_5_2 = xyd.AssetLoader.get():loadNodeFromJson("windows/anniversary4th/gold_catch/rank/rank_item.csb")
