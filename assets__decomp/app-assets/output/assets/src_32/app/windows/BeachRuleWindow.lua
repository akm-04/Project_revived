local var_0_0 = class("BeachRuleWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.willOpen(arg_3_0, arg_3_1)
	...
	arg_3_0.list = cc.ui.UIListView.new({
		async = false,
		viewRect = cc.rect(0, 0, 714, 420),
		direction = cc.ui.UIListView.DIRECTION_VERTICAL,
		alignment = cc.ui.UIListView.ALIGNMENT_HCENTER
	}):addTo(arg_3_0:nodeByName("detail_container")):onScroll(handler(arg_3_0, arg_3_0.scrollListener))
...
function var_0_0.layout(arg_4_0)
	arg_4_0:nodeByName("title_bg"):getChildByName("title_text"):setString(var_0_1:translation("BEACH_RULE_TITLE"))
	...
	for iter_4_0 = 1, #var_4_0 do
		...
		var_4_3:setContentSize(714, var_4_0[iter_4_0]:getContentSize().height)
		var_4_3:addTo(var_4_1)
		var_4_1:setContentSize(714, var_4_0[iter_4_0]:getContentSize().height)
		var_4_2:addContent(var_4_1)
		var_4_2:setItemSize(714, var_4_0[iter_4_0]:getContentSize().height)
...
function var_0_0.createRuleLabel(arg_5_0)
	local var_5_0 = var_0_1:translation("BEACH_RULE")
