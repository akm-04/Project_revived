local var_0_0 = class("SingleDayRuleWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.layout(arg_4_0)
	arg_4_0:nodeByName("title"):setString(var_0_1:translation("ACTIVITY_SINGLE_RULE_TITLE"))
	...
	arg_4_0:nodeByName("left_hua"):setPositionX(arg_4_0:nodeByName("left_hua"):getPositionX() - 70)
	arg_4_0:nodeByName("right_hua"):setPositionX(arg_4_0:nodeByName("right_hua"):getPositionX() + 70)
...
function var_0_0.createRuleLabel(arg_6_0)
	local var_6_0 = var_0_1:translation("ACTIVITY_SINGLE_RULE_TEXT")
