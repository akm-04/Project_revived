local var_0_0 = class("TaskGrowCell", import("app.common.ui.BaseNode"))
...
function var_0_0.layout(arg_2_0)
	...
	local var_2_0 = xyd.createAutoFixLabel({
		...
		txtColor = "#4fa6fe",
		width = 505,
		text = var_0_4:name(arg_2_0.tableID),
	...
	local var_2_1 = xyd.createAutoFixLabel({
		...
		txtColor = "#6A6977",
		width = 505,
		text = var_0_4:des(arg_2_0.tableID),
		align = cc.ui.TEXT_ALIGN_LEFT,
		valign = cc.ui.TEXT_VALIGN_CENTER
	})
	...
	local var_2_2, var_2_3 = arg_2_0:nodeByName("pos_txt_desc"):getPosition()

	var_2_1:setPosition(var_2_2, var_2_3 + 15)

	local var_2_4 = var_0_1.new({
		size = 503,
		color = var_0_5
	})

	var_2_4:addTo(arg_2_0:background())
	var_2_4:setAnchorPoint(0, 0.5)
	var_2_4:setPosition(arg_2_0:nodeByName("pos_splitline"):getPosition())
	arg_2_0:setAwardDisplay()

	if arg_2_0.taskInfo.is_complete == 0 then
		local var_2_5 = arg_2_0:getTaskCondition() or 1
		local var_2_6
		local var_2_7 = var_0_4:getDetailType(arg_2_0.tableID)

		if var_2_7 == xyd.TaskDetailType.COLLEGE_BUILD or var_2_7 == xyd.TaskDetailType.GROWTH_RETURN then
			var_2_6 = arg_2_0.selfPlayer.lev
		else
			var_2_6 = arg_2_0.taskInfo.count
		end

		local var_2_8 = var_2_6 .. "/" .. var_2_5
		local var_2_9 = xyd.createAutoFixLabel({
			height = 30,
			fontSize = 24,
			txtColor = "#4fa6fe",
			width = 150,
		...
		var_2_9:addTo(arg_2_0:background())
		var_2_9:setAnchorPoint(0.5, 0.5)

		local var_2_10, var_2_11 = arg_2_0:nodeByName("pos_txt_progress"):getPosition()

		var_2_9:setPosition(var_2_10, var_2_11 + 6)

		arg_2_0.children_.progress_label = var_2_9

		local var_2_12 = var_0_4:goto_type(arg_2_0.tableID)

		if var_2_12 and var_2_12 > 0 then
			local var_2_13 = "windows/button/btn127_2.png"
			local var_2_14 = var_0_2.new({
				titleSize = 24,
				sprite = var_2_13,
			...
			var_2_14:addTo(arg_2_0:nodeByName("background"))
			var_2_14:setAnchorPoint(0.5, 0.5)
			var_2_14:setPosition(arg_2_0:nodeByName("pos_btn_go"):getPosition())

			arg_2_0.children_.goto_btn = var_2_14
		else
			var_2_9:setPositionY(var_2_11 - 30)
		end
	else
		local var_2_15 = xyd.AssetLoader.get():loadSprite("windows/common/icons/icon_completed.png")

		var_2_15:addTo(arg_2_0:background())
		var_2_15:setAnchorPoint(0.5, 0.5)
		var_2_15:setPosition(arg_2_0:nodeByName("pos_btn_get"):getPosition())
	end
...
function var_0_0.setAwardDisplay(arg_3_0)
	...
	elseif var_3_0 == xyd.TaskDetailType.GROWTH_RETURN then
		...
		if arg_3_0.selfPlayer:isMaxLev() then
			if var_0_4:vipExp(arg_3_0.tableID) > 0 then
				xyd.setItemBorder(var_3_4, -8, nil, nil, var_0_4:vipExp(arg_3_0.tableID))

				var_3_5 = true
			elseif var_0_4:marchCoin(arg_3_0.tableID) > 0 then
				xyd.setItemAndAddTips(var_3_4, -4, var_0_4:marchCoin(arg_3_0.tableID))

				var_3_5 = true
			end
		elseif var_0_4:vipExp(arg_3_0.tableID) > 0 then
			xyd.setItemBorder(var_3_4, -8, nil, nil, var_0_4:vipExp(arg_3_0.tableID))

			var_3_5 = true
		elseif var_0_4:exp(arg_3_0.tableID) > 0 then
			xyd.setItemBorder(var_3_4, -7, nil, nil, var_0_4:exp(arg_3_0.tableID))
		...
		if var_3_5 == true then
			var_3_6:setPosition(var_3_1 + var_3_2, 0)
		else
			var_3_6:setPosition(0, 0)
		end

		xyd.setItemAndAddTips(var_3_6, tonumber(var_0_4:award(arg_3_0.tableID)), var_0_4:award_num(arg_3_0.tableID))
	elseif var_3_0 == xyd.TaskDetailType.SUMMON and arg_3_0.tableID == xyd.MissionIDs.SUMMON_ZHANGJIAO then
		...
		var_3_7:setPosition(0, 0)
		xyd.setItemAndAddTips(var_3_7, -2, var_0_4:gold(arg_3_0.tableID))
		...
		var_3_8:setPosition(var_3_1 + var_3_2, 0)
		...
		var_3_9:setContentSize(var_3_1, var_3_1)
		var_3_9:addTo(arg_3_0:nodeByName("award_container"))
		var_3_9:setAnchorPoint(0, 0)
		var_3_9:setPosition(0, 0)
		xyd.setItemAndAddTips(var_3_9, tonumber(var_0_4:award(arg_3_0.tableID)), var_0_4:award_num(arg_3_0.tableID))
	end
end
	...
	if arg_12_0.taskInfo.is_complete == 1 then
		...
		arg_12_0:addNodeEventListener(cc.NODE_TOUCH_EVENT, function(arg_14_0)
			...
			elseif arg_14_0.name == "ended" then
				...
				arg_12_0.task:getTaskReward(arg_12_0.tableID, xyd.TaskType.GROW, function(arg_15_0, arg_15_1)
