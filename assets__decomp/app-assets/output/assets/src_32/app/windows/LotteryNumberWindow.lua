local var_0_0 = class("LotteryNumberWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.initNumberCell(arg_8_0, arg_8_1, arg_8_2)
	for iter_8_0 = 1, var_0_4 do
		...
		local var_8_1 = xyd.AssetLoader.get():loadNodeFromJson("windows/activities/1116/lottery_number_item.csb")
		...
		elseif arg_8_0.numberTable[var_8_0] == 2 then
			...
			var_8_1:addNodeEventListener(cc.NODE_TOUCH_EVENT, function(arg_9_0)
				...
				elseif arg_9_0.name == "ended" and not arg_8_0.scrollViewMoved_ then
					...
					xyd.Backend.get():request(xyd.mid.LOTTERY_GET_PLAYER_INFO_BY_NUM, var_9_0, function(arg_10_0, arg_10_1)
						if arg_10_0 == xyd.error.OK then
							xyd.WindowManager.get():openWindow("lottery_tips", arg_10_1)
						end
					end, nil, nil, false)
				end
			end)
		elseif arg_8_0.numberTable[var_8_0] == nil and arg_8_0.canChoose then
			var_8_1:addNodeEventListener(cc.NODE_TOUCH_EVENT, function(arg_11_0)
				...
				elseif arg_11_0.name == "ended" and arg_8_0.scrollViewMoved_ == false then
					...
					xyd.Backend.get():request(xyd.mid.LOTTERY_SELECT_NUM, var_11_0, function(arg_12_0, arg_12_1)
							...
							if var_0_3:ticketNum(arg_8_0.stageCount) <= #arg_8_0.details.total_info.total_selected_nums then
								...
								arg_8_0.activityModel:loadSingleActivity(var_12_0, function(arg_13_0, arg_13_1)
									if arg_13_0 == xyd.error.OK then
										...
										if var_13_0 and var_13_0.openedActivities[xyd.Activities.Lottery] then
											var_13_0.openedActivities[xyd.Activities.Lottery].details = arg_13_1.details

											var_13_0.openedActivities[xyd.Activities.Lottery]:updateWnd()
										end
								...
								if var_12_1 and var_12_1.openedActivities[xyd.Activities.Lottery] then
									var_12_1.openedActivities[xyd.Activities.Lottery].details.base_info.selected_nums = arg_8_0.details.base_info.selected_nums
									var_12_1.openedActivities[xyd.Activities.Lottery].details.total_info.total_selected_nums = arg_8_0.details.total_info.total_selected_nums

									var_12_1.openedActivities[xyd.Activities.Lottery]:updateWnd()
								end
							end
						elseif #arg_8_0.details.base_info.selected_nums == arg_8_0.details.base_info.can_select_times then
							...
							arg_8_0.activityModel:loadSingleActivity(var_12_2, function(arg_14_0, arg_14_1)
								if arg_14_0 == xyd.error.OK then
									...
									if var_14_0 and var_14_0.openedActivities[xyd.Activities.Lottery] then
										var_14_0.openedActivities[xyd.Activities.Lottery].details = arg_14_1.details

										var_14_0.openedActivities[xyd.Activities.Lottery]:updateWnd()
									end
...
function var_0_0.willClose(arg_23_0, arg_23_1)
	if xyd.WindowManager.get():getWindow("lottery_tips") then
