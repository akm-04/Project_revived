local var_0_0 = class("Jigsaw2Window", import("app.common.ui.BaseWindow"))
...
function var_0_0.ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0.jigsaw = xyd.ModelManager.get():loadModel(xyd.ModelType.JIGSAW2)
	...
	var_3_2:addTouchEventListener(function(arg_5_0, arg_5_1)
		...
		if arg_5_1 == ccui.TouchEventType.ended then
			xyd.WindowManager.get():openWindow("new_text_rule", {
				title_name = "ANNIVERSARY_JIGSAW2_RULE_TITLE",
				rule = "ANNIVERSARY_JIGSAW2_RULE_TEXT"
			})
		end
	end)
	arg_3_0:layout()
...
function var_0_0.layout(arg_6_0)
	...
	arg_6_0:nodeByName("end_time_text"):enableOutline(cc.c4b(153, 35, 35, 255), 2)
	...
	for iter_6_0 = 1, var_0_4 do
		...
		var_6_0:addNodeEventListener(cc.NODE_TOUCH_EVENT, function(arg_7_0)
			...
			elseif arg_7_0.name == "ended" then
				...
				xyd.WindowManager.get():openWindow("jigsaw2_detail", var_7_0)
			end
		end)

		arg_6_0.progressBar[iter_6_0] = cc.ProgressTimer:create(cc.Sprite:create("windows/jigsaw2/progress_bg.png"))
...
function var_0_0.updateMovePieces(arg_11_0)
	for iter_11_0 = 1, var_0_4 do
		if arg_11_0.jigInfosList[iter_11_0].is_put ~= 1 and arg_11_0.jigInfosList[iter_11_0].count >= xyd.tables.ActivityJigsaw2:amount(iter_11_0) then
...
function var_0_0.createMovePieceByID(arg_12_0, arg_12_1)
	local var_12_0 = "windows/jigsaw2/" .. "big_" .. arg_12_1 .. ".png"
...
function var_0_0.updateAwardList(arg_29_0)
	...
	for iter_29_0 = 1, xyd.tables.ActivityJigsaw2Reward:counts() do
		local var_29_0 = display.newNode()
		local var_29_1 = arg_29_0.awardList:newItem()
		local var_29_2 = xyd.AssetLoader.get():loadNodeFromJson("windows/jigsaw2/item/activity_item.csb")
...
function var_0_0.rewardItemLayout(arg_30_0, arg_30_1, arg_30_2)
	...
	arg_30_1:getChildByName("desc"):setString(xyd.tables.ActivityJigsaw2Reward:desc(arg_30_2))
	arg_30_1:getChildByName("progress_txt"):setString(arg_30_0:getPutPiecesCount(arg_30_2) .. "/" .. #xyd.tables.ActivityJigsaw2Reward:pieceIds(arg_30_2))
	arg_30_0:rewardFormat(var_30_7, xyd.tables.ActivityJigsaw2Reward:gift(arg_30_2))
...
function var_0_0.getPutPiecesCount(arg_32_0, arg_32_1, arg_32_2)
	local var_32_0 = xyd.tables.ActivityJigsaw2Reward:pieceIds(arg_32_1)
	local var_32_1 = 0
...
function var_0_0.updateStableJigsaw(arg_38_0, arg_38_1)
	for iter_38_0 = 1, var_0_4 do
		if arg_38_0.jigInfosList[iter_38_0].is_put ~= 1 then
			...
			if arg_38_0.jigInfosList[iter_38_0].count >= xyd.tables.ActivityJigsaw2:amount(iter_38_0) or arg_38_0.jigInfosList[iter_38_0].count == 0 then
				arg_38_0.progressBar[iter_38_0]:setVisible(false)
				arg_38_0.progressTxt[iter_38_0]:setVisible(false)
			else
				local var_38_0 = 100 * arg_38_0.jigInfosList[iter_38_0].count / xyd.tables.ActivityJigsaw2:amount(iter_38_0)
