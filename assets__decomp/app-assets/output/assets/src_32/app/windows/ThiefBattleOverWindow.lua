local var_0_0 = class("ThiefBattleOverWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.didOpen(arg_5_0, arg_5_1)
	...
	for iter_5_0, iter_5_1 in ipairs(arg_5_0.awards) do
		arg_5_0.player:getBackpack():addItemsByID(tonumber(iter_5_1.table_id), tonumber(iter_5_1.item_num))
	end

	xyd.WindowManager.get():openWindow("alert_award", {
		awards = arg_5_0.awards
	})
end
