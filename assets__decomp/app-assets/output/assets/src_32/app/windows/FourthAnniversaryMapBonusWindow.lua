local var_0_0 = class("FourthAnniversaryMapBonusWindow", import("app.common.ui.BaseWindow"))
local var_0_1 = xyd.tables.translation
local var_0_2 = xyd.tables.activityAnni4thCampaignStarsTable

function var_0_0.ctor(arg_1_0, arg_1_1, arg_1_2)
	arg_1_0.super.ctor(arg_1_0, arg_1_1, arg_1_2)

	arg_1_0.selfPlayer = xyd.ModelManager.get():loadModel(xyd.ModelType.SELF_PLAYER)
	arg_1_0.bonusID = arg_1_2.canAward
end
...
function var_0_0.layout(arg_4_0)
	...
	arg_4_0.starNum = var_0_2:starNum(arg_4_0.bonusID)
	...
	arg_4_0.giftId = var_0_2:giftId(arg_4_0.bonusID)
	arg_4_0.allItems = {}
	arg_4_0.diamond = xyd.tables.gift:crystal(arg_4_0.giftId)
	...
	arg_4_0.coin = xyd.tables.gift:mana(arg_4_0.giftId)
	...
	arg_4_0.awardItems = xyd.tables.gift:items(arg_4_0.giftId)
	arg_4_0.awardNums = xyd.tables.gift:itemNum(arg_4_0.giftId)
