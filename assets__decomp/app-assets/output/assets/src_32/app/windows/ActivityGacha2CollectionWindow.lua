	...
	for iter_4_0 = 1, 4 do
		...
		if not var_4_0 or var_4_0 == 0 then
			...
			if arg_4_1[iter_4_0].star > 0 then
				local var_4_5 = arg_4_1[iter_4_0].star
...
local var_0_3 = class("ActivityGacha2CollectionWindow", import("app.common.ui.BaseWindow"))
local var_0_4 = xyd.tables.activityGacha2Collection
local var_0_5 = 4
