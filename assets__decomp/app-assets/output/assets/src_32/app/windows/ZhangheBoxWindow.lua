local var_0_0 = class("ZhangheBoxWindow", import("app.common.ui.BaseWindow"))
local var_0_1 = import("framework.scheduler")
local var_0_2 = xyd.tables.activityChest
...
function var_0_0.ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0.activity = arg_1_0.activitiesModel:getActivityInfo(xyd.Activities.ZhangheBox)
end

function var_0_0.willOpen(arg_2_0, arg_2_1)
	arg_2_0:nodeByName("time_words"):setString(var_0_3:translation("ACTIVITY_END_TIME"))
	arg_2_0:nodeByName("txt_rule"):setString(var_0_3:translation("ACTIVITY_1106_TEXT_1"))
	arg_2_0:nodeByName("words1"):setString(var_0_3:translation("ACTIVITY_1106_TEXT_5"))
	arg_2_0:nodeByName("words2"):setString(var_0_3:translation("ACTIVITY_1106_TEXT_6"))
	arg_2_0:nodeByName("words3"):setString(var_0_3:translation("ACTIVITY_1106_TEXT_7"))
	...
	for iter_2_1 = 1, 3 do
		arg_2_0:nodeByName("box" .. iter_2_1 .. "_cost_num"):setString(var_0_5["zhangheBoxCost" .. iter_2_1])

		local var_2_0 = arg_2_0:nodeByName("bg_box_gray" .. iter_2_1)

		if arg_2_0.player.vip < var_0_6[iter_2_1] then
			...
			var_2_0:addNodeEventListener(cc.NODE_TOUCH_EVENT, function(arg_3_0)
				...
				elseif arg_3_0.name == "ended" then
					xyd.WindowManager.get():openWindow("toast", {
						message = string.format(var_0_3:translation("ACTIVITY_VIP_BOX_DRAW_LEV_TIP"), var_0_6[iter_2_1])
					})
				end
			end)
		else
	...
	arg_4_0:nodeByName("rule_btn"):addTouchEventListener(function(arg_5_0, arg_5_1)
		...
		if arg_5_1 == ccui.TouchEventType.ended then
			...
			xyd.WindowManager.get():openWindow("new_text_rule", {
				title_name = "ACTIVITY_VIP_BOX_DRAW_TITLE",
...
function var_0_0.initDrawBtn(arg_9_0, arg_9_1)
	...
	var_9_0:addNodeEventListener(cc.NODE_TOUCH_EVENT, function(arg_10_0)
		...
		elseif arg_10_0.name == "ended" then
			...
			if arg_9_0.player.crystal < var_0_5["zhangheBoxCost" .. arg_9_1] then
				...
				xyd.CommonAlertWindow.open(xyd.CommonAlertType.TWO_BTN, string.format(var_0_3:translation("ACTIVITY_VIP_BOX_DRAW_ALERT"), var_0_5["zhangheBoxCost" .. arg_9_1], ""), function()
...
function var_0_0.draw(arg_19_0, arg_19_1)
	...
	xyd.Backend.get():request(xyd.mid.ACTIVITY_1106_AWARD, var_19_0, function(arg_20_0, arg_20_1)
		if arg_20_0 == xyd.error.OK then
			if arg_19_1 == 3 then
				arg_19_0.player:handleRewards({
					arg_20_1.awards[1]
				})
			else
				xyd.WindowManager.get():openWindow("zhanghe_box_effect", {
