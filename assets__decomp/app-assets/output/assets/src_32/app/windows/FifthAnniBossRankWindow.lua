local var_0_0 = class("FifthAnniBossRankWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.layout(arg_4_0)
	...
	arg_4_0:nodeByName("txt_my_send_point"):setString(var_0_1:translation("ACTIVITY_1232_BOSS_20"))

	if arg_4_0.rank then
		...
		arg_4_0:nodeByName("txt_my_rank"):setVisible(false)
		arg_4_0:nodeByName("my_rank"):setVisible(false)
	end

	arg_4_0:nodeByName("my_send_point"):setString(arg_4_0.model.bossPoint)

	if not arg_4_0.data or not next(arg_4_0.data) then
		return
	end
...
function var_0_0.createContent(arg_6_0, arg_6_1)
	...
	var_6_1:getChildByName("txt_count"):setString(arg_6_0.data[arg_6_1].point)
