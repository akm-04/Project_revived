local var_0_0 = class("Valentine2GiveGiftAlertWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.registerEvents(arg_5_0)
	...
	arg_5_0:nodeByName("confirm_button"):addTouchEventListener(function(arg_7_0, arg_7_1)
		if arg_7_1 == ccui.TouchEventType.ended then
			...
			xyd.Backend.get():request(xyd.mid.NEW_WHITE_DAY_GIFT, var_7_2, function(arg_8_0, arg_8_1)
...
function var_0_0.initItems(arg_11_0)
	local var_11_0 = xyd.tables.misc.valentine2PresentItem
	local var_11_1 = xyd.ModelManager.get():loadModel(xyd.ModelType.SELF_PLAYER)
	local var_11_2 = arg_11_0:nodeByName("item1")

	var_11_2:setScale(1.3)
	var_11_2:setContentSize(var_0_5, var_0_5)
	var_11_2:setAnchorPoint(0.5, 0.5)

	local var_11_3 = var_11_1:getBackpack():getItemNumByID(var_11_0)

	xyd.setItemBorder(var_11_2, var_11_0, nil, var_11_3 == 0, var_11_3)
	var_11_2:getChildByName("kuang"):setPosition(var_0_5 / 2, var_0_5 / 2)
	var_11_2:getChildByName("kuang"):setVisible(false)

	if var_11_3 > 0 then
		arg_11_0.itemPos = 1
		arg_11_0.itemToGive = var_11_0

		var_11_2:getChildByName("kuang"):setVisible(true)
	end

	arg_11_0:nodeByName("item2"):setVisible(false)
	arg_11_0:nodeByName("item1"):setPositionX((arg_11_0:nodeByName("item1"):getPositionX() + arg_11_0:nodeByName("item2"):getPositionX()) / 2)
end

function var_0_0.initInputBox(arg_12_0, arg_12_1)
	local var_12_0 = "windows/activities/1117/alert/spelling_bg.png"

	arg_12_0.spelling_box = ccui.EditBox:create(arg_12_1:getContentSize(), var_12_0)

	arg_12_0.spelling_box:setAnchorPoint(0, 0)
	arg_12_0.spelling_box:pos(0, 0)
	arg_12_1:addChild(arg_12_0.spelling_box, -100)
	arg_12_0.spelling_box:setFont(var_0_2.FONT_NAME, var_0_6)
	arg_12_0.spelling_box:setPlaceholderFont(var_0_2.FONT_NAME, var_0_6)
	arg_12_0.spelling_box:setPlaceHolder(var_0_1:translation("CHAT_INPUT_MESSAGE"))
	arg_12_0.spelling_box:setPlaceholderFontColor(xyd.color.FONT_K)
	arg_12_0.spelling_box:setFontColor(cc.c3b(0, 0, 0))
	arg_12_0.spelling_box:setMaxLength(50)
	arg_12_0.spelling_box:setInputMode(cc.EDITBOX_INPUT_MODE_ANY)
	arg_12_0.spelling_box:registerScriptEditBoxHandler(handler(arg_12_0, arg_12_0.channelboxEventHandler))
	arg_12_0.spelling_box:setInputFlag(3)

	arg_12_0.inputFlag = true
end

function var_0_0.channelboxEventHandler(arg_13_0, arg_13_1)
	print(arg_13_1)

	if arg_13_1 == "return" then
		print("channel return")

		arg_13_0.wordsToSay = arg_13_0.spelling_box:getText()

		if not arg_13_0.wordsToSay or arg_13_0.wordsToSay == "" then
			arg_13_0.wordsToSay = var_0_1:translation("VALENTINE_TIPS_TXT6")
		end

		arg_13_0:nodeByName("sth_to_say"):setString(arg_13_0.wordsToSay)

		arg_13_0.inputFlag = false
	end
end
