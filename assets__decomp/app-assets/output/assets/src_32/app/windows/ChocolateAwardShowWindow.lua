local var_0_0 = class("ChocolateAwardPoolsWindow", import("app.windows.SummonResultWindow"))
...
function var_0_0.layout(arg_6_0)
	...
	local var_6_1 = string.format(var_0_4:translation("ACTIVITY_CHOCOLATE_AWARD_POOL_TIP3"), var_6_0)
	...
	arg_6_0:nodeByName("return"):getChildByName("txt"):setString(var_0_4:translation("SUMMON_EXIT"))
end
