local var_0_0 = class("ActivityGachaModeWindow", import("app.common.ui.BaseWindow"))
local var_0_1 = 10
local var_0_2 = {
	TEN = 2,
	ONE = 1
...
function var_0_0.getReward(arg_8_0, arg_8_1)
	...
	arg_8_0.activitiesModel:getActivityReward2(xyd.Activities.GaCha, nil, var_8_0, function(arg_9_0, arg_9_1)
		if arg_9_0 == xyd.error.OK then
			xyd.EventDispatcher.get():dispatchEvent({
				name = xyd.event.ACTIVITY_GACHA_GET_REWARD,
				params = {
					response = arg_9_1,
					sub_id = var_8_0
				}
