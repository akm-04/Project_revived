local var_0_0 = class("AdventureIllusionShowTeamWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0.teamInviteInfos = arg_1_0.adventureEvent.teamInviteInfos
	arg_1_0.heroItems_ = {}
end
...
function var_0_0.layout(arg_3_0)
	...
	local var_3_0 = xyd.SpriteLoader.new("images/maps/map_images/team_hhx.png", nil, nil, xyd.DefaultImageType.CHAPTER_MAP)

	var_3_0:setAnchorPoint(cc.p(0, 0))
	var_3_0:addTo(arg_3_0:nodeByName("container"), -1)
...
function var_0_0.setButtonClick(arg_4_0)
	local function var_4_0()
		if arg_4_0.adventureEvent.teamFightInfos[tostring(arg_4_0.selfPlayer.playerID)].is_prepare == 1 then
			...
			arg_4_0:nodeByName("btn_prepare"):setBrightStyle(ccui.BrightStyle.highlight)
	...
	var_4_0()
	arg_4_0:nodeByName("btn_prepare"):addTouchEventListener(function(arg_6_0, arg_6_1)
		if arg_6_1 == ccui.TouchEventType.ended then
			xyd.playButtonSound()

			local var_6_0 = arg_4_0.adventureEvent.teamFightInfos[tostring(arg_4_0.selfPlayer.playerID)]
			...
			if var_6_0.is_prepare == 0 then
				if arg_4_0:checkCanPrepareFight() then
					...
					arg_4_0.adventureEvent:prepareTeamFight(var_6_1, function(arg_7_0, arg_7_1)
				...
				arg_4_0.adventureEvent:prepareTeamFight(var_6_4, function(arg_8_0, arg_8_1)
	...
	arg_4_0:nodeByName("btn_fight"):addTouchEventListener(function(arg_9_0, arg_9_1)
		if arg_9_1 == ccui.TouchEventType.ended then
			...
			if arg_4_0:checkIsMaster() and arg_4_0:checkCanFight() then
				...
				arg_4_0.adventureEvent:teamFight(var_9_0, function(arg_10_0, arg_10_1)
	...
	for iter_4_0 = 1, 3 do
		...
		arg_4_0:nodeByName("bottom_item_" .. iter_4_0):addNodeEventListener(cc.NODE_TOUCH_EVENT, function(arg_11_0)
			...
			elseif arg_11_0.name == "ended" and not arg_4_0.isPrepare then
				...
				xyd.WindowManager.get():openWindow("adventure_illusion_select_hero", var_11_0)
			end
		end)
	end
	...
	if arg_4_0:checkIsMaster() then
		...
		arg_4_0:nodeByName("bottom_bg_2"):setVisible(false)
	else
		arg_4_0:nodeByName("bottom_item_3"):setVisible(false)
		arg_4_0:nodeByName("bottom_bg_1"):setVisible(false)
	...
	arg_4_0:nodeByName("close"):addTouchEventListener(function(arg_13_0, arg_13_1)
		if arg_13_1 == ccui.TouchEventType.ended then
			xyd.playButtonSound()
			xyd.CommonAlertWindow.open(xyd.CommonAlertType.TWO_BTN, var_0_3:translation("ILLUSION_TEAM_TIPS_8"), function()
				local var_14_0 = {
					table_id = xyd.AdventureEventType.ILLUSION
				}

				arg_4_0.adventureEvent:exitRoom(var_14_0, function(arg_15_0, arg_15_1)
...
function var_0_0.updateHeros(arg_16_0)
	local var_16_0 = arg_16_0.adventureEvent.teamFightInfos[tostring(arg_16_0.selfPlayer.playerID)]

	if var_16_0.formation and next(var_16_0.formation) then
		for iter_16_0 = 1, #(var_16_0.formation or {}) do
			local var_16_1 = var_16_0.formation[iter_16_0]

			if var_16_1 and next(var_16_1) and var_16_1.table_id and var_16_1.table_id ~= 0 then
	...
	if arg_16_0:checkIsMaster() then
		...
		if petInfo and next(petInfo) and petInfo.table_id and petInfo.table_id ~= 0 then
...
function var_0_0.updateHeroSelect(arg_17_0, arg_17_1, arg_17_2)
	...
	if arg_17_1 == 3 then
		...
		xyd.setAvatarBorder(arg_17_2, var_17_0:getChildByName("hero_" .. arg_17_1))
	end
end

function var_0_0.checkIsMaster(arg_18_0)
	return arg_18_0.adventureEvent:checkIsMaster(arg_18_0.selfPlayer.playerID)
end

function var_0_0.updateHeroList(arg_19_0)
	arg_19_0.members = {}

	local var_19_0 = arg_19_0.adventureEvent.teamInfo.members

	for iter_19_0 = 1, #var_19_0 do
		if arg_19_0.adventureEvent:checkIsMaster(var_19_0[iter_19_0]) then
...
function var_0_0.createPet(arg_20_0, arg_20_1)
	...
	local var_20_1 = arg_20_0.adventureEvent.teamFightInfos[tostring(var_20_0)]
	...
	var_20_3.status = var_20_1.is_prepare
	var_20_3.playerInfo = arg_20_0.adventureEvent:getPlayerInfoByID(var_20_0)
...
function var_0_0.teamFight(arg_22_0, arg_22_1)
	...
	arg_22_0.adventureEvent:getReport(var_22_0, function(arg_23_0, arg_23_1)
...
function var_0_0.createHero(arg_24_0, arg_24_1)
	...
	local var_24_1 = arg_24_0.adventureEvent.teamFightInfos[tostring(var_24_0)]
	local var_24_2
	...
	var_24_3.playerInfo = arg_24_0.adventureEvent:getPlayerInfoByID(var_24_0)
	var_24_3.status = var_24_1.is_prepare
...
function var_0_0.updateHeroItemPrepare(arg_28_0, arg_28_1)
	...
	if not arg_28_1:getChildByName("hero_prepare") then
		local var_28_1 = xyd.AssetLoader.get():loadSprite("windows/illusion/cooperation/word_19.png")

		var_28_1:addTo(arg_28_1)
		var_28_1:setPosition(cc.p(var_0_6 / 2, var_0_6 + 50))
		var_28_1:setName("hero_prepare")
		var_28_1:setLocalZOrder(100)
	end
...
function var_0_0.checkCanFight(arg_29_0)
	local var_29_0 = arg_29_0.adventureEvent.teamInfo.members

	for iter_29_0 = 1, #var_29_0 do
		if arg_29_0.adventureEvent.teamFightInfos[tostring(var_29_0[iter_29_0])].is_prepare == 0 then
			return false
		end
	end
...
function var_0_0.checkCanPrepareFight(arg_30_0)
	local var_30_0 = arg_30_0.adventureEvent.teamFightInfos[tostring(arg_30_0.selfPlayer.playerID)]
	local var_30_1 = #(var_30_0.formation or {})

	if var_30_1 + (var_30_0.pet and 1 or 0) >= 2 and var_30_1 >= 1 then
		return true
	end
...
function var_0_0.showChatWin(arg_31_0)
	...
	local var_31_1 = arg_31_0.adventureEvent:getChatWindow("adventure_illusion_show_team")
...
function var_0_0.showHeroDetail(arg_36_0, arg_36_1, arg_36_2)
	...
	if not arg_36_0.heroDetailWnd or tolua.isnull(arg_36_0.heroDetailWnd) then
		local var_36_0 = xyd.AssetLoader.get():loadNodeFromJson("windows/illusion/cooperation/hero_detail.csb")
	...
	xyd.setAvatarBorder(var_36_3, var_36_2:getChildByName("hero"))
...
function var_0_0.playReport(arg_37_0, arg_37_1, arg_37_2)
	...
	if arg_37_2 then
		var_37_1 = json.decode(arg_37_1.report[1].content)
	else
		var_37_1 = json.decode(arg_37_1.battle_report)
	end

	var_37_0.herosA = {}
	var_37_0.herosB = {}
	var_37_0.summonMonsters = {}
	var_37_0.campaignType = xyd.CampaignType.ADVENTURE_ILLUSION_COOPERATION
	var_37_0.battleID = xyd.tables.illusionCampaign:fightId(xyd.tables.misc.adventureIllusionBoss)
	var_37_0.battleType = xyd.BattleType.ReplayReport
	ngx.ctx.battle.reportData = var_37_1

	local var_37_2 = {}
	local var_37_3 = {}

	for iter_37_0, iter_37_1 in pairs(ngx.ctx.battle.reportData.fighter) do
		local var_37_4 = string.sub(iter_37_0, 1, 1)
		local var_37_5 = tonumber(string.sub(iter_37_0, 3, 3))

		if var_37_4 == "A" and tonumber(iter_37_1.summon_type) == xyd.summonMonsterType.None then
			local var_37_6 = var_0_2.new()

			var_37_6:populate(iter_37_1.hero)
			var_37_6:setReportData(iter_37_1)

			if isOnlyData then
				var_37_6.harms = iter_37_1.harms
				var_37_6.willDie = (iter_37_1.die_count or 0) ~= -1
			end

			var_37_0.herosA[var_37_5] = var_37_6
		elseif var_37_4 == "A" and tonumber(iter_37_1.summon_type) == xyd.summonMonsterType.Pet then
			local var_37_7 = var_0_1.new()
		...
		elseif var_37_4 == "B" and tonumber(iter_37_1.summon_type) == xyd.summonMonsterType.None then
			...
			if isOnlyData then
				...
				var_37_8.healthStatus = var_37_8.health_status
				var_37_0.herosB[var_37_5] = var_37_8
			else
				var_37_2[var_37_5] = var_37_8
			end
		elseif var_37_4 == "B" and tonumber(iter_37_1.summon_type) == xyd.summonMonsterType.Pet then
	...
	var_37_0.sceneFighter = sceneFighter
	var_37_0.summonMonsters = var_37_3
	var_37_0.reportStar = tonumber(var_37_1.star)
