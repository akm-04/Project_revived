local var_0_0 = class("SelfDrinkTipWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.open(arg_1_0, arg_1_1)
	...
	return xyd.WindowManager.get():openWindow("selfdrink_tip", var_1_0)
end
...
function var_0_0.close(arg_4_0)
	xyd.WindowManager.get():closeWindow("selfdrink_tip", arg_4_0)
end
...
function var_0_0.layout(arg_12_0)
	arg_12_0:nodeByName("title"):setString(var_0_1:translation("HERO_MAIN_TEXT_37"))
	arg_12_0:nodeByName("txt_sure"):setString(string.format(var_0_1:translation("HERO_MAIN_TEXT_38"), arg_12_0.heroName))
	...
	arg_12_0:nodeByName("title"):setString(var_0_1:translation("SELFDRINK_TIP"))

	if arg_12_0.isPet then
		arg_12_0:nodeByName("title"):setString(var_0_1:translation("SELFFEED_TIP"))
	end
...
function var_0_0.createLabels(arg_13_0)
	...
	local var_13_1 = 0
	local var_13_2 = {}
	local var_13_3 = "SELFDRINK_TIP_MESSAGE1"
	local var_13_4 = "SELFDRINK_TIP_MESSAGE2"

	if arg_13_0.isPet then
		local var_13_5 = "SELFFEED_TIP_MESSAGE1"

		var_13_4 = "SELFFEED_TIP_MESSAGE2"
	end

	local var_13_6 = {
		var_0_1:translation(var_13_4)
	}

	for iter_13_0 = 1, #var_13_6 do
		local var_13_7 = {
			size = 24,
		...
		var_13_8:setString(var_13_6[iter_13_0])
		var_13_8:setMaxLineWidth(arg_13_0:nodeByName("message"):getContentSize().width)
		var_13_8:setAnchorPoint(cc.p(0, 0))
		var_13_8:addTo(arg_13_0:nodeByName("message"))

		var_13_0 = var_13_0 + var_13_8:getContentSize().height

		table.insert(var_13_2, var_13_8)
	end

	local var_13_9 = (arg_13_0:nodeByName("message"):getContentSize().height + var_13_0) / 2

	for iter_13_1 = 1, #var_13_2 do
		var_13_9 = var_13_9 - var_13_2[iter_13_1]:getContentSize().height

		var_13_2[iter_13_1]:setPosition(var_13_1, var_13_9)
	end
end
