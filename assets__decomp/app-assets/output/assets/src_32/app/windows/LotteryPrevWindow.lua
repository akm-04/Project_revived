local var_0_0 = class("LotteryPrevWindow", import("app.common.ui.BaseWindow"))
local var_0_1 = xyd.tables.activityLottery
...
function var_0_0.initCell(arg_6_0, arg_6_1, arg_6_2)
	local var_6_0 = xyd.AssetLoader.get():loadNodeFromJson("windows/activities/1116/lottery_prev_item.csb")
	...
	var_6_1:getChildByName("prev_title_word"):setString(string.format(var_0_2:translation("ACTIVITY_1116_PRE_TITLE"), var_6_3))
	var_6_1:getChildByName("prev_title_word"):enableOutline(cc.c4b(255, 255, 255, 255), 1)
	var_6_1:getChildByName("prev_word1"):setString(var_0_2:translation("ACTIVITY_1116_PRE_1"))
	var_6_1:getChildByName("prev_word2"):setString(var_0_2:translation("ACTIVITY_1116_PRE_2"))
	var_6_1:getChildByName("prev_word3"):setString(var_0_2:translation("ACTIVITY_1116_PRE_3"))
	var_6_1:getChildByName("prev_word1"):enableOutline(cc.c4b(165, 94, 42, 255), 1)
	var_6_1:getChildByName("prev_word2"):enableOutline(cc.c4b(165, 94, 42, 255), 1)
	var_6_1:getChildByName("prev_word3"):enableOutline(cc.c4b(165, 94, 42, 255), 1)
	...
	for iter_6_0, iter_6_1 in pairs(arg_6_0.prevList[var_6_3].lucky_nums) do
		var_6_5 = var_6_5 .. iter_6_1 .. "   "

		if iter_6_0 == 8 then
			var_6_5 = var_6_5 .. "\n"
		elseif iter_6_0 > 8 and (iter_6_0 - 1) % 7 == 0 and arg_6_0.prevList[var_6_3].lucky_nums[iter_6_0 + 1] then
			var_6_5 = var_6_5 .. "\n"
		end
	end

	var_6_1:getChildByName("prev_lucky_number"):setString(var_6_5)
	...
	if arg_6_0.prevList[var_6_3].major_award_info then
		...
		local var_6_6 = arg_6_0.prevList[var_6_3].major_award_info
		...
		if arg_6_0.prevList[var_6_3].major_award_info.conquer_lev and arg_6_0.prevList[var_6_3].major_award_info.conquer_lev > 0 then
			xyd.setConquerLev(arg_6_0.prevList[var_6_3].major_award_info.conquer_lev, var_6_1:getChildByName("text_lev"), var_6_1:getChildByName("dengjiquan"), nil, nil, nil, nil, arg_6_0.prevList[var_6_3].major_award_info.conquer_loop_id)
		else
			var_6_1:getChildByName("text_lev"):setString(arg_6_0.prevList[var_6_3].major_award_info.lev)
		end
	else
		var_6_1:getChildByName("bg_lv"):setVisible(false)
		var_6_1:getChildByName("dengjiquan"):setVisible(false)
		var_6_1:getChildByName("text_lev"):setVisible(false)
		var_6_1:getChildByName("player_region"):setVisible(false)
