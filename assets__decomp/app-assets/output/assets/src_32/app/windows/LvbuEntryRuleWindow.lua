local var_0_0 = class("LvbuEntryRuleWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.createRuleLabel(arg_5_0)
	local var_5_0 = var_0_1:translation("ACTIVITY_LVBU_RULE_TEXT")
