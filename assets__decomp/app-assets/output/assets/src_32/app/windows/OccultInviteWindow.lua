local var_0_0 = class("OccultInviteWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.layout(arg_3_0)
	...
	arg_3_0:nodeByName("region_txt"):setString(var_0_1:translation("ILLUSION_INVITE_TXT1"))
	arg_3_0:nodeByName("guild_txt"):setString(var_0_1:translation("ILLUSION_INVITE_TXT2"))
end

function var_0_0.initFriends(arg_4_0)
	local var_4_0 = arg_4_0.socialSystem.friendlist
	local var_4_1 = {}
	local var_4_2 = xyd.tables.functionOpen:level(xyd.FunctionID.ID_occult)
...
function var_0_0.setButtonClick(arg_5_0)
	xyd.addTouchEvent(arg_5_0:nodeByName("btn_region"), function()
		xyd.playButtonSound()

		if not arg_5_0.messageManager.chatLimit then
			arg_5_0.messageManager.chatLimit = {}
		end

		if arg_5_0.messageManager.chatLimit[5] and arg_5_0.messageManager.chatLimit[5] > 0 then
			xyd.WindowManager.get():openWindow("toast", {
				message = string.format(var_0_1:translation("TIME_TO_CHAT_ALERT"), arg_5_0.messageManager.chatLimit[5])
			})
		else
			local var_6_0 = arg_5_0.occult:getPlayerInfoByID(arg_5_0.selfPlayer.playerID)
			local var_6_1 = {
				room_id = arg_5_0.occult.baseInfo.room_id,
				type = xyd.ChatTextType.OCCULT,
				chapter_id = arg_5_0.occult.baseInfo.chapter_id,
				force = var_6_0.force
			}
			local var_6_2 = {
				message = json.encode(var_6_1),
				channel = arg_5_0.messageManager.SERVICE_CHANNEL,
				type = xyd.ChatTextType.OCCULT
			}

			xyd.Backend.get():request(xyd.mid.SEND_CHAT_MESSAGE, var_6_2)
			arg_5_0.messageManager:setChatLimit(xyd.tables.misc.chatLimitTime, 5)
			xyd.WindowManager.get():openWindow("toast", {
				message = var_0_1:translation("ILLUSION_TEAM_TIPS_26")
			})
		end
	end)
	xyd.addTouchEvent(arg_5_0:nodeByName("btn_guild"), function()
		xyd.playButtonSound()

		if arg_5_0.messageManager:hasLeague() == true then
			local var_7_0 = arg_5_0.occult:getPlayerInfoByID(arg_5_0.selfPlayer.playerID)
			local var_7_1 = {
				room_id = arg_5_0.occult.baseInfo.room_id,
				type = xyd.ChatTextType.OCCULT,
				chapter_id = arg_5_0.occult.baseInfo.chapter_id,
			...
			local var_7_2 = {
				...
				channel = arg_5_0.messageManager.GUILD_CHANNEL,
				type = xyd.ChatTextType.OCCULT
			}
...
function var_0_0.initInviteItem(arg_11_0, arg_11_1, arg_11_2)
	...
	local var_11_1 = xyd.AssetLoader.get():loadNodeFromJson("windows/illusion/cooperation_new/invite_item.csb")
	...
	xyd.nodeEventSample(var_11_2:getChildByName("btn_invite"), nil, function()
		xyd.playButtonSound()
		...
		arg_11_0.occult:inviteFriend(var_12_0, function(arg_13_0, arg_13_1)
			if arg_13_0 == xyd.error.OK then
				arg_11_0.occult:addInvitedList(var_11_0.player_id)
	...
	if arg_11_0.occult:checkIsInvited(var_11_0.player_id) then
		var_11_2:getChildByName("img_already_invite"):setVisible(true)
		var_11_2:getChildByName("btn_invite"):setVisible(false)
	else
	...
	var_11_2:getChildByName("btn_invite"):getChildByName("txt_invite"):setString(var_0_1:translation("ILLUSION_INVITE_FRIEND_TXT2"))
end
