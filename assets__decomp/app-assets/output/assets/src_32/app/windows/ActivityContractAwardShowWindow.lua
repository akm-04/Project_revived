local var_0_0 = class("ActivityContractAwardShowWindow", import("app.windows.SummonResultWindow"))
...
function var_0_0.layout(arg_6_0)
	...
	local var_6_1 = string.format(var_0_4:translation("ACTIVITY_CONTRACT_TEXT_8"), var_6_0)
