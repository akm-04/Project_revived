local var_0_0 = class("LotteryTipsConsumeWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.layout(arg_3_0)
	...
	var_3_0:getChildByName("text_tips"):setString(var_0_2:translation("LOTTERY_CONSUME_TEXT11"))
