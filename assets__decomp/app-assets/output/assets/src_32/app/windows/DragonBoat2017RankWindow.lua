local var_0_0 = class("DragonBoat2017RankWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.layout(arg_3_0)
	arg_3_0:nodeByName("total_reward_txt"):setString(arg_3_0.selfRank.zongzi_num)
	arg_3_0:nodeByName("myrank_text"):setString(var_0_1:translation("MYRANK_TEXT"))
	arg_3_0:nodeByName("total_reward_text"):setString(var_0_1:translation("DRAGON_BOAT2017_SCORE_NUM_TEXT"))

	local function var_3_0(arg_4_0)
		local var_4_0 = "windows/activities/1104/rank/word_yellow" .. arg_4_0 .. ".png"
	...
	if arg_3_0.selfRank.rank and arg_3_0.selfRank.rank > 0 then
		...
		local var_3_2 = arg_3_0.selfRank.rank
		local var_3_3 = {}
		local var_3_4 = 1
		local var_3_5 = 0
		local var_3_6 = 0
...
function var_0_0.createListContent(arg_6_0, arg_6_1)
	...
	local var_6_2 = xyd.AssetLoader.get():loadNodeFromJson("windows/activities/1104/rank/rank_item.csb")
	local var_6_3 = var_6_2:getChildByName("container")
	local var_6_4 = var_6_0.player_info

	xyd.setPlayerAvatar(var_6_3:getChildByName("icon_container"), var_6_4)

	if var_6_4.conquer_lev and var_6_4.conquer_lev > 0 then
		var_6_3:getChildByName("lev_txt"):setString(var_6_4.conquer_lev)
		var_6_3:getChildByName("lv_bg"):setVisible(false)

		local var_6_5 = xyd.getLoopBy(var_6_4.conquer_lev, var_6_4.conquer_loop_id)

		if var_6_5 < 2 then
			var_6_5 = ""
		end

		var_6_3:getChildByName("conquer_lev_bg"):setTexture("images/conquer_lev" .. var_6_5 .. ".png")
	else
		var_6_3:getChildByName("lev_txt"):setString(var_6_4.lev)
	...
	var_6_3:getChildByName("total_reward_txt"):setString(var_6_0.zongzi_num)
	var_6_3:getChildByName("total_reward_text"):setString(var_0_1:translation("DRAGON_BOAT2017_SCORE_NUM_TEXT"))
	...
	if arg_6_1 <= 3 then
		...
		var_6_6 = xyd.AssetLoader.get():loadSprite("windows/activities/1104/rank/bg_rank" .. arg_6_1 .. ".png")
	else
		...
		var_6_6 = xyd.AssetLoader.get():loadLabel(var_6_7)

		var_6_6:setString(arg_6_1)
		var_6_6:enableOutline(cc.c4b(89, 138, 174, 255), 3)
	end

	var_6_6:setAnchorPoint(cc.p(0.5, 0.5))
	var_6_6:addTo(var_6_3:getChildByName("rank_pos"))
