local var_0_0 = class("WorldBossSweepWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.willOpen(arg_2_0, arg_2_1)
	...
	arg_2_0.world_boss = xyd.ModelManager.get():loadModel(xyd.ModelType.WORLD_BOSS)

	if arg_2_0.world_boss.perpose then
		arg_2_0.p_avatar = arg_2_0.world_boss.perpose.avatar_id
		arg_2_0.p_avatar_frame = arg_2_0.world_boss.perpose.avatar_frame_id
	end

	arg_2_0.rank = arg_2_0.world_boss.total_rank

	arg_2_0:layout()
end

function var_0_0.layout(arg_3_0)
	arg_3_0:nodeByName("boss_damage_text"):setString(arg_3_0.world_boss.the_damage)
	arg_3_0:nodeByName("my_damage_text"):setString(arg_3_0.world_boss.total_damage)
	...
	if arg_3_0.rank > 1 then
		...
		arg_3_0:nodeByName("name_text"):setString(arg_3_0.world_boss.perpose.player_name)
		arg_3_0:nodeByName("level_text"):setString(arg_3_0.world_boss.perpose.lev)
		arg_3_0:nodeByName("his_damage_text"):setString(math.floor(tonumber(arg_3_0.world_boss.perpose.hurt)))
	else
