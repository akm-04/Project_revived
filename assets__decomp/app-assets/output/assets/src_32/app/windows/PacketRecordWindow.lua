local var_0_0 = class("PacketRecordWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0.packetID = arg_1_2.id
	arg_1_0.luckyPacket = xyd.ModelManager.get():loadModel(xyd.ModelType.RED_PACKET)
end
...
function var_0_0.didOpen(arg_3_0, arg_3_1)
	...
	arg_3_0:layoutDesc()
	arg_3_0:nodeByName("title"):setString(var_0_1:translation("PACKET_GET_RECORD"))
	arg_3_0:updateRecordList()
	arg_3_0:addBlockLayer(cc.c4b(0, 0, 0, 220))
end

function var_0_0.layoutDesc(arg_4_0)
	local var_4_0 = xyd.tables.luckyPacket:pacMoney(arg_4_0.packetID)
	local var_4_1 = xyd.tables.luckyPacket:pacAmount(arg_4_0.packetID)
	local var_4_2 = display.newNode()

	var_4_2:setAnchorPoint(cc.p(0, 0))
	var_4_2:addTo(arg_4_0:nodeByName("background"))

	local var_4_3 = {
		arg_4_0:createLabel(cc.c3b(248, 198, 31), 24),
		arg_4_0:createLabel(cc.c3b(255, 255, 255), 24),
		arg_4_0:createLabel(cc.c3b(248, 198, 31), 24),
		arg_4_0:createLabel(cc.c3b(255, 255, 255), 24),
		(arg_4_0:createLabel(cc.c3b(248, 198, 31), 24))
	}
...
function var_0_0.updateRecordList(arg_6_0)
	for iter_6_0 = 1, #arg_6_0.grabPlayers do
		...
		local var_6_3 = xyd.AssetLoader.get():loadNodeFromJson("windows/lucky_packet/grab_record_item.csb")
		local var_6_4 = var_6_3:getChildByName("container")

		var_6_4:getChildByName("get_desc_txt"):setString(var_0_1:translation("PACKET_RECORD_TIP"))
		...
		local var_6_8 = {
			avatar_id = var_6_0.avatar_id,
			avatar_frame_id = var_6_0.avatar_frame_id
		}
