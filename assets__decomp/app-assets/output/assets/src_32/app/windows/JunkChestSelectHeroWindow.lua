local var_0_0 = class("JunkChestSelectHeroWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.layout(arg_3_0)
	...
	arg_3_0.petsList:setDelegate(handler(arg_3_0, arg_3_0.herosListDelegate))
	arg_3_0.petsList:setBounceable(false)
	arg_3_0.petsList:reload()
	arg_3_0:nodeByName("txt_title"):setString(var_0_1:translation("SELECT_HERO"))
	arg_3_0:nodeByName("decrease_time_txt"):setString(var_0_1:translation("SELECT_HERO_FOR_BOOK"))
end

function var_0_0.herosListDelegate(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
	if cc.ui.UIListView.COUNT_TAG == arg_4_2 then
		return math.ceil(#arg_4_0.heros / var_0_3)
...
function var_0_0.createListLineContent(arg_5_0, arg_5_1)
	...
	for iter_5_0 = 1, var_0_3 do
		if (arg_5_1 - 1) * var_0_3 + iter_5_0 <= #arg_5_0.heros then
			local var_5_4 = arg_5_0.heros[(arg_5_1 - 1) * var_0_3 + iter_5_0].id
			local var_5_5 = arg_5_0:creatHeroContent(var_5_4)
...
function var_0_0.creatHeroContent(arg_7_0, arg_7_1)
	...
	if arg_7_0.selfPlayer:getHeroIgnoreAwaken(arg_7_1) then
		arg_7_1 = arg_7_0.selfPlayer:getHeroIgnoreAwaken(arg_7_1)
		var_7_1 = true
	end

	local var_7_2 = xyd.AssetLoader.get():loadNodeFromJson("windows/event_centre/pet_room/select_pet_item.csb")
	local var_7_3 = var_7_2:getChildByName("container")

	if var_7_1 == true then
		xyd.setAvatarBorderNewUI(arg_7_1, var_7_3:getChildByName("pet"))
	else
		xyd.setAvatarBorderNewUI(arg_7_1, var_7_3:getChildByName("pet"), 1, 0)
	end

	if var_7_1 then
		var_7_3:getChildByName("txt_name"):setString(arg_7_1:getName())
	else
		var_7_3:getChildByName("txt_name"):setString(var_0_2:name(arg_7_1))
	end

	var_7_2:addTo(var_7_0)
	var_7_2:setPosition(63, 80)
