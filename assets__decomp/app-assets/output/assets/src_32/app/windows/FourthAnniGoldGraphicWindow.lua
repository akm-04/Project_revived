local var_0_0 = class("FourthAnniGoldGraphicWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.updateImg(arg_5_0)
	...
	arg_5_0.img = xyd.AssetLoader.get():loadSprite("windows/anniversary4th/main/graphic/img" .. arg_5_0.nowPage .. ".png")
