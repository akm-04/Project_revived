local var_0_0 = class("GrabPacketResultWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.playSuccess(arg_6_0)
	if arg_6_0.container then
		...
		var_6_0:setString(var_0_1:translation("CHECK_PACKET"))
	...
	arg_6_0:nodeByName("click_packet_tip"):setVisible(true)
	arg_6_0:nodeByName("click_packet_tip"):setString(var_0_1:translation("CLICK_PACKET_TIP"))
	...
	arg_6_0.redEnvelopeEffect:setPosition(arg_6_0:nodeByName("packet_pos"):getPosition())
	...
	arg_6_0:nodeByName("red_large"):addNodeEventListener(cc.NODE_TOUCH_EVENT, function(arg_7_0)
		...
		elseif arg_7_0.name == "ended" then
			...
			arg_6_0:nodeByName("click_packet_tip"):runAction(var_7_3)
	...
	arg_6_0:nodeByName("check_btn"):addTouchEventListener(function(arg_11_0, arg_11_1)
		if arg_11_1 == ccui.TouchEventType.ended then
			...
			arg_6_0.luckyPacket:loadPacketRecord(var_11_0, function(arg_12_0, arg_12_1)
				...
				xyd.WindowManager.get():openWindow("packet_record", var_12_1)
			end)
		end
	end)
end
...
function var_0_0.playFailed(arg_13_0)
	if arg_13_0.container then
		arg_13_0.container:getChildByName("open_state"):setVisible(true)
		arg_13_0.container:getChildByName("close_state"):setVisible(false)

		local var_13_0 = arg_13_0.container:getChildByName("desc_label")

		var_13_0:setString(var_0_1:translation("CHECK_PACKET"))
	...
	arg_13_0:nodeByName("click_packet_tip"):setVisible(false)
	...
	arg_13_0:nodeByName("failed_txt"):setString(var_0_1:translation("GRAB_PACKET_FAILED_TXT"))
	arg_13_0:nodeByName("check_btn"):addTouchEventListener(function(arg_14_0, arg_14_1)
		if arg_14_1 == ccui.TouchEventType.ended then
			...
			arg_13_0.luckyPacket:loadPacketRecord(var_14_0, function(arg_15_0, arg_15_1)
				...
				xyd.WindowManager.get():openWindow("packet_record", var_15_1)
			end)
		end
	end)
end
