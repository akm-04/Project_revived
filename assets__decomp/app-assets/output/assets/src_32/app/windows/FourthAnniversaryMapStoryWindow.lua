local var_0_0 = class("FourthAnniversaryMapStoryWindow", import("app.common.ui.BaseWindow"))
...
local var_0_6 = 2
local var_0_7 = 3
local var_0_8 = xyd.tables.activityAnni4thCampaignStoryTable
...
function var_0_0.ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0.fourthAnniversary = xyd.ModelManager.get():loadModel(xyd.ModelType.FOURTH_ANNIVERSARY)
end
...
function var_0_0.didOpen(arg_4_0, arg_4_1)
	...
	if arg_4_0.dialogueID == 0 or not arg_4_0.dialogData_ then
		arg_4_0:onEnded()
...
function var_0_0.createListContent(arg_8_0, arg_8_1)
	...
	local var_8_1 = xyd.AssetLoader.get():loadNodeFromJson("windows/anniversary4th/story_map/map_story/story_item.csb")
...
function var_0_0.onEnded(arg_19_0)
	...
	local var_19_0 = xyd.WindowManager.get():getWindow("fourth_annni_map_story")

	if var_19_0 and not tolua.isnull(var_19_0) then
		xyd.WindowManager.get():closeWindow("fourth_annni_map_story")
	end
end
