local var_0_0 = class("VipBoxDrawListWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0.changeName = arg_1_2.changeName
	...
	arg_1_0.title0 = "ACTIVITY_1106_TEXT_" .. arg_1_0.index + 4
end
...
function var_0_0.sourceDelegate(arg_4_0, arg_4_1, arg_4_2, arg_4_3)
	...
	elseif cc.ui.UIListView.CELL_TAG == arg_4_2 then
		...
		if arg_4_3 == arg_4_0.title1 or arg_4_3 == arg_4_0.title2 then
			local var_4_2 = xyd.AssetLoader.get():loadNodeFromJson("windows/activities/vip_box_draw/vip_box_draw_list_title.csb")
			local var_4_3

			if arg_4_3 == arg_4_0.title1 then
				var_4_3 = var_0_1:translation("ACTIVITY_VIP_BOX_DRAW_RARE")

				if arg_4_0.changeName then
					var_4_3 = var_0_1:translation("ZHANGHE_BOX_RARE")
				end
			else
				var_4_3 = var_0_1:translation("ACTIVITY_VIP_BOX_DRAW_NORMAL")

				if arg_4_0.changeName then
					var_4_3 = var_0_1:translation("ZHANGHE_BOX_NORMAL")
				end
			end
