local var_0_0 = class("SummerQuizRuleWindoww", import("app.common.ui.BaseWindow"))
...
function var_0_0.layout(arg_4_0)
	arg_4_0:nodeByName("title"):setString(var_0_1:translation("SUMMER_QUIZ_RULE_TITLE"))
	...
	arg_4_0:nodeByName("left_hua"):setPositionX(arg_4_0:nodeByName("left_hua"):getPositionX() - 50)
	arg_4_0:nodeByName("right_hua"):setPositionX(arg_4_0:nodeByName("right_hua"):getPositionX() + 50)
...
function var_0_0.createRuleLabel(arg_6_0)
	local var_6_0 = var_0_1:translation("SUMMER_QUIZ_RULE_TEXT")
