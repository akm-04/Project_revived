local var_0_0 = class("ActivityGachaRuleWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.layout(arg_4_0)
	arg_4_0:nodeByName("title_txt"):setString(var_0_1:translation(arg_4_0.title))
