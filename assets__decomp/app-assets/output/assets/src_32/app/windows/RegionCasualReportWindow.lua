local var_0_0 = class("RegionCasualReportWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.willOpen(arg_2_0, arg_2_1)
	...
	if not arg_2_0.attackerAvatar or arg_2_0.attackerAvatar == 0 or arg_2_0.attackAvatar == "0" or arg_2_0.attackAvatar == "0.0" then
		arg_2_0.attackerAvatar = xyd.tables.avatar.icon_[xyd.tables.misc.defaultAvatarId]
	end

	if not arg_2_0.defenderAvatar or arg_2_0.defenderAvatar == 0 or arg_2_0.defenderAvatar == "0" or arg_2_0.defenderAvatar == "0.0" then
		arg_2_0.defenderAvatar = xyd.tables.avatar.icon_[xyd.tables.misc.defaultAvatarId]
	end
	...
	arg_2_0.peakArena = xyd.ModelManager.get():loadModel(xyd.ModelType.PEAK_ARENA)
