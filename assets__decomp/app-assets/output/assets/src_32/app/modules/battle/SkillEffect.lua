local var_0_0 = ngx
local var_0_1 = class("SkillEffect", function(arg_1_0, arg_1_1, arg_1_2)
	...
	if arg_1_1 == "self" then
		var_1_0, var_1_1 = xyd.tables.skill:selfResource(arg_1_0)
	elseif arg_1_1 == "area" then
		var_1_0, var_1_1 = xyd.tables.skill:areaResource(arg_1_0)
	elseif arg_1_1 == "unit" then
		var_1_0, var_1_1 = xyd.tables.skill:unitResource(arg_1_0)
	elseif arg_1_1 == "hurt" then
		var_1_0, var_1_1 = xyd.tables.skill:hurtResource(arg_1_0)
	end

	local var_1_2 = cc.FileUtils:getInstance():fullPathForFilename("/res/" .. var_1_0)
	local var_1_3 = cc.FileUtils:getInstance():fullPathForFilename("/res/" .. var_1_1)

	if var_1_0 and var_1_1 and var_1_0 ~= "" and var_1_1 ~= "" then
		return sp.SkeletonAnimation:create(var_1_0, var_1_1, arg_1_2 or 1)
	end
end)
...
function var_0_1.ctor(arg_2_0, arg_2_1, arg_2_2, arg_2_3, arg_2_4)
	...
	if arg_2_2 == "self" then
		arg_2_0.key = xyd.tables.skill:selfResource(arg_2_1)
	elseif arg_2_2 == "area" then
		arg_2_0.key = xyd.tables.skill:areaResource(arg_2_1)
	elseif arg_2_2 == "unit" then
		arg_2_0.key = xyd.tables.skill:unitResource(arg_2_1)
	elseif arg_2_2 == "hurt" then
		arg_2_0.key = xyd.tables.skill:hurtResource(arg_2_1)
	end
