local var_0_0 = class("EventCentreRecycleTable")
...
function var_0_0.ctor(arg_1_0)
	...
	arg_1_0.recountItem_ = {}
	arg_1_0.energyLimit_ = {}
	arg_1_0.cutCostEnergy_ = {}
	arg_1_0.critUp_ = {}

	import("app.common.tables.TableParser").parse("event_centre_recycle.lua", function(arg_2_0)
		...
		arg_1_0.functionRequest_[var_2_0] = tonumber(arg_2_0.function_request)
		arg_1_0.functionRequestLevel_[var_2_0] = tonumber(arg_2_0.function_request_level)
		arg_1_0.recountItem_[var_2_0] = xyd.splitToNumber(arg_2_0.recount_item, "|")
		arg_1_0.energyLimit_[var_2_0] = tonumber(arg_2_0.energy_limit)
		arg_1_0.cutCostEnergy_[var_2_0] = tonumber(arg_2_0.cut_cost_energy)
		arg_1_0.critUp_[var_2_0] = tonumber(arg_2_0.crit_up)
	end)
end
...
function var_0_0.recountItem(arg_11_0, arg_11_1)
	return arg_11_0.recountItem_[arg_11_1] or {}
end

function var_0_0.energyLimit(arg_12_0, arg_12_1)
	return arg_12_0.energyLimit_[arg_12_1] or 0
end

function var_0_0.cutCostEnergy(arg_13_0, arg_13_1)
	return arg_13_0.cutCostEnergy_[arg_13_1] or 0
end

function var_0_0.critUp(arg_14_0, arg_14_1)
	return arg_14_0.critUp_[arg_14_1] or 0
end
