local var_0_0 = class("ActivityCandleRangeRewardTable")
...
function var_0_0.ctor(arg_1_0)
	...
	import("app.common.tables.TableParser").parse("activity_candle_range_reward.lua", function(arg_2_0)
...
function var_0_0.ids(arg_7_0)
	return table.keys(arg_7_0.range_)
end
