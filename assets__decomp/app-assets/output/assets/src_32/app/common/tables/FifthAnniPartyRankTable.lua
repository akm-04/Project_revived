local var_0_0 = class("FifthAnniPartyRankTable")
...
function var_0_0.ctor(arg_1_0)
	...
	import("app.common.tables.TableParser").parse("fifth_anni_party_rank.lua", function(arg_2_0)
		local var_2_0 = tonumber(arg_2_0.id)

		arg_1_0.range_[var_2_0] = tonumber(arg_2_0.range)
		arg_1_0.gift_[var_2_0] = tonumber(arg_2_0.gift)
		arg_1_0.titleId_[var_2_0] = tonumber(arg_2_0.title_id)
	end)
end
...
function var_0_0.titleId(arg_6_0, arg_6_1)
	return arg_6_0.titleId_[arg_6_1] or 0
end
