...
function var_0_0.ctor(arg_1_0, arg_1_1)
	...
	import("app.common.tables.TableParser").parse("dreamworld_story.lua", function(arg_2_0)
		...
		arg_1_0.favorCharacter_[var_2_0] = xyd.splitToNumber(arg_2_0.favor_character, "|")
		arg_1_0.favorParam_[var_2_0] = xyd.splitToNumber(arg_2_0.favor_param, "|")
...
function var_0_0.trends(arg_12_0, arg_12_1)
	return arg_12_0.trends_[arg_12_1]
end

function var_0_0.expression(arg_13_0, arg_13_1)
	return arg_13_0.expression_[arg_13_1]
end

function var_0_0.favorCharacter(arg_14_0, arg_14_1)
	return arg_14_0.favorCharacter_[arg_14_1]
end

function var_0_0.favorParam(arg_15_0, arg_15_1)
	return arg_15_0.favorParam_[arg_15_1]
end
