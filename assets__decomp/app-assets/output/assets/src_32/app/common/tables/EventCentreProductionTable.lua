local var_0_0 = class("EventCentreProductionTable")
...
function var_0_0.ctor(arg_1_0)
	...
	arg_1_0.makeItem_ = {}
	arg_1_0.cutMakeTime_ = {}

	import("app.common.tables.TableParser").parse("event_centre_table.lua", function(arg_2_0)
		...
		arg_1_0.makeItem_[var_2_0] = xyd.splitToNumber(arg_2_0.item_id, "|")
		arg_1_0.cutMakeTime_[var_2_0] = tonumber(arg_2_0.cut_maketime)
	end)
end
...
function var_0_0.makeItem(arg_11_0, arg_11_1)
	return arg_11_0.makeItem_[arg_11_1] or {}
end

function var_0_0.cutMakeTime(arg_12_0, arg_12_1)
	return arg_12_0.cutMakeTime_[arg_12_1] or 0
end
