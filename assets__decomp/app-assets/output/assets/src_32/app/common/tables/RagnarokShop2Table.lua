local var_0_0 = class("RagnarokShop2Table")
...
function var_0_0.ctor(arg_1_0)
	...
	import("app.common.tables.TableParser").parse("activity_ragnarok_shop2.lua", function(arg_2_0)
...
function var_0_0.condition(arg_8_0, arg_8_1)
	return arg_8_0.condition_[arg_8_1] or 0
end

function var_0_0.conditionDesc(arg_9_0, arg_9_1)
	return arg_9_0.conditionDesc_[arg_9_1] or ""
end
