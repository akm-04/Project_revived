local var_0_0 = class("ActivityDiglettShopTable")
...
function var_0_0.ctor(arg_1_0)
	...
	import("app.common.tables.TableParser").parse("activity_diglett_shop.lua", function(arg_2_0)
...
function var_0_0.ids(arg_8_0, ...)
	return table.keys(arg_8_0.itemId_) or {}
end
