local var_0_0 = class("ActivitySummerQuizRewardTable")
...
function var_0_0.ctor(arg_1_0)
	...
	import("app.common.tables.TableParser").parse("activity_summer_quiz_reward.lua", function(arg_2_0)
...
function var_0_0.range(arg_3_0, arg_3_1)
	return arg_3_0.range_[arg_3_1] or {}
end
...
function var_0_0.item(arg_5_0, arg_5_1)
	return arg_5_0.item_[arg_5_1] or {}
end
