...
local var_0_3 = var_0_0.class("Lvlingqi", var_0_1.ctx.battle.getRequire("BaseFighter"))
...
local var_0_24 = 20001464
local var_0_25 = 10002225
local var_0_26 = {
	40012372,
	40012373
}
...
function var_0_3.setSummonMonsters(arg_6_0, arg_6_1, arg_6_2, arg_6_3, arg_6_4)
	...
	if var_0_2.BattleType.ReplayReport == var_0_1.ctx.battle.battleType then
		...
		for iter_6_0, iter_6_1 in ipairs(var_6_1.skillLev_) do
			local var_6_2 = var_6_1:getSkillId(iter_6_0)
			local var_6_3 = arg_6_0.hero_:getSkillLevelByID(var_6_2)

			if var_6_3 and var_6_3 > 0 then
				var_6_1.skillLev_[iter_6_0] = var_6_3
			end
		end

		local var_6_4 = var_6_1:className()

		var_6_0 = var_0_1.ctx.battle.requireFighter(var_6_4).new({
	...
	if arg_6_0.extraSkillLevel2 > 0 then
		local var_6_5 = arg_6_0.extraSkillLevel2 * var_0_8:attrValues(var_0_19) / var_0_2.PERCENT_BASE * arg_6_0:getAD()

		var_6_0:setExtraAD(var_6_5)
	end
	...
	if arg_6_0.bloodyTarget_ and not arg_6_0.bloodyTarget_:isDeath() then
		...
		local var_6_6 = arg_6_0:newBuff(var_0_22, var_6_0, arg_6_0:getEnergySkillID())

		var_6_0:addBuffs(var_6_6)
	end

	if arg_6_0:hasElementEquipByID(var_0_24) then
		local var_6_7 = var_0_24
		local var_6_8 = var_0_23:battleAttr(var_6_7, arg_6_0:getElementEquipLevelByID(var_6_7))
		local var_6_9 = arg_6_0.hero_:getElementEquipActiveRate(var_6_7)
		local var_6_10 = arg_6_0:createNewBuffs(var_0_26, var_6_0, var_0_25)

		for iter_6_2, iter_6_3 in ipairs(var_6_10) do
			if iter_6_3:getAttrType() == var_0_2.AttributeType.HP then
				local var_6_11 = var_6_8 * var_6_0:getHpLimit() * var_6_9

				var_6_0:resetHpLimit(var_6_0:getHpLimit() + var_6_11)
			elseif iter_6_3:getAttrType() == var_0_2.AttributeType.AD then
				iter_6_3.manualRevise = var_6_8 * var_6_0:getAD() * var_6_9
			end
		end

		var_6_0:addBuffs(var_6_10)
	end

	local var_6_12 = var_6_0:getTeamType() == var_0_2.TeamType.A and var_0_1.ctx.battle.teamA or var_0_1.ctx.battle.teamB
