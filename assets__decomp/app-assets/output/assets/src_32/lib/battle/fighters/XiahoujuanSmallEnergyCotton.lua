...
local var_0_3 = var_0_0.class("XiahoujuanSmallEnergyCotton", var_0_1.ctx.battle.getRequire("BaseFighter"))
...
function var_0_3.updateUnitDataByFighter(arg_6_0, arg_6_1, arg_6_2, arg_6_3, arg_6_4, arg_6_5, arg_6_6, arg_6_7)
	...
	if arg_6_1.skillID == var_0_10 and var_6_2 > 0 and arg_6_0.harmExtra_ then
		var_6_2 = var_6_2 * arg_6_0.harmExtra_
	end
