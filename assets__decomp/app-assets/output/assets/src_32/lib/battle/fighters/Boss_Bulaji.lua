...
local var_0_3 = var_0_0.class("Bulaji", var_0_1.ctx.battle.requireFighter("Boss"))
...
local var_0_16 = 10002445
local var_0_17 = 10002441
local var_0_18 = 10002442
local var_0_19 = 10002446
local var_0_20 = 150
local var_0_21 = 40012490
local var_0_22 = 10002433
local var_0_23 = 450
...
function var_0_3.buffAddAction(arg_6_0, arg_6_1)
	...
	elseif arg_6_1:getTableID() == var_0_21 then
		arg_6_0.bossBuffCount = arg_6_0.bossBuffCount + 1

		if var_0_2.BattleType.ReplayReport ~= var_0_1.ctx.battle.battleType and arg_6_0.bossBuffCount >= 5 then
			local var_6_0 = arg_6_0:getTargets(var_0_22)
			local var_6_1 = arg_6_0:createAttackUnits(var_6_0, var_0_22)
...
function var_0_3.getHuJia(arg_10_0)
	local var_10_0 = math.floor(var_0_1.ctx.battle.count / var_0_23)
	local var_10_1 = 1
	...
	return arg_10_0:getAttrByType(var_0_2.AttributeType.HUJIA) * var_10_1
end

function var_0_3.getMoKang(arg_11_0)
	local var_11_0 = math.floor(var_0_1.ctx.battle.count / var_0_23)
	local var_11_1 = 1
	...
	return arg_11_0:getAttrByType(var_0_2.AttributeType.MOKANG) * var_11_1
end
