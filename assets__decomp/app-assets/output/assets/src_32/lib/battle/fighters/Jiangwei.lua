...
local var_0_3 = var_0_0.class("Jiangwei", var_0_1.ctx.battle.getRequire("BaseFighter"))
local var_0_4 = var_0_2.tables.skill
local var_0_5 = 10
local var_0_6 = -100
local var_0_7 = 10000327
local var_0_8 = 10000326
local var_0_9 = 10000609
...
function var_0_3.getFarest(arg_5_0)
	...
	if var_5_0 and var_5_0:avoidHeroMoveBehind() then
		var_5_1 = var_5_1 - (var_5_1 > 0 and 120 or -120)
	end
...
function var_0_3.applyHurtFighter(arg_11_0, arg_11_1, arg_11_2, arg_11_3, arg_11_4, arg_11_5)
	if arg_11_2 > 0 and var_0_2.BattleType.ReplayReport ~= var_0_1.ctx.battle.battleType and arg_11_0:getSkillLevelByColor(var_0_2.SKILL_INDEX.Purple) > 0 and var_0_4:type(arg_11_1.skillID) == var_0_2.AttackType.AD and arg_11_1.skillID ~= var_0_9 then
	...
	local var_11_3, var_11_4, var_11_5, var_11_6 = var_0_3.super.applyHurtFighter(arg_11_0, arg_11_1, arg_11_2, arg_11_3, arg_11_4, arg_11_5)

	return var_11_3, var_11_4, var_11_5, var_11_6
end
...
function var_0_3.getEnergyTarget(arg_13_0)
	local var_13_0 = var_0_4:scope(var_0_7)
	local var_13_1 = {}

	for iter_13_0, iter_13_1 in ipairs(arg_13_0.targetTeam_) do
		if not iter_13_1:isDeath() and not iter_13_1:isAffected() and math.abs(iter_13_1:getX() - arg_13_0.energyPosX_) < var_13_0 / 2 then
...
function var_0_3.selectTargetByTypeD1(arg_14_0, arg_14_1, arg_14_2)
	...
	table.sort(var_14_0, function(arg_15_0, arg_15_1)
		return arg_15_0:getX() < arg_15_1:getX()
	end)
	...
	elseif #var_14_0 == 2 then
		return math.abs(var_14_0[1]:getX() - arg_14_0:getX()) > math.abs(var_14_0[2]:getX() - arg_14_0:getX()) and {
			var_14_0[2]
		} or {
			var_14_0[1]
		}
	elseif #var_14_0 == 3 then
		...
		for iter_14_2 = 2, #var_14_0 - 1 do
			if not var_14_1 or var_14_1 > var_14_0[iter_14_2 + 1]:getX() - var_14_0[iter_14_2 - 1]:getX() then
				var_14_1 = var_14_0[iter_14_2 + 1]:getX() - var_14_0[iter_14_2 - 1]:getX()
				var_14_2 = var_14_0[iter_14_2]
			end
		end
...
function var_0_3.unitAfterCreate(arg_16_0, arg_16_1, arg_16_2)
	if arg_16_1 and arg_16_1.skillID == var_0_8 then
		arg_16_0.rushUnit_ = arg_16_1
	end
end

function var_0_3.isHurtBreak(arg_17_0, arg_17_1, arg_17_2)
	if arg_17_1 > arg_17_0:getHpLimit() * var_0_2.SHOW_HURT_EFFECT_RATE and arg_17_0.isEnergySkill_ ~= true and not arg_17_0:isPause() and next(arg_17_0.rushUnit_ or {}) == nil or arg_17_2:isForceBreak() then
		return true
	end
...
function var_0_3.checkSkillBreak(arg_18_0, arg_18_1, arg_18_2)
	...
	if arg_18_1 == var_0_2.BreakSkillType.AD then
		if arg_18_0:isAdBreakImmortal() or arg_18_0:isBreakImmortal() then
			return
		end
...
function var_0_3.clickAvatar(arg_19_0, arg_19_1)
	if arg_19_1.name == "ended" and var_0_1.ctx.battle.autoA ~= true then
		if next(arg_19_0.skillRush_) then
			arg_19_0.skillRush_ = {}

			if arg_19_0:getX() > var_0_2.STAGE_WIDTH - arg_19_0:getFighterModel():getWidth() / 2 then
				arg_19_0:x(var_0_2.STAGE_WIDTH - arg_19_0:getFighterModel():getWidth() / 2)
			elseif arg_19_0:getX() < arg_19_0:getFighterModel():getWidth() / 2 then
				arg_19_0:x(arg_19_0:getFighterModel():getWidth() / 2)
			end
		end
...
function var_0_3.beginAttackEnd(arg_20_0, arg_20_1)
	...
	if arg_20_1.rootID_ == arg_20_0:getSkillByColor(var_0_2.SKILL_INDEX.Blue) then
		local var_20_0 = arg_20_0:getFarest()

		if var_20_0 then
			arg_20_0:flipX(var_20_0:getX() < arg_20_0:getX())
		end
	elseif arg_20_1.rootID_ == arg_20_0:getEnergySkillID() then
		arg_20_0.noEnergy_ = true
	end
end

function var_0_3.checkEnergySkill(arg_21_0)
	if arg_21_0.noEnergy_ then
		return false
	end

	return var_0_3.super.checkEnergySkill(arg_21_0)
end
