...
local var_0_3 = var_0_0.class("MazeFazheng", var_0_1.ctx.battle.requireFighter("ElementBoss"))
...
function var_0_3.applySingleUnit(arg_4_0, arg_4_1)
	...
	if arg_4_1.skillID == arg_4_0:getSkillByColor(var_0_2.SKILL_INDEX.Green) then
		...
		local var_4_1 = var_4_0.hero_:getHeroID()
		...
		if var_0_2.BattleType.ReplayReport == var_0_1.ctx.battle.battleType then
			...
			local var_4_6 = var_0_2.ModelManager.get():loadModel(var_0_2.ModelType.SELF_PLAYER):getHeroByID(var_4_1)
		...
		table.insert(arg_4_0.summonMonsters_, var_4_4)
...
function var_0_3.die(arg_14_0)
	...
	if arg_14_0.summonMonsters_ and next(arg_14_0.summonMonsters_) then
		for iter_14_0, iter_14_1 in ipairs(arg_14_0.summonMonsters_) do
			if not iter_14_1:isDeath() then
				iter_14_1:updateHp(0)
				iter_14_1:die()
			end
		end
	end
