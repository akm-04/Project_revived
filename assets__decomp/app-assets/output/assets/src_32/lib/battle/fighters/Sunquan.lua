...
local var_0_3 = var_0_0.class("Sunquan", var_0_1.ctx.battle.getRequire("BaseFighter"))
...
local var_0_11 = 40010056
local var_0_12 = 45
local var_0_13 = 10420008
local var_0_14 = 10000181
local var_0_15 = {
	20010113,
	20010114
}
local var_0_16 = 300
local var_0_17 = 120
local var_0_18 = 10000180
local var_0_19 = 30010025
local var_0_20 = 15
local var_0_21 = 80010056
local var_0_22 = 80020056
local var_0_23 = {
	40011110
}
local var_0_24 = 200
local var_0_25 = 0.2
local var_0_26 = 10001003
...
function var_0_3.init(arg_1_0)
	...
	arg_1_0.skinMpInfos_ = {}
	arg_1_0.skinHpInfos_ = {}
end
...
function var_0_3.jugeGreenSkill(arg_2_0)
	if arg_2_0:getSkillLevelByColor(var_0_2.SKILL_INDEX.Green) > 0 then
		...
		arg_2_0.greenRatio = math.abs(var_0_9:init(var_0_19) + var_0_9:step(var_0_19) * arg_2_0:getSkillLevelByColor(var_0_2.SKILL_INDEX.green))
	else
...
function var_0_3.getExtraHarm(arg_3_0)
	if arg_3_0:getSkillLevelByColor(var_0_2.SKILL_INDEX.Purple) > 0 and not arg_3_0.extraHarm then
		arg_3_0.extraHarm = var_0_8:init(var_0_14) + var_0_8:step(var_0_14) * arg_3_0:getSkillLevelByColor(var_0_2.SKILL_INDEX.Purple)
	end
end
...
function var_0_3.toDoPerFrames(arg_5_0)
	...
	if arg_5_0.greenExist then
		...
		elseif arg_5_0:getOriHurt() ~= 0 and var_0_2.BattleType.ReplayReport ~= var_0_1.ctx.battle.battleType then
			...
			arg_5_0.greenSkillCD_ = var_0_12
		end
	end

	if not arg_5_0.extraSkillJudge then
		arg_5_0.extraSkillJudge = true
		arg_5_0.extraSkillLevel = arg_5_0.hero_:skillBook()[tostring(var_0_13)] or 0
		arg_5_0.extraSkillHp = arg_5_0.extraSkillLevel * var_0_10:attrValues(var_0_13)
	end
end
...
function var_0_3.beginAttackEnd(arg_6_0, arg_6_1)
	...
	if var_0_8:father(arg_6_1.rootID_) == arg_6_0:getSkillByColor(var_0_2.SKILL_INDEX.Green) then
		arg_6_0:addSpecialBuff()

		arg_6_0.skinMpInfos_ = {}
		arg_6_0.skinHpInfos_ = {}
	end
end
...
function var_0_3.addSpecialBuff(arg_7_0)
	...
	arg_7_0:addBuffs(var_7_0(var_0_15, var_7_1, var_7_2, arg_7_0))
end

function var_0_3.applySingleUnit(arg_9_0, arg_9_1)
	var_0_3.super.applySingleUnit(arg_9_0, arg_9_1)

	if var_0_8:father(arg_9_1.skillID) == arg_9_0:getSkillByColor(var_0_2.SKILL_INDEX.Green) then
		if next(arg_9_1.target.buffs_) ~= nil then
			for iter_9_0 = #arg_9_1.target.buffs_, 1, -1 do
				local var_9_0 = arg_9_1.target.buffs_[iter_9_0]

				if var_9_0 and var_9_0:getType() == var_0_2.BuffType.D_HARM then
		...
		if arg_9_0.isSkinSkillOn_ and arg_9_0.skinSkillID_ == var_0_22 and not arg_9_1.target:isDeath() and arg_9_1.target.__cname ~= "Sunquan" then
			local var_9_1 = arg_9_0:createNewBuffs(var_0_23, arg_9_1.target, arg_9_0:getEnergySkillID())

			arg_9_1.target:addBuffs(var_9_1)
		end
	end
end
	...
	for iter_10_0, iter_10_1 in ipairs(var_10_0) do
		if iter_10_1:getSummonType() == 0 and not iter_10_1:isDeath() then
			...
			if iter_10_1:getTeamType() == var_0_2.TeamType.A then
				var_10_2.x = var_10_2.x + var_0_17
			else
				var_10_2.x = var_10_2.x - var_0_17
			end

			if var_0_2.BattleType.ReplayReport == var_0_1.ctx.battle.battleType then
				var_10_1 = arg_10_0:getSummonMonster()
			else
				local var_10_3 = var_0_7.new()

				var_10_3:populateWithTableID(arg_10_1)

				var_10_3.level_ = arg_10_2 or var_10_3.level_
				var_10_3.color_ = arg_10_3 or var_10_3.color_

				for iter_10_2, iter_10_3 in ipairs(var_10_3.skillLev_) do
					local var_10_4 = var_10_3:getSkillId(iter_10_2)
					local var_10_5 = arg_10_0.hero_:getSkillLevelByID(var_10_4)

					if var_10_5 and var_10_5 > 0 then
						var_10_3.skillLev_[iter_10_2] = var_0_0.clone(var_10_5)
					end
				end

				local var_10_6 = var_10_3:className()

				var_10_1 = var_0_1.ctx.battle.requireFighter(var_10_6).new({
					is_arena = arg_10_0.isInArena_
				})

				var_10_1:populateWithHero(var_10_3)
				var_10_1:initModels()
			...
			if not var_10_1 then
				arg_10_0:summonMonstersErrorLog()
			end

			if arg_10_0.extraSkillLevel > 0 and var_10_1.setExtraSkillHp then
				var_10_1:setExtraSkillHp(arg_10_0.extraSkillHp)
			end
			...
			if arg_10_0.isSkinSkillOn_ and arg_10_0.skinSkillID_ == var_0_21 and var_10_1.setSkinCureType then
				var_10_1:setSkinCureType(true)
			end

			local var_10_7 = var_10_1:getTeamType() == var_0_2.TeamType.A and var_0_1.ctx.battle.teamA or var_0_1.ctx.battle.teamB

			table.insert(var_10_7, var_10_1)
			table.insert(var_0_1.ctx.battle.yOrder, var_10_1)
			var_0_1.ctx.battle.updateZorder()

			arg_10_0.copyTime = var_0_0.clone(var_0_16)
...
function var_0_3.readyToChange(arg_14_0)
	...
	arg_14_0.readyTime = var_0_0.clone(var_0_20)
end
...
function var_0_3.calculateUnitData(arg_16_0, arg_16_1)
	...
	if arg_16_1.skillID == var_0_11 and var_16_2 > 0 then
		local var_16_6 = 0
	...
	elseif arg_16_1.skillID == var_0_18 then
...
function var_0_3.checkSpGive(arg_20_0, arg_20_1, arg_20_2)
	if arg_20_0.skinMpInfos_[arg_20_1.target] and arg_20_0.skinMpInfos_[arg_20_1.target] >= var_0_24 then
		arg_20_2 = 0
	else
		local var_20_0 = arg_20_0.skinMpInfos_[arg_20_1.target] or 0

		if var_20_0 + arg_20_2 > var_0_24 then
			arg_20_2 = var_0_24 - var_20_0
			arg_20_0.skinMpInfos_[arg_20_1.target] = var_0_24
		else
			arg_20_0.skinMpInfos_[arg_20_1.target] = var_20_0 + arg_20_2
		end
	end
...
function var_0_3.updateUnitDataBySpecialHero(arg_21_0, arg_21_1, arg_21_2, arg_21_3, arg_21_4, arg_21_5, arg_21_6, arg_21_7)
	arg_21_2, arg_21_3, arg_21_4, arg_21_5, arg_21_6, arg_21_7 = var_0_3.super.updateUnitDataBySpecialHero(arg_21_0, arg_21_1, arg_21_2, arg_21_3, arg_21_4, arg_21_5, arg_21_6, arg_21_7)

	if arg_21_5 > 0 and arg_21_0.isSkinSkillOn_ and arg_21_0.skinSkillID_ == var_0_22 and arg_21_1.target:isHasBuffByID(var_0_23[1]) then
		local var_21_0 = arg_21_1.target:getHpLimit() * var_0_25

		if not arg_21_0.skinHpInfos_[arg_21_1.target] or var_21_0 > arg_21_0.skinHpInfos_[arg_21_1.target] then
			local var_21_1 = arg_21_5 * 0.5

			arg_21_0.skinHpInfos_[arg_21_1.target] = arg_21_0.skinHpInfos_[arg_21_1.target] or 0

			if var_21_0 < arg_21_0.skinHpInfos_[arg_21_1.target] + var_21_1 then
				var_21_1 = var_21_0 - arg_21_0.skinHpInfos_[arg_21_1.target]
			end

			arg_21_0.skinHpInfos_[arg_21_1.target] = arg_21_0.skinHpInfos_[arg_21_1.target] + var_21_1

			local var_21_2 = arg_21_0:createAttackUnits({
				arg_21_0
			}, var_0_26)

			for iter_21_0, iter_21_1 in ipairs(var_21_2) do
				iter_21_1.cure_num = var_21_1

				table.insert(arg_21_0.moveAttackUnits_, iter_21_1)
				table.insert(arg_21_0.records_.special_units, iter_21_1)
			end
		end

		arg_21_5 = arg_21_5 * 0.5
	end

	return arg_21_2, arg_21_3, arg_21_4, arg_21_5, arg_21_6, arg_21_7
end

function var_0_3.updateUnitDataByFighter(arg_22_0, arg_22_1, arg_22_2, arg_22_3, arg_22_4, arg_22_5, arg_22_6, arg_22_7)
	arg_22_2, arg_22_3, arg_22_4, arg_22_5, arg_22_6, arg_22_7 = var_0_3.super.updateUnitDataByFighter(arg_22_0, arg_22_1, arg_22_2, arg_22_3, arg_22_4, arg_22_5, arg_22_6, arg_22_7)

	if arg_22_1.skillID == var_0_26 and arg_22_1.cure_num and arg_22_1.cure_num > 0 then
		arg_22_5 = arg_22_5 + arg_22_1.cure_num
	end

	return arg_22_2, arg_22_3, arg_22_4, arg_22_5, arg_22_6, arg_22_7
end
