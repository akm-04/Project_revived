...
local var_0_3 = var_0_0.class("Luxifa", var_0_1.ctx.battle.requireFighter("ElementBoss"))
...
function var_0_3.calculateUnitData(arg_7_0, arg_7_1)
	...
	if arg_7_1.skillID == var_0_10 and arg_7_1.target == arg_7_0.energyTarget_ then
		var_7_2 = var_7_2 + arg_7_1.target:getDamage() * (var_0_21 + var_0_22 * arg_7_0:getSkillLevelByID(arg_7_0:getEnergySkillID()))
	end
...
function var_0_3.summonDeathHero(arg_10_0, arg_10_1)
	...
	if var_0_2.BattleType.ReplayReport == var_0_1.ctx.battle.battleType then
		local var_10_4 = "B|" .. tostring(#var_0_1.ctx.battle.teamB + 1)
		...
		var_10_3.fighterIndex = "B|" .. tostring(#var_0_1.ctx.battle.teamB + 1)
...
function var_0_3.toDoPerFrames(arg_13_0)
	...
	if arg_13_0:getSkillLevelByColor(var_0_2.SKILL_INDEX.Purple) > 0 then
		for iter_13_2, iter_13_3 in ipairs(arg_13_0:getInfoByKey("death_info")) do
			if iter_13_3:getTeamType() == arg_13_0:getTeamType() and iter_13_3 ~= arg_13_0 and not arg_13_0:isDeath() and iter_13_3.summonType_ == var_0_2.summonMonsterType.None then
				...
				for iter_13_4, iter_13_5 in ipairs(var_13_5) do
					...
					local var_13_9 = arg_13_0:setSummonMonsters(iter_13_5, var_13_6, var_13_7, var_13_8)

					table.insert(arg_13_0.purpleMonsters_, var_13_9)
				end
			end
		end
	end
