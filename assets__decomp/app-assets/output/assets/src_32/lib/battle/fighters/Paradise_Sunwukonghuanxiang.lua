...
local var_0_3 = var_0_0.class("ParadiseSunwukonghuanxiang", var_0_1.ctx.battle.getRequire("BaseFighter"))
local var_0_4 = 1
local var_0_5 = 20
local var_0_6 = 0.5
local var_0_7 = 10
...
function var_0_3.getShanBi(arg_3_0)
	return var_0_3.super.getShanBi(arg_3_0) + var_0_4 * arg_3_0:getSkillLevelByColor(var_0_2.SKILL_INDEX.Green)
end
