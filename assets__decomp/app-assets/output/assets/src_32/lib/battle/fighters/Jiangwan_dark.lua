...
function var_0_3.purpleRemoveBuff(arg_5_0, arg_5_1, arg_5_2)
	local var_5_0 = arg_5_1:getBuffs()
	local var_5_1

	if arg_5_2 then
		var_5_1 = var_0_2.BuffForm.GAIN
	else
		var_5_1 = var_0_2.BuffForm.DEBUFF
	end

	for iter_5_0, iter_5_1 in ipairs(var_5_0) do
		local var_5_2 = iter_5_1:getTableID()

		if var_0_4:buffForm(var_5_2) == var_5_1 then
			arg_5_1:removeBuffByID(var_5_2)
		end
	end
end

function var_0_3.updateUnitDataByFighter(arg_6_0, arg_6_1, arg_6_2, arg_6_3, arg_6_4, arg_6_5, arg_6_6, arg_6_7)
	if arg_6_0:getSkillLevelByColor(var_0_2.SKILL_INDEX.Awake) > 0 and arg_6_1.skillID ~= arg_6_0:getPugongID() then
		local var_6_0 = var_0_5 + var_0_6 * arg_6_0:getSkillLevelByColor(var_0_2.SKILL_INDEX.Awake)

		arg_6_4 = (1 + var_6_0) * arg_6_4
		arg_6_5 = (1 + var_6_0) * arg_6_5
	end
