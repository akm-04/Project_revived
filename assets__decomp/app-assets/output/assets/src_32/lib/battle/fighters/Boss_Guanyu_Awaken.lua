...
local var_0_3 = var_0_0.class("Guanyu", var_0_1.ctx.battle.requireFighter("Boss"))
...
function var_0_3.applyBuffMoves(arg_3_0)
	if var_0_1.ctx.battle.isEnergySkilling and arg_3_0.acttionInBlack_ ~= true or not arg_3_0:isHasBuffByID(var_0_7) then
		return
	end

	var_0_3.super.super.applyBuffMoves(arg_3_0)
end

function var_0_3.distributeBuffMove(arg_4_0, arg_4_1)
	if arg_4_1.fighter ~= arg_4_0 then
		return
	end

	var_0_3.super.distributeBuffMove(arg_4_0, arg_4_1)
end
