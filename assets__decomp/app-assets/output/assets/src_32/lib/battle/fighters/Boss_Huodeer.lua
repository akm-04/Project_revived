...
local var_0_3 = var_0_0.class("Huodeer", var_0_1.ctx.battle.requireFighter("Boss"))
...
function var_0_3.beginAttackEnd(arg_3_0, arg_3_1)
	...
	if arg_3_1.rootID_ == arg_3_0:getSkillByColor(var_0_2.SKILL_INDEX.Green) then
		local var_3_0 = arg_3_0:selectTargetByTypeD2(arg_3_0:getSkillByColor(var_0_2.SKILL_INDEX.Green))
		...
		if next(var_3_0) then
			...
			arg_3_0.greenEffect = var_0_1.ctx.battle.getSpine(arg_3_0:getSkillByColor(var_0_2.SKILL_INDEX.Green), "area", 1)
	...
	if arg_3_1.rootID_ == arg_3_0:getSkillByColor(var_0_2.SKILL_INDEX.Blue) then
		local var_3_5 = var_0_6.B30(arg_3_0, arg_3_0:getSkillByColor(var_0_2.SKILL_INDEX.Blue))
		...
		if next(var_3_5) then
			...
			arg_3_0.blueEffect = var_0_1.ctx.battle.getSpine(arg_3_0:getSkillByColor(var_0_2.SKILL_INDEX.Blue), "area", 1)
	...
	if arg_3_1.rootID_ == arg_3_0:getSkillByColor(var_0_2.SKILL_INDEX.Purple) then
		local var_3_10 = var_0_6.B30(arg_3_0, arg_3_0:getSkillByColor(var_0_2.SKILL_INDEX.Purple))
		...
		if next(var_3_10) then
			...
			arg_3_0.purpleEffect = var_0_1.ctx.battle.getSpine(arg_3_0:getSkillByColor(var_0_2.SKILL_INDEX.Purple), "area", 1)
...
function var_0_3.toDoPerFrames(arg_6_0)
	if arg_6_0.purpleEffectCount > 0 then
		...
		local var_6_0 = var_0_7:scope(arg_6_0:getSkillByColor(var_0_2.SKILL_INDEX.Purple))
		...
		for iter_7_0, iter_7_1 in ipairs(arg_7_1.target:getBuffs()) do
			if iter_7_1.fighter:getTeamType() == arg_7_0:getTeamType() and iter_7_1:Ychange() > 0 then
				if iter_7_1:getTableID() == var_0_14 then
					arg_7_4 = arg_7_4 + arg_7_4 * var_0_13
					...
					if var_0_1.ctx.battle.infoListener.buff_info then
						table.insert(var_0_1.ctx.battle.infoListener.buff_info, var_7_0)
					end

					break
				end

				arg_7_4 = arg_7_4 + arg_7_4 * var_0_12
...
function var_0_3.updateUnitDataBySpecialHero(arg_8_0, arg_8_1, arg_8_2, arg_8_3, arg_8_4, arg_8_5, arg_8_6, arg_8_7)
	local var_8_0 = var_0_7:scope(arg_8_0:getSkillByColor(var_0_2.SKILL_INDEX.Purple))

	if arg_8_0.purpleEffectCount > 0 and arg_8_1.target:getTeamType() ~= arg_8_0:getTeamType() and var_8_0 > math.abs(arg_8_0.purpleEffectX - arg_8_1.target:getX()) then
		arg_8_4 = arg_8_4 + arg_8_4 * 0.5
	end

	return var_0_3.super.updateUnitDataBySpecialHero(arg_8_0, arg_8_1, arg_8_2, arg_8_3, arg_8_4, arg_8_5, arg_8_6, arg_8_7)
end

function var_0_3.getHuJia(arg_9_0)
	local var_9_0 = math.floor(var_0_1.ctx.battle.count / var_0_19)
	local var_9_1 = 1
	...
	return arg_9_0:getAttrByType(var_0_2.AttributeType.HUJIA) * var_9_1
end

function var_0_3.getMoKang(arg_10_0)
	local var_10_0 = math.floor(var_0_1.ctx.battle.count / var_0_19)
	local var_10_1 = 1

	if var_10_0 > 0 then
		for iter_10_0 = 1, var_10_0 do
			var_10_1 = var_10_1 * 0.7
		end
	end

	return arg_10_0:getAttrByType(var_0_2.AttributeType.MOKANG) * var_10_1
end
...
function var_0_3.applyUnitBuffs(arg_11_0, arg_11_1, arg_11_2, arg_11_3, arg_11_4, arg_11_5, arg_11_6)
	...
	arg_11_0.bossDeBuffNum = arg_11_0.bossDeBuffNum + #arg_11_2

	if arg_11_0.bossDeBuffNum >= 10 then
		if var_0_2.BattleType.ReplayReport ~= var_0_1.ctx.battle.battleType then
			local var_11_0 = arg_11_0:getTargets(var_0_18)
			local var_11_1 = arg_11_0:createAttackUnits(var_11_0, var_0_18)
		...
		arg_11_0.bossDeBuffNum = 0
	end
end

function var_0_3.getZhuangtaiDIkang(arg_12_0)
	return arg_12_0:getAttrByType(var_0_2.AttributeType.ZHUANGTAI_KANGXING) / 100 + var_0_20
end
