...
local var_0_3 = var_0_0.class("Youyu", var_0_0.import("lib.fight_fish.FightFish"))
local var_0_4 = 0.2
local var_0_5 = 0.3
local var_0_6 = 3

function var_0_3.skill(arg_1_0)
	local var_1_0 = arg_1_0:newBuff(var_0_6, var_0_2.FishAttributeType.SHANBI, var_0_5, nil, arg_1_0, arg_1_0)
...
function var_0_3.addSkillMessage(arg_3_0)
	...
	local var_3_0 = arg_3_0:getRandomMessage("youyu")
