...
local var_0_3 = var_0_0.class("BossMonster", var_0_1.ctx.battle.getRequire("BaseFighter"))
...
function var_0_3.checkAwaken(arg_3_0)
	...
	local var_3_0 = var_0_8:changeDuration(arg_3_0:getModelID())
...
function var_0_3.avoidHeroMoveBehind(arg_14_0)
	return var_0_7:avoidHeroMoveBehind(arg_14_0:getTableID())
end

function var_0_3.getADJianShang(arg_15_0)
	return var_0_9 * var_0_3.super.getADJianShang(arg_15_0)
end

function var_0_3.getAPJianShang(arg_16_0)
	return var_0_9 * var_0_3.super.getAPJianShang(arg_16_0)
end
...
function var_0_3.awaken(arg_22_0)
	...
	arg_22_0.skillRoll_ = var_0_8:changeDuration(arg_22_0:getModelID())
...
function var_0_3.afterAwaken(arg_24_0)
	...
	arg_24_0.skillRoll_ = var_0_8:changeDuration(arg_24_0:getModelID())
