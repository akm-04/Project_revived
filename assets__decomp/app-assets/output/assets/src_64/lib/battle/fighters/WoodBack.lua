...
local var_0_3 = var_0_0.class("WoodBack", var_0_1.ctx.battle.requireFighter("Boss"))
...
function var_0_3.resumeIdle(arg_5_0)
	if not arg_5_0:isDeath() and arg_5_0:getFighterModel() then
		arg_5_0:getFighterModel():playAnimation_("idle03", true, nil, nil, nil)
	end
end

function var_0_3.die(arg_6_0)
	var_0_3.super.die(arg_6_0)
	arg_6_0:getFighterModel():playAnimation_("dead03", false, nil, nil, nil)
end

function var_0_3.attacked(arg_7_0)
	if arg_7_0:getFighterModel().currentAnimation_ and arg_7_0:getFighterModel().currentAnimation_ == "hurt03" then
		return
	end
	...
	arg_7_0:getFighterModel():playAnimation_("hurt03", false, nil, nil, function()
		if arg_7_0:getFighterModel().currentAnimation_ == "hurt03" then
			arg_7_0:resumeIdle()
		end
	end)
end
...
function var_0_3.updateUnitDataByTarget(arg_9_0, arg_9_1, arg_9_2, arg_9_3, arg_9_4, arg_9_5, arg_9_6, arg_9_7)
	if var_0_4:distanceType(arg_9_1.fighter:getTableID()) ~= var_0_2.DistanceType.HOUPAI then
		arg_9_2 = true
	end
