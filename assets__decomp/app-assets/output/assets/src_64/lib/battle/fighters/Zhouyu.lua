...
local var_0_3 = var_0_0.class("Zhouyu", var_0_1.ctx.battle.getRequire("BaseFighter"))
...
local var_0_12 = 0.75
local var_0_13 = 80010077
local var_0_14 = 80020077
local var_0_15 = 40011908
local var_0_16 = 10001777
...
function var_0_3.toDoPerFrames(arg_4_0)
	...
	if arg_4_0.isSkinSkillOn_ and arg_4_0.skinSkillID_ == var_0_13 and not arg_4_0.isAddSkinBuff and arg_4_0:getSkillLevelByColor(var_0_2.SKILL_INDEX.Blue) >= 1 then
...
function var_0_3.updatePurpleSkill(arg_8_0, arg_8_1)
	...
	if not arg_8_0.purpleTargetCache_[arg_8_1] or arg_8_0.purpleTargetCache_[arg_8_1] and var_0_1.ctx.battle.count - arg_8_0.purpleTargetCache_[arg_8_1] > 30 then
		...
		if arg_8_0.isSkinSkillOn_ and arg_8_0.skinSkillID_ == var_0_14 then
			local var_8_3 = var_0_14
			local var_8_4 = arg_8_0:createAttackUnits({
				arg_8_0
			}, var_8_3, arg_8_0:getSkillLevelByColor(var_0_2.SKILL_INDEX.Purple))
...
function var_0_3.beginAttack(arg_9_0)
	...
	if var_0_6:father(var_9_0.rootID_) == arg_9_0:getSkillByColor(var_0_2.SKILL_INDEX.Green) then
...
function var_0_3.createSpecialSkill(arg_11_0)
	...
	if arg_11_0.isSkinSkillOn_ and arg_11_0.skinSkillID_ == var_0_14 then
		var_11_0 = var_0_16
	end
...
function var_0_3.updateUnitDataByFighter(arg_16_0, arg_16_1, arg_16_2, arg_16_3, arg_16_4, arg_16_5, arg_16_6, arg_16_7)
	...
	if arg_16_0.isSkinSkillOn_ and arg_16_0.skinSkillID_ == var_0_14 and arg_16_4 > 0 and arg_16_1.skillID == arg_16_0:getSkillByColor(var_0_2.SKILL_INDEX.Purple) then
		arg_16_6 = arg_16_4 / 2
	end
...
function var_0_3.updateUnitDataByTarget(arg_17_0, arg_17_1, arg_17_2, arg_17_3, arg_17_4, arg_17_5, arg_17_6, arg_17_7)
	local var_17_0 = arg_17_0:getSkillLevelByColor(var_0_2.SKILL_INDEX.Blue)

	if arg_17_1.attackType == var_0_2.AttackType.AP and arg_17_4 > 0 and var_17_0 > 0 and arg_17_0:isHasBuffByID(var_0_7) and arg_17_0:isHasBuffByID(var_0_11) and var_0_2.weightedChoise({
		var_0_12,
		1 - var_0_12
	}) == 1 then
		arg_17_0.fighterModel:playFloatText({
			var_0_2.BattleFloatType.AP_IMMORTAL
		}, arg_17_0:getTeamType())

		arg_17_4 = 0
	end

	return var_0_3.super.updateUnitDataByTarget(arg_17_0, arg_17_1, arg_17_2, arg_17_3, arg_17_4, arg_17_5, arg_17_6, arg_17_7)
end
...
function var_0_3.die(arg_19_0)
	if not arg_19_0.isSkinSkillOn_ and arg_19_0:isHasBuffByID(var_0_11) then
		arg_19_0:removeBuffByID(var_0_11)
	end

	return var_0_3.super.die(arg_19_0)
end

function var_0_3.addSkinDharmBuff(arg_20_0)
	if arg_20_0.isSkinSkillOn_ and arg_20_0.skinSkillID_ == var_0_14 then
		local var_20_0 = arg_20_0:createNewBuffs({
			var_0_15
		}, arg_20_0, var_0_14)

		arg_20_0:addBuffs(var_20_0)
	end
end
