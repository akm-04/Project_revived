...
local var_0_3 = var_0_0.class("ParadiseGanfuren", var_0_1.ctx.battle.requireFighter("ElementBoss"))
...
local var_0_10 = 10000800
local var_0_11 = 10000799
local var_0_12 = 40010876
local var_0_13 = 0
local var_0_14 = 0.6
local var_0_15 = 40010868
local var_0_16 = 0.2
local var_0_17 = 0.1
local var_0_18 = 0.6
local var_0_19 = 200
local var_0_20 = 300
local var_0_21 = 500
local var_0_22 = 40010867
local var_0_23 = 10001463
...
function var_0_3.applySingleUnit(arg_5_0, arg_5_1)
	...
	if arg_5_1.skillID ~= var_0_8 and var_0_5:father(arg_5_1.skillID) == arg_5_0:getSkillByColor(var_0_2.SKILL_INDEX.Blue) and arg_5_1.target:getSummonType() == var_0_2.summonMonsterType.None and (not arg_5_0.awakenEatTargets_[arg_5_1.target] or var_0_1.ctx.battle.count - arg_5_0.awakenEatTargets_[arg_5_1.target] > var_0_20) then
		local var_5_3 = false

		if var_0_2.BattleType.ReplayReport == var_0_1.ctx.battle.battleType then
			if arg_5_0.awakeEatHpLimit[tostring(var_0_1.ctx.battle.count)] then
				var_5_3 = true
			end
		else
			var_5_3 = var_0_2.weightedChoise({
				var_0_16,
				1 - var_0_16
			}) == 1

			if var_5_3 then
				arg_5_0.records_.awake_eat_hp[tostring(var_0_1.ctx.battle.count)] = 1
			end
		end

		if var_5_3 then
			arg_5_0:useAwakeSkillToHero(arg_5_1.target)

			arg_5_0.awakenEatTargets_[arg_5_1.target] = var_0_1.ctx.battle.count
		end
	end
end
...
function var_0_3.useAwakeSkillToHero(arg_14_0, arg_14_1)
	local var_14_0 = arg_14_0:getSkillLevelByColor(var_0_2.SKILL_INDEX.Awake)
	local var_14_1 = var_0_19 * var_14_0
	local var_14_2 = var_0_21 * var_14_0
	local var_14_3 = 0
	local var_14_4 = arg_14_1:getTempHpLimit()

	if var_14_4 < var_14_1 then
		local var_14_5 = var_0_17 * arg_14_1:getHpLimit()

		if var_14_1 < var_14_4 + var_14_5 then
			var_14_3 = var_14_1 - var_14_4
			var_14_4 = var_14_1
		else
			var_14_3 = var_14_5
		...
		arg_14_1:setTempHpLimit(var_14_4)

		local var_14_6 = arg_14_0:getTempHpLimit()

		if var_14_6 > -var_14_2 then
			local var_14_7 = var_0_18 * var_14_3

			if -var_14_7 + var_14_6 < -var_14_2 then
				var_14_6 = -var_14_2
			else
				var_14_6 = var_14_6 - var_14_7
			end

			arg_14_0:setTempHpLimit(var_14_6)
		end
	end

	local var_14_8 = arg_14_1:getAP() * var_0_17

	arg_14_0.awakeEatAp_ = arg_14_0.awakeEatAp_ + var_14_8 * var_0_18
end

function var_0_3.setupReport(arg_15_0, arg_15_1)
	var_0_3.super.setupReport(arg_15_0, arg_15_1)

	arg_15_0.awakeEatHpLimit = arg_15_1.awake_eat_hp
end

function var_0_3.writeReport(arg_16_0)
	local var_16_0 = var_0_3.super.writeReport(arg_16_0)

	var_16_0.awake_eat_hp = arg_16_0.records_.awake_eat_hp

	return var_16_0
end

function var_0_3.getAP(arg_17_0)
	return var_0_3.super.getAP(arg_17_0) + arg_17_0.awakeEatAp_
end
...
function var_0_3.updateUnitDataBySpecialHero(arg_19_0, arg_19_1, arg_19_2, arg_19_3, arg_19_4, arg_19_5, arg_19_6, arg_19_7)
	local var_19_0, var_19_1, var_19_2, var_19_3, var_19_4, var_19_5 = var_0_3.super.updateUnitDataByTarget(arg_19_0, arg_19_1, arg_19_2, arg_19_3, arg_19_4, arg_19_5, arg_19_6, arg_19_7)

	if arg_19_1.target == arg_19_0 and var_19_2 > 0 then
		if var_19_2 < var_0_24 then
			var_19_2 = 0
		end

		local var_19_6 = arg_19_0:createAttackUnits({
			arg_19_0
		}, var_0_23)
	...
	return var_19_0, var_19_1, var_19_2, var_19_3, var_19_4, var_19_5
end
