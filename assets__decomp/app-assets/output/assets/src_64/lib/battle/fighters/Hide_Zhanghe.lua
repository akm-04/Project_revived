...
local var_0_3 = var_0_0.class("Zhanghe", var_0_1.ctx.battle.requireFighter("HideBoss"))
local var_0_4 = var_0_1.ctx.battle.getRequire("GetTarget")
local var_0_5 = var_0_2.tables.skill
local var_0_6 = var_0_2.tables.hero
local var_0_7 = var_0_2.tables.model
local var_0_8 = 20020029

function var_0_3.getOrbOfFrontSkill(arg_1_0)
	local var_1_0 = var_0_3.super.getOrbOfFrontSkill(arg_1_0)

	if var_1_0 == arg_1_0:getSkillByColor(var_0_2.SKILL_INDEX.Green) or var_1_0 == var_0_8 then
