...
local var_0_3 = var_0_0.class("Ganning_Awaken", var_0_1.ctx.battle.requireFighter("Hide_Ganning"))
...
function var_0_3.setSummonMonsters(arg_5_0, arg_5_1, arg_5_2, arg_5_3, arg_5_4)
	...
	if var_5_0.SummonIndex % 2 == 1 then
		var_5_6 = math.floor((var_5_0.SummonIndex + 1) / 2) * -50
	else
		var_5_6 = math.floor((var_5_0.SummonIndex + 1) / 2) * 30
	end

	var_5_0.fighterModel:pos(arg_5_4.x, arg_5_4.y + var_5_6)
	...
	local var_5_7 = var_5_0:getTeamType() == var_0_2.TeamType.A and var_0_1.ctx.battle.teamA or var_0_1.ctx.battle.teamB

	table.insert(var_5_7, var_5_0)
