...
function var_0_1.checkUpdate_(arg_17_0)
	...
	arg_17_0:checkVersion_(function(arg_18_0)
		...
		elseif var_18_7:isFileExist(xyd.versionUpdatePath .. "src_32/" .. var_0_19) then
			var_18_12 = arg_17_0:readFromFile(xyd.versionUpdatePath .. "src_32/" .. var_0_19)
		...
		local function var_18_15()
			...
			if var_18_7:isFileExist(xyd.versionUpdatePath .. "src_32/" .. var_0_19) then
				var_21_0 = arg_17_0:readFromFile(xyd.versionUpdatePath .. "src_32/" .. var_0_19)
			else
				return
			end
...
function var_0_1.alert_(arg_33_0, arg_33_1, arg_33_2, arg_33_3)
	...
	if arg_33_0.alertView_ == nil then
		...
		arg_33_0.alertYesButton_:setTitleColor({
			g = 55,
			b = 64,
			r = 44
		})
		...
		arg_33_0.alertNoButton_:setTitleColor({
			g = 55,
			b = 64,
			r = 44
		})
	...
	arg_85_0:runAction(cc.Sequence:create({
		...
		cc.CallFunc:create(function()
			if cc.Application:getInstance():getTargetPlatform() == 0 then
				...
				package.path = xyd.versionUpdatePath .. "src_32/;src_32/"
			end
