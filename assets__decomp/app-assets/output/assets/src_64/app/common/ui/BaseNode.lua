local var_0_0 = class("BaseNode", function()
...
function var_0_0.loadRes(arg_3_0, arg_3_1)
	if not arg_3_1 then
		return
	end
	...
	local var_3_0 = xyd.AssetLoader.get():loadNodeFromJson(arg_3_1)
	...
	arg_3_0:setupContentView_(var_3_0)
end
...
function var_0_0.clearRes(arg_16_0)
	arg_16_0.hasLoadRes = false

	if arg_16_0.contentView_ and not tolua.isnull(arg_16_0.contentView_) then
		arg_16_0.contentView_:removeAllChildren()

		arg_16_0.contentView_ = nil
	end
end
