local var_0_0 = class("ActivityMoonRaffleShopTable")
...
function var_0_0.ctor(arg_1_0)
	...
	import("app.common.tables.TableParser").parse("activity_square_turntable_shop.lua", function(arg_2_0)
...
function var_0_0.itemNum(arg_5_0, arg_5_1)
	return arg_5_0.itemNum_[arg_5_1] or 1
end
...
function var_0_0.times(arg_8_0, arg_8_1)
	return arg_8_0.times_[arg_8_1] or 0
end
