local var_0_0 = class("EventCentreNoticeBoardTable")
...
function var_0_0.ctor(arg_1_0)
	...
	import("app.common.tables.TableParser").parse("event_centre_notice_board.lua", function(arg_2_0)
		...
		arg_1_0.typeRequest_[var_2_0] = tonumber(arg_2_0.type_request)
		arg_1_0.functionRequestLevel_[var_2_0] = tonumber(arg_2_0.function_request_level)
		arg_1_0.taskLimit_[var_2_0] = tonumber(arg_2_0.task_limit)
		arg_1_0.goldTask_[var_2_0] = tonumber(arg_2_0.gold_task)
	end)
end
...
function var_0_0.time(arg_8_0, arg_8_1)
	return arg_8_0.time_[arg_8_1] or ""
end

function var_0_0.typeRequest(arg_9_0, arg_9_1)
	return arg_9_0.typeRequest_[arg_9_1] or ""
end

function var_0_0.functionRequestLevel(arg_10_0, arg_10_1)
	return arg_10_0.functionRequestLevel_[arg_10_1] or ""
end

function var_0_0.attribute(arg_11_0, arg_11_1)
	return arg_11_0.attribute_[arg_11_1] or ""
end

function var_0_0.taskLimit(arg_12_0, arg_12_1)
	return arg_12_0.taskLimit_[arg_12_1] or ""
end

function var_0_0.goldTask(arg_13_0, arg_13_1)
	return arg_13_0.goldTask_[arg_13_1] or ""
end
