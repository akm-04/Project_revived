local var_0_0 = class("PetExpTable")

function var_0_0.ctor(arg_1_0)
	arg_1_0.exps_ = {}
	arg_1_0.totalExps_ = {}

	import("app.common.tables.TableParser").parse("pet_exp.lua", function(arg_2_0)
...
function var_0_0.exp(arg_3_0, arg_3_1)
	return arg_3_0.exps_[arg_3_1] or 0
end
