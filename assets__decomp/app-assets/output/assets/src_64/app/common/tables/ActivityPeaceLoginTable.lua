local var_0_0 = class("ActivityPeaceLoginTable")

function var_0_0.ctor(arg_1_0)
	arg_1_0.name_ = {}
	arg_1_0.gift_ = {}

	import("app.common.tables.TableParser").parse("activity_peacelogin.lua", function(arg_2_0)
...
function var_0_0.getGifts(arg_5_0)
