local var_0_0 = class("RagnarokGachaShopDetailWindow", import("app.common.ui.BaseWindow"))
...
local var_0_5 = xyd.tables.misc:getValue("activity_ragnarok_shop_item2")
...
function var_0_0.layout(arg_4_0)
	...
	xyd.nodeEventSample(arg_4_0:nodeByName("btn_buy"), nil, function()
		...
		arg_4_0.ragnarok:getGachaShopReward(var_14_2, function(arg_15_0, arg_15_1)
