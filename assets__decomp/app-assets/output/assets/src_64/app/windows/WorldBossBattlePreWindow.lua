local var_0_0 = class("WorldBossBattlePreWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0.boss_id = arg_1_0.WorldBoss.boss_id
end
...
function var_0_0.layout(arg_3_0)
	...
	if arg_3_0.WorldBoss.can_sweep == 0 then
		arg_3_0:nodeByName("sweep_word"):setVisible(false)
		arg_3_0:nodeByName("sweep_btn"):setVisible(false)
	else
	...
	if arg_3_0.WorldBoss.total_rank == nil or arg_3_0.WorldBoss.total_rank == 0 then
		arg_3_0:nodeByName("bottom_container"):setVisible(false)
	...
	arg_3_0:setRank(arg_3_0.WorldBoss.total_rank)

	local var_3_0 = string.formatnumberthousands(arg_3_0.WorldBoss.total_damage)

	arg_3_0:nodeByName("damage_num_text"):setString(var_3_0)
	arg_3_0:nodeByName("reward_1_num_text"):setString(xyd.tables.worldBossReward:getMana(arg_3_0.WorldBoss.total_rank))
	arg_3_0:nodeByName("reward_2_num_text"):setString(xyd.tables.worldBossReward:getDiamond(arg_3_0.WorldBoss.total_rank))
	arg_3_0:rewardFormat(arg_3_0:nodeByName("reward_icons_container"), xyd.tables.worldBoss.stone[arg_3_0.boss_id], xyd.tables.worldBossReward:getStone(arg_3_0.WorldBoss.total_rank))
end
...
function var_0_0.init(arg_4_0)
	...
	arg_4_0:layout()
	arg_4_0.hero:populateWithTableID(tonumber(arg_4_0.WorldBoss.monster_id))
	...
	local var_4_0 = {
		xyd.tables.worldBoss.skill1[arg_4_0.boss_id],
		xyd.tables.worldBoss.skill2[arg_4_0.boss_id],
		xyd.tables.worldBoss.skill3[arg_4_0.boss_id],
		xyd.tables.worldBoss.skill4[arg_4_0.boss_id]
	}

	arg_4_0:setSkillContainer(var_4_0)
	arg_4_0:setRank(arg_4_0.WorldBoss.total_rank)
	arg_4_0:nodeByName("des_text"):setString(xyd.tables.worldBoss.campaign_des[arg_4_0.boss_id])
	arg_4_0:nodeByName("title_text"):setString(xyd.tables.worldBoss.campaign_name[arg_4_0.boss_id])
	arg_4_0:nodeByName("title_text"):enableOutline(cc.c4b(35, 100, 180, 255), 1)
	...
	arg_4_0:nodeByName("des_words"):setString(string.format(var_0_2:translation("WORLD_BOSS_KEEP_RANK"), xyd.tables.worldBoss.name[arg_4_0.boss_id]))
end
...
function var_0_0.rewardFormat(arg_9_0, arg_9_1, arg_9_2, arg_9_3)
	local var_9_0 = arg_9_1:getContentSize().height
	local var_9_1 = var_9_0 / 4
	local var_9_2 = {
		arg_9_2
	}
	...
	for iter_9_0 = 1, #var_9_2 do
		if var_9_3[iter_9_0] > 0 then
			...
			if xyd.tables.item:type(var_9_2[iter_9_0]) == -1 then
				...
				xyd.setItemBorder(var_9_5, var_9_2[iter_9_0], false, false, 1)
				arg_9_0:nodeByName("reward_3_num_text"):setString(var_9_3[iter_9_0])
			end
			...
			var_9_6.hasNum = arg_9_0.player:getBackpack():getItemNumByID(var_9_2[iter_9_0])
			var_9_6.name = xyd.tables.item:name(var_9_2[iter_9_0])

			arg_9_0:addTips(var_9_5, var_9_6)
		else
			arg_9_0:nodeByName("reward_3_num_text"):setVisible(false)
		end
	end
...
function var_0_0.updateHeroModel(arg_10_0, arg_10_1)
	local var_10_0 = arg_10_1:getHeroModel()

	var_10_0:setTouchSwallowEnabled(false)

	local var_10_1 = arg_10_0:nodeByName("pic_container"):getContentSize().width / 2

	var_10_0:setPosition(cc.p(var_10_1, 0))
	arg_10_0:nodeByName("pic_container"):removeAllChildren()
	var_10_0:addTo(arg_10_0:nodeByName("pic_container"))
end
...
function var_0_0.didOpen(arg_11_0, arg_11_1)
	...
	arg_11_0:nodeByName("sweep_btn"):addTouchEventListener(function(arg_13_0, arg_13_1)
		if arg_13_1 == ccui.TouchEventType.ended then
			xyd.playButtonSound()

			if not arg_11_0:dealWrongTimeChallenge() then
				return
			end

			if arg_11_0.WorldBoss.challenge_times <= 0 then
				...
				xyd.CommonAlertWindow.open(xyd.CommonAlertType.TWO_BTN, var_0_2:translation("WORLD_BOSS_SWEEP"), function()
					arg_11_0.WorldBoss:doSweep({
						campaign_id = arg_11_0.WorldBoss.boss_id
					}, function(arg_15_0, arg_15_1)
						if arg_15_0 == xyd.error.OK then
							arg_11_0.WorldBoss:loadWorldBoss(function(arg_16_0, arg_16_1)
								if arg_16_0 == xyd.error.OK then
									arg_11_0:layout()
									xyd.WindowManager.get():openWindow("world_boss_sweep")

									local var_16_0 = xyd.WindowManager.get():getWindow("world_boss")

									if var_16_0 then
										var_16_0:updateSence()
									end
								end
							end, true)
						end
	...
	arg_11_0:nodeByName("play_btn"):addTouchEventListener(function(arg_17_0, arg_17_1)
		if arg_17_1 == ccui.TouchEventType.ended then
			...
			arg_11_0.guild = xyd.ModelManager.get():loadModel(xyd.ModelType.SELF_GUILD)
			...
			if arg_11_0.WorldBoss.challenge_times <= 0 then
				...
				local var_17_0 = {
					campaign_type = xyd.CampaignType.ELEMENT
				}

				arg_11_0.guild:loadAllTeamHeros(var_17_0, function(arg_18_0)
					...
					if arg_18_0 == xyd.error.OK then
						...
						for iter_18_0, iter_18_1 in ipairs(arg_11_0.guild:getAllTeamHeros()) do
					...
					for iter_18_2, iter_18_3 in pairs(arg_11_0.player.heros_) do
					...
					local var_18_5 = {
						type = xyd.SelectTeamType.WORLD_BOSS,
						isMercenary = var_18_0,
						allTeamHeros = var_18_1,
						campaignID = arg_11_0.boss_id,
						campaignType = xyd.CampaignType.ELEMENT,
					...
					if var_18_2 == false and var_18_3 == false then
						xyd.WindowManager.get():openWindow("toast", {
							message = var_0_2:translation("WORLD_BOSS_HAS_NO_HERO")
						})
					else
						xyd.WindowManager.get():openWindow(xyd.WindowName.SelectTeamWnd, var_18_5)
					end
				end)
			end
		end
...
function var_0_0.dealWrongTimeChallenge(arg_19_0)
	local var_19_0 = arg_19_0:checkTimeCanDo()

	if var_19_0 == true then
		return true
	elseif var_19_0 == false then
		local var_19_1 = var_0_2:translation("WORLD_BOSS_OPEN_TIP")
...
function var_0_0.checkTimeCanDo(arg_20_0)
