local var_0_0 = class("ChristmasRuleWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.layout(arg_4_0)
	...
	local var_4_1 = arg_4_0:createRuleLabel(var_0_2:translation("CHRISTMAS_RULE_TEXT1"), cc.c3b(247, 217, 54))

	var_4_0(var_4_1, 70)

	arg_4_0.height_table = {}

	local var_4_2 = arg_4_0:createRuleLabel(var_0_2:translation("CHRISTMAS_RULE_TEXT2"), cc.c3b(255, 255, 255))

	var_4_0(var_4_2, 49)

	arg_4_0.height_table = {}

	local var_4_3 = arg_4_0:createRuleLabel(var_0_2:translation("CHRISTMAS_RULE_TEXT3"), cc.c3b(247, 217, 54))

	var_4_0(var_4_3, 70)

	arg_4_0.height_table = {}

	local var_4_4 = arg_4_0:createRuleLabel(var_0_2:translation("CHRISTMAS_RULE_TEXT4"), cc.c3b(255, 255, 255))
