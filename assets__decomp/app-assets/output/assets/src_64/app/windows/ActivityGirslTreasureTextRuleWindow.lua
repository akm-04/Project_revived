local var_0_0 = class("ActivityGirslTreasureTextRuleWindow", import("app.common.ui.BaseWindow"))
...
local var_0_5 = 4
local var_0_6 = 5
local var_0_7 = xyd.tables.activityGirlsTreasure
local var_0_8 = xyd.tables.dropbox
local var_0_9 = {
	NORMAL = 2,
	SX = 1
}
...
function var_0_0.initRule(arg_7_0)
	...
	for iter_7_0 = 1, #var_7_0 do
		...
		if iter_7_0 == var_0_5 or iter_7_0 == var_0_6 then
			local var_7_4 = arg_7_0:calculateRate(iter_7_0)

			var_7_0[iter_7_0] = string.format(var_7_0[iter_7_0], var_7_4)
		end
		...
		var_7_3:setContentSize(708, var_7_7)
		var_7_3:addTo(var_7_1)
		var_7_1:setContentSize(708, var_7_7 + 20)
		var_7_2:addContent(var_7_1)
		var_7_2:setItemSize(708, var_7_7 + 20)
...
function var_0_0.updateRewardItem(arg_10_0)
	...
	for iter_10_0 = 1, var_10_3 do
		...
		var_10_5:setContentSize(714, 80)

		local var_10_6 = 0
		local var_10_7 = arg_10_0.awardTable:range(iter_10_0)
		local var_10_8 = {
			size = 24,
		...
		if var_10_7[1] == var_10_7[2] then
			local var_10_10 = string.format(var_0_1:translation("ARENA_RULE_ITEM_TITLE_1"), var_10_7[1])

			var_10_9:setString(var_10_10)
		else
			local var_10_11 = string.format(var_0_1:translation("ARENA_RULE_ITEM_TITLE_2"), var_10_7[1], var_10_7[2])

			var_10_9:setString(var_10_11)
		end

		var_10_9:addTo(var_10_5)
		var_10_9:setAnchorPoint(cc.p(0, 0.5))
		var_10_9:setPosition(var_10_6, 40)

		local var_10_12 = var_10_6 + 200
		local var_10_13 = "images/icon/eco/icon_crystal.png"
		local var_10_14 = xyd.AssetLoader.get():loadSprite(var_10_13)

		var_10_14:setScale(0.8)
		var_10_14:addTo(var_10_5)
		var_10_14:setAnchorPoint(cc.p(0.5, 0.5))
		var_10_14:setPosition(var_10_12, 40)

		local var_10_15 = arg_10_0.awardTable:diamond(iter_10_0)
		...
		if var_10_15 >= 0 then
			...
			local var_10_17 = xyd.AssetLoader.get():loadLabel(var_10_16)

			var_10_17:setString("x" .. var_10_15)
			var_10_17:addTo(var_10_5)
			var_10_17:setAnchorPoint(cc.p(0, 0.5))
			var_10_17:setPosition(var_10_12 + 20, 40)
		end

		local var_10_18 = var_10_12 + 100 + 50
		local var_10_19 = arg_10_0.awardTable:item(iter_10_0)
		local var_10_20 = arg_10_0.awardTable:itemNum(iter_10_0)

		for iter_10_1 = 1, #var_10_19 do
			local var_10_21 = display.newNode()

			var_10_21:setContentSize(60, 60)
			xyd.setItemAndAddTips(var_10_21, var_10_19[iter_10_1])
			var_10_21:addTo(var_10_5)
			var_10_21:setAnchorPoint(cc.p(0.5, 0.5))
			var_10_21:setPosition(var_10_18 + (iter_10_1 - 1) * 130, 40)

			local var_10_22 = {
				size = 24,
				color = cc.c3b(54, 52, 55)
			}
			local var_10_23 = xyd.AssetLoader.get():loadLabel(var_10_22)

			var_10_23:setString("x" .. var_10_20[iter_10_1])
			var_10_23:addTo(var_10_5)
			var_10_23:setAnchorPoint(cc.p(0, 0.5))
			var_10_23:setPosition(var_10_18 + 40 + (iter_10_1 - 1) * 130, 40)
		end

		var_10_4:addContent(var_10_5)
		var_10_4:setItemSize(714, 80)
		arg_10_0.list:addItem(var_10_4)
	end
end

function var_0_0.calculateRate(arg_11_0, arg_11_1)
	local var_11_0 = 0
	local var_11_1 = 0
	local var_11_2
	local var_11_3
	...
	if arg_11_1 == var_0_5 then
		local var_11_5 = var_0_7:dropboxID(var_0_9.SX)
		local var_11_6 = var_0_8:itemIDs(var_11_5)

		for iter_11_0 = 1, #var_11_6 do
			var_11_0 = var_11_0 + 1

			if not arg_11_0.selfPlayer:getHeroIgnoreAwaken(var_11_6[iter_11_0]) then
				var_11_1 = var_11_1 + 1
			end
		end
	else
		local var_11_7 = var_0_7:dropboxID(var_0_9.NORMAL)
		local var_11_8 = var_0_8:itemIDs(var_11_7)

		for iter_11_1 = 1, #var_11_8 do
			var_11_0 = var_11_0 + 1

			if not arg_11_0.selfPlayer:getHeroIgnoreAwaken(var_11_8[iter_11_1]) then
				var_11_1 = var_11_1 + 1
			end
		end
	end
	...
	if var_11_1 > 0 then
		var_11_4 = math.floor((var_11_1 + var_11_0) / (var_11_0 * 2) * 100)
	else
		var_11_4 = 0
	end

	return tostring(var_11_4)
end
