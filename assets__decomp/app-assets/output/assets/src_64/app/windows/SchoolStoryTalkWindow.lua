SchoolStoryTalkWindow = class("SchoolStoryTalkWindow", import("app.common.ui.BaseWindow"))
...
function SchoolStoryTalkWindow.ctor(arg_1_0, arg_1_1, arg_1_2)
	SchoolStoryTalkWindow.super.ctor(arg_1_0, arg_1_1, arg_1_2)

	arg_1_0.isOccultStory = arg_1_2.is_occult_story
	arg_1_0.tableName = arg_1_2.table_name
	arg_1_0.talkId = arg_1_2.talk_id
end

function SchoolStoryTalkWindow.playFadeIn(arg_2_0)
...
function SchoolStoryTalkWindow.playFadeOut(arg_3_0)
...
function SchoolStoryTalkWindow.checkFileExist(arg_5_0)
	return true
end

function SchoolStoryTalkWindow.willOpen(arg_6_0, arg_6_1)
	SchoolStoryTalkWindow.super.willOpen(arg_6_0, arg_6_1)
	...
	if not arg_6_0.isOccultStory and arg_6_0:checkFileExist() then
		arg_6_0.talkTable_ = import("app.common.tables.SchoolStoryTalkTable").new(arg_6_0.talkId)
		arg_6_0.talkIdlist = arg_6_0.talkTable_:ids()
		arg_6_0.playingIndex_ = 0
	elseif arg_6_0.isOccultStory then
		arg_6_0.talkTable_ = import("app.common.tables.CreatsStoryTable").new(arg_6_0.tableName)
		arg_6_0.talkIdlist = arg_6_0.talkTable_:ids()
		arg_6_0.playingIndex_ = 0

		arg_6_0:nodeByName("bg"):setVisible(false)
...
function SchoolStoryTalkWindow.didOpen(arg_7_0, arg_7_1)
	SchoolStoryTalkWindow.super.didOpen(arg_7_0, arg_7_1)
...
function SchoolStoryTalkWindow.didClose(arg_8_0, arg_8_1)
	SchoolStoryTalkWindow.super.didClose(arg_8_0, arg_8_1)
...
function SchoolStoryTalkWindow.playCloseWindow(arg_9_0)
...
function SchoolStoryTalkWindow.layout(arg_10_0)
...
function SchoolStoryTalkWindow.speak(arg_13_0, arg_13_1, arg_13_2, arg_13_3)
...
function SchoolStoryTalkWindow.nextPlay(arg_15_0)
...
function SchoolStoryTalkWindow.update(arg_16_0)
	local var_16_0 = arg_16_0.talkIdlist[arg_16_0.playingIndex_]

	if arg_16_0.talkTable_:bg(var_16_0) == 1 then
		if not arg_16_0.coverBg then
			arg_16_0.coverBg = cc.LayerColor:create(cc.c4b(0, 0, 0, 255))

			arg_16_0.coverBg:addTo(arg_16_0:nodeByName("bg"))
		else
			arg_16_0.coverBg:setVisible(true)
		end
	elseif arg_16_0.coverBg then
		arg_16_0.coverBg:setVisible(false)
	end
...
function SchoolStoryTalkWindow.onEffectEnded(arg_18_0)
...
function SchoolStoryTalkWindow.playSpeak(arg_19_0, arg_19_1)
...
function SchoolStoryTalkWindow.updateTalkBox(arg_20_0, arg_20_1)
...
function SchoolStoryTalkWindow.getName(arg_21_0, arg_21_1)
...
function SchoolStoryTalkWindow.getPlayerName(arg_22_0)
...
function SchoolStoryTalkWindow.updateCardContainer(arg_23_0, arg_23_1)
	...
	local var_23_0 = arg_23_0.talkTable_:leftImg(arg_23_1)

	if var_23_0 ~= arg_23_0.talkTable_:leftImg(arg_23_1 - 1) or arg_23_0.talkTable_:position(arg_23_1) ~= arg_23_0.talkTable_:position(arg_23_1 - 1) then
	...
	local var_23_2 = arg_23_0.talkTable_:rightImg(arg_23_1)

	if var_23_2 ~= arg_23_0.talkTable_:rightImg(arg_23_1 - 1) or arg_23_0.talkTable_:position(arg_23_1) ~= arg_23_0.talkTable_:position(arg_23_1 - 1) then
...
function SchoolStoryTalkWindow.gray(arg_24_0, arg_24_1)
	local var_24_0 = cc.TintTo:create(0, 70, 70, 70)

	arg_24_1:runActionOnce(var_24_0)
end

return SchoolStoryTalkWindow
