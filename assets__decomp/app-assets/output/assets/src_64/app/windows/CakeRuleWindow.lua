local var_0_0 = class("CakeRuleWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.layout(arg_4_0)
	arg_4_0:nodeByName("title"):setString(var_0_1:translation("ANNIVERSARY_CAKE_RULE_TITLE"))
...
function var_0_0.createRuleLabel(arg_6_0)
	local var_6_0 = var_0_1:translation("ANNIVERSARY_CAKE_RULE_TEXT")
