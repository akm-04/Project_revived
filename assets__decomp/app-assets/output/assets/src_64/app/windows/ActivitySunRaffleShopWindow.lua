local var_0_0 = class("ActivitySunRaffleShopWindow", import("app.common.ui.BaseWindow"))
local var_0_1 = require("framework.scheduler")
local var_0_2 = xyd.tables.translation
local var_0_3 = xyd.tables.activitySunRaffleShop
local var_0_4 = 2
...
function var_0_0.willOpen(arg_2_0, arg_2_1)
	arg_2_0:nodeByName("txt_title"):setString(var_0_2:translation("ACTIVITY_1100_TEXT6"))
	arg_2_0:nodeByName("txt_has"):setString(var_0_2:translation("ACTIVITY_1100_TEXT7"))
	arg_2_0:initData()
...
function var_0_0.initItemCell(arg_9_0, arg_9_1, arg_9_2)
	for iter_9_0 = 1, var_0_4 do
		...
		local var_9_1 = xyd.AssetLoader.get():loadNodeFromJson("windows/activities/1100/new_shop/sun_item.csb")
...
function var_0_0.judge_open(arg_13_0)
	local var_13_0 = xyd.ServerTime.get():getServerTime()

	if var_13_0 >= arg_13_0.activity.start_time and var_13_0 < arg_13_0.activity.end_time then
		return true
	end

	local var_13_1 = var_13_0 >= arg_13_0.activity.end_time and "ACTIVITY_FINISHED" or var_0_2:translation("ACTIVITY_NO_OPEN")

	xyd.WindowManager.get():openWindow("toast", {
		message = var_0_2:translation(var_13_1)
	})
end
...
function var_0_0.getStr(arg_15_0)
	local var_15_0 = #var_0_3.times_
	local var_15_1 = ""
	...
	for iter_15_0 = 1, var_15_0 do
		...
		var_15_1 = var_15_1 .. (arg_15_0.buyTimes[iter_15_0] or 0)
	end
