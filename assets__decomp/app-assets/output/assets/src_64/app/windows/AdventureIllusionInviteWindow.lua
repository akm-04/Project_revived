local var_0_0 = class("AdventureIllusionInviteWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.initFriends(arg_4_0)
	...
	local var_4_1 = {}
	local var_4_2 = arg_4_0.adventureEvent:getIllusionRoomLev()
	local var_4_3 = 65
	local var_4_4 = xyd.tables.misc.paradiseTeamLimit
	local var_4_5 = math.max(var_4_3, var_4_2 - var_4_4)
	local var_4_6 = var_4_2 + var_4_4

	for iter_4_0 = 1, #var_4_0 do
		if var_4_5 <= var_4_0[iter_4_0].lev and var_4_6 >= var_4_0[iter_4_0].lev then
	...
	arg_6_0:nodeByName("btn_region"):addTouchEventListener(function(arg_7_0, arg_7_1)
		if arg_7_1 == ccui.TouchEventType.ended then
			...
			if arg_6_0.messageManager.chatLimit[5] and arg_6_0.messageManager.chatLimit[5] > 0 then
				...
				local var_7_0 = arg_6_0.adventureEvent:getPlayerInfoByID(arg_6_0.selfPlayer.playerID)
				local var_7_1 = {
					room_id = arg_6_0.adventureEvent.teamInfo.room_id,
					type = xyd.ChatTextType.ADVENTURE_ILLUSION,
					boss_name = xyd.tables.illusionCampaign:name(xyd.tables.misc.adventureIllusionBoss),
	...
	arg_6_0:nodeByName("btn_guild"):addTouchEventListener(function(arg_8_0, arg_8_1)
		if arg_8_1 == ccui.TouchEventType.ended then
			...
			if arg_6_0.messageManager:hasLeague() == true then
				local var_8_0 = arg_6_0.adventureEvent:getPlayerInfoByID(arg_6_0.selfPlayer.playerID)
				local var_8_1 = {
					room_id = arg_6_0.adventureEvent.teamInfo.room_id,
					type = xyd.ChatTextType.ADVENTURE_ILLUSION,
					boss_name = xyd.tables.illusionCampaign:name(xyd.tables.misc.adventureIllusionBoss),
...
function var_0_0.initInviteItem(arg_11_0, arg_11_1, arg_11_2)
		...
		if arg_12_1 == ccui.TouchEventType.ended then
			...
			arg_11_0.adventureEvent:inviteFriend(var_12_0, function(arg_13_0, arg_13_1)
				if arg_13_0 == xyd.error.OK then
					arg_11_0.adventureEvent:addInvitedList(var_11_0.player_id)
	...
	if arg_11_0.adventureEvent:checkIsInvited(var_11_0.player_id) then
		var_11_2:getChildByName("img_already_invite"):setVisible(true)
