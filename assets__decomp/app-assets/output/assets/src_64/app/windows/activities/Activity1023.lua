...
function var_0_0.layout(arg_3_0)
	...
	for iter_3_0, iter_3_1 in ipairs(var_3_4) do
		local var_3_5 = xyd.AssetLoader.get():loadSprite("windows/activities/1023/star.png")

		var_3_5:setPosition(10, var_3_2 - 9.5)
...
function var_0_0.createAwardList(arg_4_0, arg_4_1)
	...
	for iter_4_0 = 1, var_4_2 do
		...
		local var_4_6 = xyd.AssetLoader.get():loadNodeFromJson("windows/activities/1023/item.csb")
...
function var_0_0.rewardItemLayout(arg_6_0, arg_6_1, arg_6_2, arg_6_3, arg_6_4)
	local var_6_0 = xyd.tables.activityConsume:name(arg_6_4)
	...
	if xyd.tables.activityConsume:consume(arg_6_4) > arg_6_1.details.consume_count then
	...
	arg_6_0:rewardFormat(var_6_2, xyd.tables.activityConsume:gift(arg_6_4), arg_6_0.activity, 15)
