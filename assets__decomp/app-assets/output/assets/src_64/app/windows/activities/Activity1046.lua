...
local var_0_2 = xyd.tables.activitySakuraSell
...
function var_0_0.sakuraSellLayout(arg_3_0, arg_3_1, arg_3_2, arg_3_3)
	...
	local function var_3_1(arg_5_0, arg_5_1, arg_5_2, arg_5_3)
		local var_5_0 = xyd.tables.activitySakuraSell:buyCount(arg_5_1)
	...
	local function var_3_2(arg_6_0, arg_6_1)
		...
		local var_6_2 = xyd.tables.activitySakuraSell:icon(arg_6_1)
		local var_6_3 = xyd.SpriteLoader.new(var_6_2, nil, nil, xyd.DefaultImageType.ITEM_ICON, arg_6_0:getChildByName("reward"))
		...
		local var_6_11 = arg_6_0:getChildByName("bg_discount"):getChildByName("txt")
		local var_6_12 = (10 - var_0_2:discount(arg_6_1)) * 10

		var_6_11:setString(tostring(var_6_12) .. "% off")
	end

	arg_3_0.playerVipLev = arg_3_0.player.vip
	arg_3_0.giftCounts = xyd.tables.activitySakuraSell:allcount()
	...
	arg_3_3:getChildByName("bg_desc"):getChildByName("txt"):setString(var_0_1:translation("SAKURASELLRULES"))

	local var_3_4 = cc.ui.UIListView.new({
		viewRect = cc.rect(0, 0, 667, 390),
		padding_ = {
			top = 0,
			bottom = 0,
			left = 0,
	...
	for iter_3_1 = 1, #arg_3_0.giftCounts do
		local var_3_5 = xyd.AssetLoader.get():loadNodeFromJson("windows/activities/1046/sakura_sell_item.csb")
		local var_3_6 = var_3_5:getChildByName("container")

		table.insert(arg_3_0.btn, var_3_6:getChildByName("btn"))
		table.insert(arg_3_0.giftContainer, var_3_6)
		var_3_6:getChildByName("btn"):getChildByName("txt"):setString(var_0_1:translation("ACTIVITY_COMMON_TEXT6"))

		if arg_3_1.is_open == 0 then
			var_3_6:getChildByName("btn"):setBright(false)
			var_3_6:getChildByName("btn"):setTouchEnabled(false)
			var_3_2(var_3_6, iter_3_1)
			var_3_1(var_3_6, iter_3_1, arg_3_1)

			local var_3_7 = display.newNode()
			local var_3_8 = var_3_6:getWidth()
			local var_3_9 = var_3_6:getHeight()

			var_3_7:setContentSize(var_3_8, var_3_9)
			var_3_5:addTo(var_3_7)
			var_3_7:setAnchorPoint(cc.p(0, 0))

			local var_3_10 = var_3_4:newItem()

			var_3_10:addContent(var_3_7)
			var_3_10:setItemSize(var_3_8, var_3_9)
			var_3_4:addItem(var_3_10)
			var_3_4:reload()
		else
			var_3_6:getChildByName("btn"):setBright(true)
			var_3_6:getChildByName("btn"):setTouchEnabled(true)

			local var_3_11 = xyd.tables.activitySakuraSell:buyCount(iter_3_1)

			if var_3_11 > arg_3_0.countBuyTimes[iter_3_1] or var_3_11 == -1 then
				var_3_2(var_3_6, iter_3_1)
				var_3_1(var_3_6, iter_3_1, arg_3_1)

				local var_3_12 = display.newNode()
				local var_3_13 = var_3_6:getWidth()
				local var_3_14 = var_3_6:getHeight()

				var_3_12:setContentSize(var_3_13, var_3_14)
				var_3_5:addTo(var_3_12)
				var_3_12:setAnchorPoint(cc.p(0, 0))

				local var_3_15 = var_3_4:newItem()

				var_3_15:addContent(var_3_12)
				var_3_15:setItemSize(var_3_13, var_3_14)
				var_3_4:addItem(var_3_15)
				var_3_4:reload()
			else
				table.insert(arg_3_0.hasBoughtIndex, iter_3_1)
				table.insert(arg_3_0.hasBought, var_3_6)
			end
		end
	end
	...
	local function var_3_16()
		for iter_7_0 = 1, #arg_3_0.hasBought do
			local var_7_0 = xyd.AssetLoader.get():loadNodeFromJson("windows/activities/1046/sakura_sell_item.csb")
	...
	for iter_8_0 = 1, #arg_8_0.giftCounts do
		arg_8_0.btn[iter_8_0]:addTouchEventListener(function(arg_9_0, arg_9_1)
			...
			if arg_9_1 == ccui.TouchEventType.ended and arg_8_0.scrollViewMoved2_ ~= true then
				...
				local var_9_0 = xyd.tables.activitySakuraSell:vip(iter_8_0)
				...
				elseif arg_8_0.player.crystal < xyd.tables.activitySakuraSell:discount_price(iter_8_0) then
					...
					arg_8_0.activitiesModel:getActivityReward(arg_8_1.table_id, iter_8_0, function(arg_11_0, arg_11_1)
						if arg_11_0 == xyd.error.OK then
							...
							if xyd.tables.activitySakuraSell:buyCount(iter_8_0) ~= -1 then
								...
								if arg_8_0.countBuyTimes[iter_8_0] >= xyd.tables.activitySakuraSell:buyCount(iter_8_0) then
