...
function var_0_0.layout(arg_3_0, arg_3_1, arg_3_2)
	local var_3_0 = xyd.AssetLoader.get():loadNodeFromJson("windows/activities/1047/normal_activity.csb")

	var_3_0:addTo(arg_3_0.parent)
	var_3_0:getChildByName("bg_desc"):getChildByName("txt"):setString(xyd.tables.activities:desc(arg_3_1.table_id))

	local var_3_1 = var_3_0:getChildByName("time")
	local var_3_2 = arg_3_0.activity.start_time
	local var_3_3 = arg_3_0.activity.end_time
	local var_3_4 = string.format(var_0_1:translation("ACTIVITY_TIME_SPAN"), os.date("%Y", var_3_2), os.date("%m", var_3_2), os.date("%d", var_3_2), os.date("%H", var_3_2), os.date("%M", var_3_2), os.date("%Y", var_3_3), os.date("%m", var_3_3), os.date("%d", var_3_3), os.date("%H", var_3_3), os.date("%M", var_3_3))

	if arg_3_0.activity.days == -1 then
		var_3_1:setString(var_0_1:translation("FOREVER"))
	else
		var_3_1:setString(var_3_4)
	end

	var_3_0:getChildByName("charge_txt"):setString(var_0_1:translation("ACTIVITY_TOTAL_RECHARGE"))
	var_3_0:getChildByName("charge"):setString(arg_3_0.activity.details.charge_count)

	local var_3_5 = cc.ui.UIListView.new({
		viewRect = cc.rect(1, 1, 667, 362),
		padding_ = {
			top = 0,
			bottom = 0,
			left = 0,
	...
	var_3_5:addTo(var_3_0:getChildByName("container"):getChildByName("list"))
	var_3_5:onScroll(handler(arg_3_0, arg_3_0.scrollListener))
	...
	arg_3_0:addActivityAwardList(var_3_6)
end
...
function var_0_0.createAwardList(arg_4_0, arg_4_1)
	...
	for iter_4_0 = 1, var_4_2 do
		if arg_4_0:checkInitItem(iter_4_0, arg_4_1) then
			...
			local var_4_6 = xyd.AssetLoader.get():loadNodeFromJson("windows/activities/1047/award_item.csb")
			...
			var_4_6:setPosition(0, 4)
			var_4_6:setTouchSwallowEnabled(false)
			var_4_5:setContentSize(667, 170)
			var_4_4:addContent(var_4_5)
			var_4_4:setItemSize(667, 170)
...
function var_0_0.rewardItemLayout(arg_6_0, arg_6_1, arg_6_2, arg_6_3, arg_6_4)
	local var_6_0 = xyd.tables.activitySakuraCharge:name(arg_6_4)
	...
	local var_6_3 = xyd.luaStringSplit(arg_6_1.details.is_awards, "|")

	if xyd.tables.activitySakuraCharge:recharge(arg_6_4) > arg_6_1.details.charge_count then
		var_6_1:setTouchEnabled(false)
		var_6_1:setBright(false)
	elseif var_6_3[arg_6_4] == "1" then
		var_6_1:setVisible(false)
		arg_6_2:getChildByName("already_get"):setVisible(true)
	end

	arg_6_0:rewardFormat(arg_6_2:getChildByName("award_container"), xyd.tables.activitySakuraCharge:gift(arg_6_4))
