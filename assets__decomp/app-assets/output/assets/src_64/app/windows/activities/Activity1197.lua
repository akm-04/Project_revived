...
local var_0_3 = xyd.tables.activityGirlTraining2
local var_0_4 = {
	PERSONAL = 1,
	SERVER = 2
}
...
local var_0_6 = 1000
local var_0_7 = 5
local var_0_8 = tonumber(xyd.tables.misc:getValue("activity_girl_training2_partner"))
...
function var_0_0.layout(arg_3_0)
	...
	if arg_3_0.selfPlayer:getHeroByTableID(var_0_8) or arg_3_0.selfPlayer:getHeroByTableID(xyd.tables.hero:afterAwaken(var_0_8)) then
	...
	local var_3_0 = xyd.tables.hero:modelID(var_0_8)
...
function var_0_0.updateRedMark(arg_6_0)
	...
	for iter_6_0, iter_6_1 in ipairs(arg_6_0.details.base_info.is_awards) do
		if arg_6_0.details.base_info.is_awards[iter_6_0] == 0 and arg_6_0.details.mission_list[iter_6_0].is_complete == 1 and var_0_3:type(iter_6_0) == var_0_4.PERSONAL and (arg_6_0.selfPlayer:getHeroByTableID(var_0_8) or arg_6_0.selfPlayer:getHeroByTableID(xyd.tables.hero:afterAwaken(var_0_8))) then
			arg_6_0.container:getChildByName("btn_personal"):getChildByName("red_mark"):setVisible(true)
		end

		if arg_6_0.details.base_info.is_awards[iter_6_0] == 0 and arg_6_0.details.mission_list[iter_6_0].is_complete == 1 and var_0_3:type(iter_6_0) == var_0_4.SERVER and (arg_6_0.selfPlayer:getHeroByTableID(var_0_8) or arg_6_0.selfPlayer:getHeroByTableID(xyd.tables.hero:afterAwaken(var_0_8))) then
...
function var_0_0.initCell(arg_9_0, arg_9_1, arg_9_2)
	...
	local var_9_4 = xyd.AssetLoader.get():loadNodeFromJson("windows/activities/1197/task_item.csb")
	...
	var_9_5:getChildByName("text_task"):setString(string.format(var_0_3:desc(var_9_0), xyd.tables.hero:name(var_0_8), var_0_3:req(var_9_0)))
	...
	elseif arg_9_0.details.mission_list[var_9_0].is_complete == 1 and not arg_9_0.selfPlayer:getHeroByTableID(var_0_8) and not arg_9_0.selfPlayer:getHeroByTableID(xyd.tables.hero:afterAwaken(var_0_8)) then
		...
		var_9_5:getChildByName("btn_get"):addTouchEventListener(function(arg_10_0, arg_10_1)
			...
			elseif arg_10_1 == ccui.TouchEventType.ended then
				...
				if xyd.ServerTime.get():getServerTime() >= arg_9_0.activity.start_time and xyd.ServerTime.get():getServerTime() < arg_9_0.activity.end_time then
					...
					arg_9_0.activitiesModel:getActivityReward(xyd.Activities.GirlTraining2, var_10_0, function(arg_11_0, arg_11_1)
						if arg_11_0 == xyd.error.OK then
							arg_9_0.selfPlayer:handleRewards(arg_11_1.awards)

							local var_11_0 = {
								activity_id = xyd.Activities.GirlTraining2
							}
							...
							xyd.ModelManager.get():loadModel(xyd.ModelType.ACTIVITIES):loadSingleActivity(var_11_0, function(arg_12_0, arg_12_1)
								if arg_12_0 == xyd.error.OK then
									...
									arg_9_0.activitiesModel:clearRedMarkState(xyd.Activities.GirlTraining2, 2)

									local var_12_0 = xyd.WindowManager.get():getWindow("activities")

									if var_12_0 and var_12_0.rightItems then
										var_12_0:updateRightCell(xyd.Activities.GirlTraining2)
									end
								end
							end)
						end
...
function var_0_0.playSound(arg_17_0)
	...
	local var_17_0 = xyd.tables.hero:clickDialog(var_0_8)
	local var_17_1 = xyd.tables.hero:dialogSounds(var_0_8)
	local var_17_2 = xyd.tables.hero:soundTimes(var_0_8)
	local var_17_3 = xyd.tables.hero:name(var_0_8)
