...
function var_0_0.layout(arg_12_0)
	arg_12_0.contentView_:nodeByName("btn_send"):addTouchEventListener(function(arg_13_0, arg_13_1)
		if arg_13_1 == ccui.TouchEventType.ended and arg_12_0.text and arg_12_0.text ~= "" then
...
function var_0_0.contentView(arg_25_0)
	if arg_25_0.contentView_ == nil then
		...
		arg_25_0.contentView_:setupContentView_(xyd.AssetLoader.get():loadNodeFromJson("windows/illusion/cooperation/chat_wnd.csb"))
...
function var_0_0.createChatMsgContent(arg_28_0, arg_28_1)
	...
	if arg_28_1.isOwnSend == 0 then
		var_28_1 = xyd.AssetLoader.get():loadNodeFromJson("windows/illusion/cooperation/chat_item_left.csb")
		...
		var_28_1 = xyd.AssetLoader.get():loadNodeFromJson("windows/illusion/cooperation/chat_item_right.csb")
		var_28_2 = var_28_1:getChildByName("container")
	...
	local var_28_11 = var_28_2:getChildByName("duihua_bg"):getContentSize().height + 34
