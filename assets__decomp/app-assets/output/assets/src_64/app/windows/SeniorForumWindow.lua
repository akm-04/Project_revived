local var_0_0 = class("SeniorForumWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.willOpen(arg_2_0, arg_2_1)
	...
	arg_2_0:nodeByName("title_txt"):setString(var_0_1:translation("SENIOR_FORUM_TITLE"))
...
function var_0_0.layout(arg_3_0)
	...
	arg_3_0:nodeByName("comment_btn"):addTouchEventListener(function(arg_4_0, arg_4_1)
		if arg_4_1 == ccui.TouchEventType.ended then
			...
			if not arg_3_0.hero:getHeroID() or arg_3_0.hero:getHeroID() < 0 then
				xyd.WindowManager.get():openWindow("toast", {
					message = var_0_1:translation("HERO_NOT_COLLECTED")
				})
			else
				local var_4_0 = {
					id = arg_3_0.hero:getHeroID(),
...
function var_0_0.createListContent(arg_10_0, arg_10_1)
	...
	var_10_2:getChildByName("vote_num"):setString(arg_10_1.like or "0")
	...
	var_10_2:getChildByName("hero_lev_txt"):setString("LV:" .. arg_10_1.hero_lev)
	var_10_2:getChildByName("hero_lev_txt"):setColor(xyd.color.HERO_QUALITY[arg_10_1.hero_color])
	var_10_2:getChildByName("hero_name_txt"):setString(arg_10_0.hero:getName() .. xyd.Color2Level[arg_10_1.hero_color])
	var_10_2:getChildByName("hero_name_txt"):setColor(xyd.color.HERO_QUALITY[arg_10_1.hero_color])
	var_10_2:getChildByName("domain_txt"):setString("S" .. arg_10_1.region)

	if arg_10_1.hero_color == 1 then
	...
	for iter_10_0 = 1, xyd.HERO_TOTAL_STARS do
		if iter_10_0 > arg_10_1.hero_star then
		...
		elseif arg_11_0.name == "ended" then
			...
			arg_10_0.library:addForumLike(var_11_0, function(arg_12_0, arg_12_1)
				if arg_12_0 == xyd.error.OK then
					...
					if arg_10_1.is_commented == 1 then
						var_12_0 = var_0_1:translation("CANCEL_LIKE_SUCCEED")
					end
...
function var_0_0.initEditBox(arg_15_0)
	...
	if not arg_15_0.message or arg_15_0.message == "" then
		arg_15_0:nodeByName("edit_desc"):setString(var_0_1:translation("VIEW_MSG"))
...
function var_0_0.inputboxEventHandler(arg_16_0, arg_16_1)
	...
	if arg_16_1 == "return" then
		...
		if var_16_0 == "" then
			...
			arg_16_0:nodeByName("edit_desc"):setString(var_0_1:translation("VIEW_MSG"))
