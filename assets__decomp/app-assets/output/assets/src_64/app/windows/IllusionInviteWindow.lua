local var_0_0 = class("IllusionInviteWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.layout(arg_4_0)
	...
	arg_4_0:nodeByName("text_title"):setString(var_0_1:translation("ILLUSION_TEAM_TIPS_9"))
	arg_4_0:nodeByName("region_txt"):setString(var_0_1:translation("ILLUSION_INVITE_TXT1"))
	arg_4_0:nodeByName("guild_txt"):setString(var_0_1:translation("ILLUSION_INVITE_TXT2"))
end

function var_0_0.initFriends(arg_5_0)
	local var_5_0 = arg_5_0.socialSystem.friendlist
	local var_5_1 = {}
	local var_5_2 = xyd.tables.functionOpen:level(xyd.FunctionID.ID_ILLUSION)
	local var_5_3 = arg_5_0.illusion:getPlayerInfo(1)
	local var_5_4 = xyd.tables.misc.paradiseTeamLimit
	local var_5_5 = math.max(var_5_2, var_5_3.lev - var_5_4)
	local var_5_6 = var_5_3.lev + var_5_4

	for iter_5_0 = 1, #var_5_0 do
		if var_5_5 <= var_5_0[iter_5_0].lev and var_5_6 >= var_5_0[iter_5_0].lev then
			table.insert(var_5_1, var_5_0[iter_5_0])
		end
	end

	arg_5_0.friendList_ = var_5_1
end
...
function var_0_0.setButtonClick(arg_6_0)
	xyd.addTouchEvent(arg_6_0:nodeByName("btn_region"), function()
		...
		if arg_6_0.messageManager.chatLimit[5] and arg_6_0.messageManager.chatLimit[5] > 0 then
			...
			local var_7_0 = arg_6_0.illusion:getPlayerInfo(1)
			local var_7_1 = {
				room_id = arg_6_0.illusion:getRoomID(),
				type = xyd.ChatTextType.ILLUSION,
				boss_name = xyd.tables.illusionCampaign:name(arg_6_0.illusion.id),
	...
	xyd.addTouchEvent(arg_6_0:nodeByName("btn_guild"), function()
		if arg_6_0.messageManager:hasLeague() == true then
			local var_8_0 = arg_6_0.illusion:getPlayerInfo(1)
			local var_8_1 = {
				room_id = arg_6_0.illusion:getRoomID(),
				type = xyd.ChatTextType.ILLUSION,
				boss_name = xyd.tables.illusionCampaign:name(arg_6_0.illusion.id),
...
function var_0_0.initInviteItem(arg_12_0, arg_12_1, arg_12_2)
	...
	local var_12_1 = xyd.AssetLoader.get():loadNodeFromJson("windows/illusion/cooperation_new/invite_item.csb")
	...
	xyd.nodeEventSample(var_12_2:getChildByName("btn_invite"), nil, function()
		...
		arg_12_0.illusion:inviteFriend(var_12_0.player_id, function(arg_14_0, arg_14_1)
			if arg_14_0 == xyd.error.OK then
				arg_12_0.illusion:addInvitedList(var_12_0.player_id)
	...
	if arg_12_0.illusion:checkIsInvited(var_12_0.player_id) then
		var_12_2:getChildByName("img_already_invite"):setVisible(true)
		var_12_2:getChildByName("btn_invite"):setVisible(false)
	else
	...
	var_12_2:getChildByName("btn_invite"):getChildByName("txt_invite"):setString(var_0_1:translation("ILLUSION_INVITE_FRIEND_TXT2"))
end
