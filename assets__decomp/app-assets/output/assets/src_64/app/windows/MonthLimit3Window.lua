...
local var_0_1 = class("MonthLimit3Window", import("app.windows.GardenSeedWindow"))
local var_0_2 = xyd.tables.translation
local var_0_3 = xyd.tables.activityMonthLimit3
local var_0_4 = import("framework.scheduler")

function var_0_1.getActivityInfo(arg_1_0)
	arg_1_0.activity = arg_1_0.activitiesModel:getActivityInfo(xyd.Activities.MonthLimit3)
...
function var_0_1.loadItem(arg_4_0)
	return xyd.AssetLoader.get():loadNodeFromJson("windows/month_limit3/item.csb")
end
