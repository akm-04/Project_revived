local var_0_0 = class("NewArenaRecordWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.willOpen(arg_2_0, arg_2_1)
	...
	arg_2_0:nodeByName("txt_title"):setString(var_0_3:translation("FIGHT_RECORD"))
	...
	for iter_6_0, iter_6_1 in pairs(arg_6_0.records) do
		...
		if arg_6_0.type == xyd.CampaignType.ARENA then
			if iter_6_1.attack_name then
				...
				local var_6_5 = xyd.AssetLoader.get():loadNodeFromJson("windows/arena/record/new_record_item.csb")
				local var_6_6 = var_6_5:getChildByName("container")
				local var_6_7 = var_6_6:getChildByName("win"):getChildByName("txt_win")
				local var_6_8 = var_6_6:getChildByName("lose"):getChildByName("txt_lose")

				var_6_7:setString(var_0_3:translation("TOP_BATTLE_TEXT1"))
				var_6_7:enableOutline(cc.c4b(19, 112, 29, 255), 2)
				var_6_8:setString(var_0_3:translation("TOP_BATTLE_TEXT2"))
				var_6_8:enableOutline(cc.c4b(147, 24, 24, 255), 2)
				...
				if tonumber(iter_6_1.is_attack) == 1 and tonumber(iter_6_1.defend_avatar) ~= 0 then
					local var_6_9 = {
						...
						callback = var_6_2,
						level = iter_6_1.defend_lev,
						conquerLev = iter_6_1.defend_conquer_lev,
						conquerLoopID = iter_6_1.defend_conquer_loop_id
					}
				...
				elseif tonumber(iter_6_1.is_attack) == 1 and tonumber(iter_6_1.defend_avatar) == 0 then
					...
					xyd.setPlayerAvatar(var_6_6:getChildByName("avatar"), var_6_10)
					var_6_6:getChildByName("text_player_name"):setString(iter_6_1.defend_name)
				else
					local var_6_11 = {
						showLevel = true,
						...
						callback = var_6_2,
						level = iter_6_1.attack_lev,
						conquerLev = iter_6_1.attack_conquer_lev,
						conquerLoopID = iter_6_1.attack_conquer_loop_id
					}

					xyd.setPlayerAvatar(var_6_6:getChildByName("avatar"), var_6_11)
					var_6_6:getChildByName("text_player_name"):setString(iter_6_1.attack_name)
				end

				local var_6_12 = var_6_6:getChildByName("win")
				local var_6_13 = var_6_6:getChildByName("lose")
				local var_6_14 = cc.p(var_6_12:getPosition())

				if tonumber(iter_6_1.win) == 1 then
					var_6_12:setVisible(true)
					var_6_12:setPosition(var_6_14.x, var_6_14.y + 20)
					var_6_13:setVisible(false)
				else
					var_6_13:setVisible(true)
					var_6_13:setPosition(var_6_14.x, var_6_14.y + 20)
					var_6_12:setVisible(false)
				end

				local var_6_15 = var_6_6:getChildByName("mode_name")

				if iter_6_1.mode then
					var_6_15:setString(xyd.tables.arenaMode:title(iter_6_1.mode))
				else
					var_6_15:setColor(cc.c3b(125, 51, 0))
					var_6_15:setString(var_0_3:translation("ARENA_REPORT_DESC"))
				end

				if iter_6_1.time then
					local var_6_16 = xyd.ServerTime.get():getServerTime() - iter_6_1.time

					var_6_6:getChildByName("text_time"):setString(xyd.secondsToString(var_6_16, {
						short = true,
						toText = true
					}) .. xyd.tables.translation:translation("BEFORE"))
				end

				local var_6_17 = var_6_6:getContentSize()

				var_6_5:setPosition(cc.p(5, 0))
				var_6_5:setContentSize(var_6_17.width + 15, var_6_17.height)
				...
				local var_6_18 = var_6_6:getChildByName("share_btn")
				local var_6_19 = var_6_6:getChildByName("replay_btn")

				var_6_19:getChildByName("replay"):setVisible(true)
				var_6_19:getChildByName("select"):setVisible(false)
				var_6_18:addTouchEventListener(function(arg_10_0, arg_10_1)
				...
				local function var_6_20(arg_11_0)
				...
				var_6_19:addTouchEventListener(function(arg_13_0, arg_13_1)
		...
		elseif arg_6_0.type == xyd.CampaignType.SUPER_ARENA then
			...
			local var_6_23 = arg_6_0.recordList_:newItem()
			local var_6_24 = arg_6_0:createPeakItem(iter_6_1)

			var_6_22:addChild(var_6_24)
			var_6_22:setContentSize(cc.size(arg_6_0.recordList_.viewRect_.width, var_6_24:getContentSize().height + 5))
			var_6_23:addContent(var_6_22)
			var_6_23:setItemSize(arg_6_0.recordList_.viewRect_.width, var_6_22:getContentSize().height)
			arg_6_0.recordList_:addItem(var_6_23)
		elseif arg_6_0.type == xyd.CampaignType.SUPER_ARENA_OLD then
			local var_6_25 = {}

			if iter_6_1.attacker_name then
				local var_6_26 = display.newNode()
				local var_6_27 = arg_6_0.recordList_:newItem()
				local var_6_28 = xyd.AssetLoader.get():loadNodeFromJson("windows/arena/record/new_record_item.csb")
				local var_6_29 = var_6_28:getChildByName("container")
				local var_6_30 = var_6_29:getChildByName("win"):getChildByName("txt_win")
				local var_6_31 = var_6_29:getChildByName("lose"):getChildByName("txt_lose")

				var_6_30:setString(var_0_3:translation("TOP_BATTLE_TEXT1"))
				var_6_30:enableOutline(cc.c4b(19, 112, 29, 255), 2)
				var_6_31:setString(var_0_3:translation("TOP_BATTLE_TEXT2"))
				var_6_31:enableOutline(cc.c4b(147, 24, 24, 255), 2)
				...
				if tonumber(iter_6_1.is_attack) == 1 and tonumber(iter_6_1.defencer_avatar) ~= 0 then
					...
					local var_6_33 = {
						...
						level = iter_6_1.defencer_lev,
						conquerLev = iter_6_1.defencer_conquer_lev,
						conquerLoopID = iter_6_1.defencer_conquer_loop_id
					}

					xyd.setPlayerAvatar(var_6_29:getChildByName("avatar"), var_6_33)
					var_6_29:getChildByName("text_player_name"):setString(iter_6_1.defencer_name)
				elseif tonumber(iter_6_1.is_attack) == 1 and tonumber(iter_6_1.defencer_avatar) == 0 then
					...
					xyd.setPlayerAvatar(var_6_29:getChildByName("avatar"), var_6_35)
					var_6_29:getChildByName("text_player_name"):setString(iter_6_1.defencer_name)
				else
					local var_6_36 = {
						"attack"
					...
					local var_6_37 = {
						...
						level = iter_6_1.attacker_lev,
						conquerLev = iter_6_1.attacker_conquer_lev,
						conquerLoopID = iter_6_1.attacker_conquer_loop_id
					}

					xyd.setPlayerAvatar(var_6_29:getChildByName("avatar"), var_6_37)
					var_6_29:getChildByName("text_player_name"):setString(iter_6_1.attacker_name)
				end

				if tonumber(iter_6_1.win) == 1 then
					var_6_29:getChildByName("win"):setVisible(true)
					var_6_29:getChildByName("lose"):setVisible(false)
				else
					var_6_29:getChildByName("win"):setVisible(false)
					var_6_29:getChildByName("lose"):setVisible(true)
				end

				if iter_6_1.time then
					local var_6_38 = xyd.ServerTime.get():getServerTime() - iter_6_1.time

					var_6_29:getChildByName("text_time"):setString(xyd.secondsToString(var_6_38, {
						short = true,
						toText = true
					}) .. xyd.tables.translation:translation("BEFORE"))
				end

				local var_6_39 = var_6_29:getContentSize()

				var_6_28:setPosition(cc.p(5, 0))
				var_6_28:setContentSize(var_6_39.width + 15, var_6_39.height)
				var_6_26:addChild(var_6_28)
				var_6_26:setContentSize(cc.size(arg_6_0.recordList_.viewRect_.width, var_6_28:getContentSize().height + 5))
				var_6_27:addContent(var_6_26)
				var_6_27:setItemSize(arg_6_0.recordList_.viewRect_.width, var_6_26:getContentSize().height)

				local var_6_40 = var_6_29:getChildByName("share_btn")
				local var_6_41 = var_6_29:getChildByName("replay_btn")

				var_6_41:getChildByName("replay"):setVisible(false)
				var_6_41:getChildByName("select"):setVisible(true)
				var_6_29:getChildByName("data_btn"):setVisible(false)
				var_6_40:addTouchEventListener(function(arg_15_0, arg_15_1)
				...
				var_6_41:addTouchEventListener(function(arg_16_0, arg_16_1)
				...
				arg_6_0.recordList_:addItem(var_6_27)
			end
		elseif arg_6_0.type == xyd.CampaignType.REGION_CASUAL then
			local var_6_42 = {}

			if iter_6_1.player_name then
				local var_6_43 = display.newNode()
				local var_6_44 = arg_6_0.recordList_:newItem()
				local var_6_45 = xyd.AssetLoader.get():loadNodeFromJson("windows/arena/record/new_record_item.csb")
				local var_6_46 = var_6_45:getChildByName("container")
				local var_6_47 = var_6_46:getChildByName("win"):getChildByName("txt_win")
				local var_6_48 = var_6_46:getChildByName("lose"):getChildByName("txt_lose")

				var_6_47:setString(var_0_3:translation("TOP_BATTLE_TEXT1"))
				var_6_47:enableOutline(cc.c4b(19, 112, 29, 255), 2)
				var_6_48:setString(var_0_3:translation("TOP_BATTLE_TEXT2"))
				var_6_48:enableOutline(cc.c4b(147, 24, 24, 255), 2)
				...
				local var_6_49 = {
					...
					level = iter_6_1.player_lev,
					conquerLev = iter_6_1.conquer_lev,
					conquerLoopID = iter_6_1.conquer_loop_id
				}

				xyd.setPlayerAvatar(var_6_46:getChildByName("avatar"), var_6_49)
				var_6_46:getChildByName("text_player_name"):setString(iter_6_1.player_name)

				if tonumber(iter_6_1.is_win) == 1 then
					var_6_46:getChildByName("win"):setVisible(true)
					var_6_46:getChildByName("lose"):setVisible(false)
				else
					var_6_46:getChildByName("win"):setVisible(false)
					var_6_46:getChildByName("lose"):setVisible(true)
				end

				if iter_6_1.time then
					local var_6_50 = xyd.ServerTime.get():getServerTime() - iter_6_1.time

					var_6_46:getChildByName("text_time"):setString(xyd.secondsToString(var_6_50, {
						short = true,
						toText = true
					}) .. xyd.tables.translation:translation("BEFORE"))
				end

				local var_6_51 = var_6_46:getContentSize()

				var_6_45:setPosition(cc.p(5, 0))
				var_6_45:setContentSize(var_6_51.width + 15, var_6_51.height)
				var_6_43:addChild(var_6_45)
				var_6_43:setContentSize(cc.size(arg_6_0.recordList_.viewRect_.width, var_6_45:getContentSize().height + 5))
				var_6_44:addContent(var_6_43)
				var_6_44:setItemSize(arg_6_0.recordList_.viewRect_.width, var_6_43:getContentSize().height)

				local var_6_52 = var_6_46:getChildByName("share_btn")
				local var_6_53 = var_6_46:getChildByName("replay_btn")

				var_6_53:getChildByName("replay"):setVisible(false)
				var_6_53:getChildByName("select"):setVisible(true)
				var_6_46:getChildByName("data_btn"):setVisible(false)
				var_6_52:addTouchEventListener(function(arg_18_0, arg_18_1)
				...
				var_6_53:addTouchEventListener(function(arg_19_0, arg_19_1)
				...
				arg_6_0.recordList_:addItem(var_6_44)
			end
		end
	end
...
function var_0_0.createPeakItem(arg_21_0, arg_21_1)
	...
	local var_21_2 = xyd.AssetLoader.get():loadNodeFromJson("windows/arena/record/new_record_item.csb")
	local var_21_3 = var_21_2:getChildByName("container")
	local var_21_4 = var_21_3:getChildByName("win"):getChildByName("txt_win")
	local var_21_5 = var_21_3:getChildByName("lose"):getChildByName("txt_lose")

	var_21_4:setString(var_0_3:translation("TOP_BATTLE_TEXT1"))
	var_21_4:enableOutline(cc.c4b(19, 112, 29, 255), 2)
	var_21_5:setString(var_0_3:translation("TOP_BATTLE_TEXT2"))
	var_21_5:enableOutline(cc.c4b(147, 24, 24, 255), 2)

	local var_21_6 = arg_21_1.attack_player_info.player_id == arg_21_0.selfPlayer.playerID
	local var_21_7 = var_21_6 and var_21_1 or var_21_0
	local var_21_8 = {
		showLevel = true,
		is_new = true,
		avatar_id = var_21_7.avatar_id,
		avatar_frame_id = var_21_7.avatar_frame_id,
		level = var_21_7.lev,
		conquerLev = var_21_7.conquer_lev,
		conquerLoopID = var_21_7.conquer_loop_id
	}

	xyd.setPlayerAvatar(var_21_3:getChildByName("avatar"), var_21_8)
	var_21_3:getChildByName("text_player_name"):setString(var_21_7.player_name)

	local var_21_9

	if tonumber(arg_21_1.is_win) > 0 then
		var_21_9 = var_21_3:getChildByName("win")

		var_21_3:getChildByName("lose"):setVisible(false)
	else
		var_21_9 = var_21_3:getChildByName("lose")

		var_21_3:getChildByName("win"):setVisible(false)
	end

	var_21_9:setVisible(true)

	if arg_21_1.mode == 2 then
		local var_21_10 = cc.p(var_21_9:getPosition())

		var_21_9:setPosition(var_21_10.x, var_21_10.y + 20)
		var_21_3:getChildByName("mode_name"):setString(var_0_3:translation("LEGEND_PROMO_TEXT"))
	end

	if arg_21_1.time then
		local var_21_11 = xyd.ServerTime.get():getServerTime() - arg_21_1.time

		var_21_3:getChildByName("text_time"):setString(xyd.secondsToString(var_21_11, {
			short = true,
			toText = true
		}) .. xyd.tables.translation:translation("BEFORE"))
	end

	local var_21_12 = var_21_3:getContentSize()

	var_21_2:setPosition(cc.p(5, 0))
	var_21_2:setContentSize(var_21_12.width + 15, var_21_12.height)
	var_21_3:getChildByName("replay_btn"):getChildByName("replay"):setVisible(false)
	var_21_3:getChildByName("replay_btn"):getChildByName("select"):setVisible(true)
	...
	var_21_3:getChildByName("share_btn"):addTouchEventListener(function(arg_22_0, arg_22_1)
		...
		if arg_22_1 == ccui.TouchEventType.ended then
			local var_22_0 = {
				enemy_name = var_21_7.player_name,
