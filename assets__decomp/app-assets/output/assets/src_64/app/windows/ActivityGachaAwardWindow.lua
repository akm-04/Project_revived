...
function var_0_0.willOpen(arg_2_0, arg_2_1)
	...
	if arg_2_0.mode == var_0_6.ONE then
		...
		elseif var_2_0 == 2 then
			arg_2_0:nodeByName("rare"):loadTexture("windows/activities/1068/rare_txt.png")
		...
		elseif var_2_0 == 3 then
			arg_2_0:nodeByName("rare"):loadTexture("windows/activities/1068/epic_txt.png")
		end
	...
	local var_2_9 = "skeletons/ui_effect/activity_anniversary/gacha_open"
	local var_2_10 = var_0_4.new(var_2_9 .. ".json", var_2_9 .. ".atlas", 1)

	var_2_10:setAnchorPoint(cc.p(0.5, 0.5))

	local var_2_11 = arg_2_0:nodeByName("container")

	var_2_10:addTo(var_2_11)
	var_2_10:play(function()
		if arg_2_0.mode == var_0_6.ONE then
...
function var_0_0.star(arg_5_0, arg_5_1)
	return xyd.tables.activityGachaCollection:rarityById(arg_5_1)
end
