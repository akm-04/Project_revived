local var_0_0 = class("AllNightMapDetailWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0.mapCampaignType = xyd.CampaignType.ALL_NIGHT_MAP
...
function var_0_0.baseDefine(arg_4_0)
	...
	arg_4_0.campaignTable = xyd.tables.allNightCampaign
...
function var_0_0.updateEnemyPanel(arg_8_0)
	...
	local var_8_5 = xyd.tables.campaign:element(arg_8_0.campaignID)
	...
	for iter_8_0 = 1, #var_8_1 do
		...
		if iter_8_0 ~= #var_8_1 then
			var_8_6.isBoss = false

			var_8_7:setContentSize(90, 90)
			arg_8_0:nodeByName(arg_8_0.PANEL_ENEMY):addChild(var_8_7)
			var_8_7:setPosition(iter_8_0 * 100 - 50, 15)
		else
			var_8_6.isBoss = true

			var_8_7:setContentSize(107, 107)
			arg_8_0:nodeByName(arg_8_0.PANEL_ENEMY):addChild(var_8_7)
			var_8_7:setPosition(iter_8_0 * 100 - 50, 6)
		end

		if var_8_5 == {} then
			xyd.setAvatarBorderNewUI(var_8_1[iter_8_0], var_8_7, var_8_3[iter_8_0], var_8_2[iter_8_0])
		else
			xyd.setAvatarBorderNewUI(var_8_1[iter_8_0], var_8_7, var_8_3[iter_8_0], var_8_2[iter_8_0], nil, nil, nil, nil, nil, nil, var_8_5[iter_8_0])
		end

		var_8_6.id = var_8_1[iter_8_0]
		var_8_6.lev = var_8_4[iter_8_0]
		var_8_6.quality = var_8_3[iter_8_0]
		var_8_6.name = xyd.tables.hero:name(var_8_1[iter_8_0])
		var_8_6.desc = xyd.tables.hero:getDes(var_8_1[iter_8_0])
		var_8_6.isHero = true

		local var_8_8, var_8_9 = var_8_7:getPosition()
		...
		var_8_7:addNodeEventListener(cc.NODE_TOUCH_EVENT, function(arg_9_0)
			if arg_9_0.name == "began" then
				...
				if not var_9_0 then
					local var_9_2 = xyd.WindowManager.get():openWindow("new_item_tips", var_8_6)

					xyd.adaptToWorldPosition(var_8_7, var_9_2)
				end
...
function var_0_0.updateSweepPanel(arg_10_0)
	...
	var_10_1:getChildByName("once_button"):addTouchEventListener(function(arg_11_0, arg_11_1)
		if arg_11_1 == ccui.TouchEventType.ended then
			...
			var_11_2.campaign_type = xyd.CampaignType.ALL_NIGHT_MAP
	...
	if arg_10_0.mapCampaignType == xyd.CampaignType.ALL_NIGHT_MAP then
		var_10_4 = 10
	end
...
function var_0_0.updateStartBtn(arg_16_0)
	...
	arg_16_0:nodeByName(arg_16_0.START_BUTTON):addTouchEventListener(function(arg_17_0, arg_17_1)
		if arg_17_1 == ccui.TouchEventType.ended then
			...
			if arg_16_0.mapCampaignType == xyd.CampaignType.ALL_NIGHT_MAP then
				var_17_3 = xyd.SelectTeamType.ALL_NIGHT_MAP
			end
