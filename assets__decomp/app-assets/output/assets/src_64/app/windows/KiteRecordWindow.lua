local var_0_0 = class("KiteRecordWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.updateRecordList(arg_5_0)
	for iter_5_0 = 1, #arg_5_0.grabPlayers do
		...
		local var_5_5, var_5_6 = var_5_4:getChildByName("avatar_pos"):getPosition()
		local var_5_7 = display.newNode()

		var_5_4:getChildByName("avatar_kuang"):setVisible(false)
		var_5_7:setContentSize(90, 90)
		var_5_7:setPosition(var_5_5, var_5_6)
		var_5_7:setAnchorPoint(cc.p(0.5, 0.5))
		var_5_7:addTo(var_5_4)
		...
		xyd.setPlayerAvatar(var_5_7, var_5_8)
