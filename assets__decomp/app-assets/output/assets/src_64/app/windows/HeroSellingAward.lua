local var_0_0 = class("HeroSellingAward", import("app.common.ui.BaseWindow"))
local var_0_1 = xyd.tables.translation

function var_0_0.ctor(arg_1_0, arg_1_1, arg_1_2)
	var_0_0.super.ctor(arg_1_0, arg_1_1, arg_1_2)

	arg_1_0.choosenHeros = arg_1_2.choosenHeros
	arg_1_0.callback = arg_1_2.callback
	arg_1_0.details = arg_1_2.details
	arg_1_0.subIds = arg_1_0.details.sub_ids
...
function var_0_0.layout(arg_4_0)
	...
	local var_4_0 = xyd.splitToNumber(arg_4_0.subIds, "|") or {}
	...
	arg_4_0:nodeByName("ok_btn"):addTouchEventListener(function(arg_6_0, arg_6_1)
		if arg_6_1 == ccui.TouchEventType.ended then
			...
			arg_4_0.activitiesModel:getActivityReward(xyd.Activities.HeroSelling, arg_4_0.choosenGift, function(arg_7_0, arg_7_1)
				if arg_7_0 == xyd.error.OK then
					arg_4_0.details.sub_ids = arg_7_1.info.sub_ids
