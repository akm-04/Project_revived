local var_0_0 = class("FourthAnniGoldResultWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.didClose(arg_4_0, arg_4_1)
	...
	local var_4_0 = xyd.WindowManager.get():getWindow("gold_main")
...
function var_0_0.layout(arg_7_0)
	...
	if arg_7_0.btType == 2 then
		...
		local var_7_2 = xyd.tables.misc.activityAnni4thGoldDiamondCost
		local var_7_3 = arg_7_0.backpack:getItemNumByID(xyd.tables.misc.activityAnni4thGoldResetItem)
		...
		if var_7_3 > 0 then
			...
			xyd.setItemAndAddTips(arg_7_0:nodeByName("item_icon"), xyd.tables.misc.activityAnni4thGoldResetItem)
		end
	...
	arg_8_0:nodeByName("double_btn"):addTouchEventListener(function(arg_13_0, arg_13_1)
		...
		if arg_13_1 == ccui.TouchEventType.ended then
			...
			local function var_13_2()
				...
				arg_8_0.fourthAnni:fourthAnniGoldMul(var_15_0, function(arg_16_0, arg_16_1)
