local var_0_0 = class("ChocolateAwardGraphicTipWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.updateImg(arg_5_0)
	...
	arg_5_0.img = xyd.AssetLoader.get():loadSprite("windows/chocolate/rule/img" .. arg_5_0.nowPage .. ".png")
