local var_0_0 = class("ThirdDiglettSureExchangeWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.layout(arg_4_0)
	...
	local var_4_1 = var_0_3:itemNum(var_4_0)
	local var_4_2 = var_0_3:buyLimit(var_4_0)

	xyd.setItemAndAddTips(arg_4_0:nodeByName("icon_container"), arg_4_0.itemID, var_4_1)
	arg_4_0:nodeByName("name_txt"):setString(xyd.tables.item:name(arg_4_0.itemID))

	local var_4_3 = arg_4_0.selfPlayer:getBackpack():getItemNumByID(arg_4_0.itemID)
...
function var_0_0.updateNum(arg_5_0)
	...
	if not var_0_3:buyLimit(arg_5_0.id) then
		local var_5_0 = 0
	end

	local var_5_1 = arg_5_0.selfPlayer:getBackpack():getItemNumByID(arg_5_0.itemID)

	arg_5_0:nodeByName("own_num_txt"):setString(var_5_1)
	arg_5_0:nodeByName("progress_txt"):setVisible(false)
end

function var_0_0.getCanBuyNum(arg_6_0)
	arg_6_0.canBuyNum = math.floor(arg_6_0.diglettInfo.point / var_0_3:sellPrice(arg_6_0.id))
	...
	local var_6_1 = var_0_3:buyLimit(arg_6_0.id) - (arg_6_0.diglettInfo.exchange_times[arg_6_0.id] or 0)
...
function var_0_0.didOpen(arg_9_0)
	...
	local var_9_0 = cc.ui.UIPushButton.new({
		pressed = "windows/anniversary3rd_diglett/shop/btn_sub.png",
		disabled = "windows/anniversary3rd_diglett/shop/btn_sub.png",
		normal = "windows/anniversary3rd_diglett/shop/btn_sub.png"
	})
	...
	local var_9_2 = cc.ui.UIPushButton.new({
		pressed = "windows/anniversary3rd_diglett/shop/btn_add.png",
		disabled = "windows/anniversary3rd_diglett/shop/btn_add.png",
		normal = "windows/anniversary3rd_diglett/shop/btn_add.png"
	})
	...
	arg_9_0:nodeByName("exchange_btn"):addTouchEventListener(function(arg_18_0, arg_18_1)
		if arg_18_1 == ccui.TouchEventType.ended then
			...
			arg_9_0.thirdAnniversary:thirdAnniDiglettExchange(var_18_1, function(arg_19_0, arg_19_1)
				if arg_19_0 == xyd.error.OK then
					arg_9_0.diglettInfo.exchange_times[arg_9_0.id] = (arg_9_0.diglettInfo.exchange_times[arg_9_0.id] or 0) + var_18_1.num
