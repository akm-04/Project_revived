local var_0_0 = class("Jigsaw2DetailWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.layout(arg_3_0)
	arg_3_0:nodeByName("title_txt"):setString(var_0_1:translation("JIGSAW2_DETAIL_TEXT"))
	...
	local var_3_0 = xyd.tables.ActivityJigsaw2:desc(arg_3_0.jigInfo.jigsaw_id)
	...
	if arg_3_0:isGotten() == true then
		...
		arg_3_0:nodeByName("progress_txt"):setString(arg_3_0.jigInfo.count .. "/" .. xyd.tables.ActivityJigsaw2:amount(arg_3_0.jigInfo.jigsaw_id))
	end

	local var_3_1 = "windows/jigsaw2/" .. "big_" .. arg_3_0.jigInfo.jigsaw_id .. ".png"
	...
	var_3_2:setRotation(30)

	local var_3_3 = arg_3_0:nodeByName("go_btn")

	var_3_3:getChildByName("txt"):setString(var_0_1:translation("BUTTON_NAME_GO"))
	var_3_3:addTouchEventListener(function(arg_4_0, arg_4_1)
		xyd.buttonScaleAnim(var_3_3, arg_4_1)

		if arg_4_1 == ccui.TouchEventType.ended then
			local var_4_0 = xyd.tables.ActivityJigsaw2:type(arg_3_0.jigInfo.jigsaw_id)
			...
			if var_4_0 == xyd.JigsawGetType.GASHAPON then
				arg_3_0.activities:loadActivities(function(arg_5_0)
					if arg_5_0 == xyd.error.OK then
						...
						if activities:isActivityOpen(xyd.Activities.GaCha2) then
							local var_5_0 = {
								default_table_id = xyd.Activities.GaCha2
							}

							xyd.WindowManager.get():openWindow("activities", var_5_0)
							arg_3_0:closeJigSaw2Windows()
						else
							if xyd.WindowManager.get():isWindowOpen("toast") then
								xyd.WindowManager.get():closeWindow("toast")
							end
...
function var_0_0.isGotten(arg_9_0)
	if arg_9_0.jigInfo.is_put == 1 or arg_9_0.jigInfo.count >= xyd.tables.ActivityJigsaw2:amount(arg_9_0.jigInfo.jigsaw_id) then
		return true
	else
		return false
	end
...
function var_0_0.closeJigSaw2Windows(arg_10_0)
	if xyd.WindowManager.get():isWindowOpen("jigsaw2") then
		xyd.WindowManager.get():closeWindow("jigsaw2")
	end
