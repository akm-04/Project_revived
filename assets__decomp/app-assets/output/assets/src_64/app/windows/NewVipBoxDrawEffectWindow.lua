local var_0_0 = class("NewVipBoxDrawEffectWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.init(arg_3_0)
	arg_3_0:nodeByName("txt_title"):setString(var_0_2:translation("ACTIVITY_1206_TEXT_2"))
...
function var_0_0.drawFinish(arg_5_0)
	xyd.ModelManager.get():loadModel(xyd.ModelType.SELF_PLAYER):handleRewards({
		...
		if arg_5_0.multiple then
			xyd.WindowManager.get():openWindow("new_vip_box_draw_extra", {
				award = {
					arg_5_0.awards[2]
				},
