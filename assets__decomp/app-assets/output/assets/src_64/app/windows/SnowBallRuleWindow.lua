local var_0_0 = class("SnowBallRuleWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.layout(arg_3_0)
	arg_3_0.scroll = arg_3_0:nodeByName("rule_container")
...
function var_0_0.createListContent(arg_5_0, arg_5_1)
	...
	if arg_5_1 == 1 then
		local var_5_1 = var_0_1:translation("ACTIVITY_SNOWBALL_RULE_TEXT1")
	...
	elseif arg_5_1 == 2 then
		return (arg_5_0:createSnowBallReward())
	elseif arg_5_1 == 3 then
		local var_5_3 = var_0_1:translation("ACTIVITY_SNOWBALL_RULE_TEXT2")
...
function var_0_0.createSnowBallReward(arg_7_0)
	local var_7_0 = display.newNode()

	var_7_0:setContentSize(726, 185)

	local var_7_1 = xyd.AssetLoader:get():loadSprite("windows/snow_ball/rabbit.png")
	local var_7_2 = {
		size = 22,
		color = cc.c3b(255, 255, 255)
	}
	...
	var_7_3:setString(var_0_1:translation("ACTIVITY_SNOWBALL_RULE_DESC1"))
	var_7_3:addTo(var_7_0)
	var_7_3:setAnchorPoint(cc.p(0.5, 0))
	var_7_3:setPosition(181.5, 30)
	var_7_1:addTo(var_7_0)
	var_7_1:setAnchorPoint(cc.p(0.5, 0.5))
	var_7_1:setPosition(181.5, 130)

	local var_7_4 = xyd.AssetLoader:get():loadSprite("windows/snow_ball/brid.png")
	local var_7_5 = {
		size = 22,
		color = cc.c3b(255, 255, 255)
	}
	...
	var_7_6:setString(var_0_1:translation("ACTIVITY_SNOWBALL_RULE_DESC2"))
	var_7_6:addTo(var_7_0)
	var_7_6:setAnchorPoint(cc.p(0.5, 0))
	var_7_6:setPosition(544.5, 30)
	var_7_4:addTo(var_7_0)
	var_7_4:setAnchorPoint(cc.p(0.5, 0.5))
	var_7_4:setPosition(544.5, 130)

	return var_7_0
end

function var_0_0.createHeadFrameReward(arg_8_0)
	local var_8_0 = xyd.tables.misc.snowBallRewardItem
	local var_8_1 = display.newNode()

	var_8_1:setContentSize(726, 100)
	...
	var_8_4:setPosition(cc.p(50, -40))
