local var_0_0 = class("PetAddExpTipWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.open(arg_1_0, arg_1_1)
	...
	return xyd.WindowManager.get():openWindow("pet_selfdrink_tip", var_1_0)
end
...
function var_0_0.close(arg_4_0)
	xyd.WindowManager.get():closeWindow("pet_selfdrink_tip", arg_4_0)
end
...
function var_0_0.didOpen(arg_5_0, arg_5_1)
	...
	xyd.nodeEventSample(arg_5_0:confirmButton_(), nil, function()
		xyd.playButtonSound()
		var_0_0.close(function()
			var_5_0(true)
		end)
	end)
	xyd.nodeEventSample(arg_5_0:rejectButton_(), nil, function()
		xyd.playButtonSound()
		var_0_0.close(function()
			var_5_0(false)
		end)
