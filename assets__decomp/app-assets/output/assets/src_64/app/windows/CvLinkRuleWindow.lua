local var_0_0 = class("CvLinkRuleWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.layout(arg_4_0)
	arg_4_0:nodeByName("title_txt"):setString(var_0_1:translation("ACTIVITY_CV_LINK_RULE_TITLE"))
	arg_4_0:nodeByName("title_txt"):enableOutline(cc.c4b(107, 89, 159, 255), 2)

	arg_4_0.list = cc.ui.UIListView.new({
		async = false,
		viewRect = cc.rect(0, 0, 568, 430),
		direction = cc.ui.UIListView.DIRECTION_VERTICAL,
		alignment = cc.ui.UIListView.ALIGNMENT_HCENTER
	}):addTo(arg_4_0:nodeByName("scroll")):onScroll(handler(arg_4_0, arg_4_0.scrollListener))
	...
	for iter_4_0 = 1, #var_4_0 do
		...
		var_4_3:setContentSize(568, var_4_0[iter_4_0]:getContentSize().height)
		var_4_3:addTo(var_4_1)
		var_4_1:setContentSize(568, var_4_0[iter_4_0]:getContentSize().height + 20)
		var_4_2:addContent(var_4_1)
		var_4_2:setItemSize(568, var_4_0[iter_4_0]:getContentSize().height + 20)
...
function var_0_0.createRuleLabel(arg_5_0)
	local var_5_0 = var_0_1:translation("ACTIVITY_CV_LINK_RULE_TEXT")
