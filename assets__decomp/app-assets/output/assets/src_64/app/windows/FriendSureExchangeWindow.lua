local var_0_0 = class("FriendSureExchangeWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.updateNum(arg_4_0)
	arg_4_0.canBuyNum = math.floor(arg_4_0.selfPlayer.friendshipCoin / xyd.tables.friendShopItem:price(arg_4_0.id))
	...
	if arg_4_0.canBuyNum > xyd.tables.misc.friendBuyLimit then
		arg_4_0.canBuyNum = xyd.tables.misc.friendBuyLimit
	end
	...
	arg_4_0:nodeByName("cost_num_txt"):setString(arg_4_0.buyNum * xyd.tables.friendShopItem:price(arg_4_0.id))
end
...
function var_0_0.didOpen(arg_7_0)
	...
	arg_7_0:nodeByName("exchange_btn"):addTouchEventListener(function(arg_17_0, arg_17_1)
		...
		if arg_17_1 == ccui.TouchEventType.ended then
			...
			arg_7_0.socialSystem:exchangeItems(var_17_0, function(arg_18_0, arg_18_1)
				if arg_18_0 == xyd.error.OK then
					if arg_18_1 and arg_18_1.awards then
						local var_18_0 = arg_7_0:summaryAwards(arg_18_1.awards)
