...
function var_0_0.layout(arg_4_0)
	arg_4_0:nodeByName("top_text"):setString(var_0_1:translation("SUPER_RICH_SELECT_PIPE_TEXT"))
...
function var_0_0.updateItems(arg_9_0)
	...
	for iter_9_0 = 1, var_0_3 do
		...
		var_9_0:setPosition((iter_9_0 - 1) % 3 * 140 - 20 + 66.5, -math.floor((iter_9_0 - 1) / 3) * 130 - 120 + 66.5)
...
function var_0_0.updateSelectShow(arg_11_0)
	for iter_11_0, iter_11_1 in pairs(arg_11_0.items) do
		...
		if arg_11_0.selectPoint == iter_11_1.point then
			var_11_0:getChildByName("item_bg"):setVisible(false)
			var_11_0:getChildByName("item_bg_touch"):setVisible(true)
		else
			var_11_0:getChildByName("item_bg"):setVisible(true)
			var_11_0:getChildByName("item_bg_touch"):setVisible(false)
		end
	end
end

function var_0_0.createItem(arg_12_0, arg_12_1)
	local var_12_0 = xyd.AssetLoader.get():loadNodeFromJson(var_0_2 .. "item.csb")
	local var_12_1 = var_12_0:getChildByName("container")

	var_12_0:setAnchorPoint(cc.p(0.5, 0.5))
	var_12_1:getChildByName("item_bg"):setVisible(true)

	if arg_12_1 == 1 or arg_12_1 == 2 then
		var_12_1:getChildByName("pip_line_gray"):setVisible(true)
		var_12_0:setRotation(90 * (arg_12_1 - 1))
	else
		var_12_1:getChildByName("pip_angle_gray"):setVisible(true)
		var_12_0:setRotation(90 * (arg_12_1 - 3))
	end
