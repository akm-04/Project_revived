local var_0_0 = class("HeroSendGiftRuleWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.layout(arg_4_0)
	arg_4_0:nodeByName("title"):setString(var_0_1:translation("LIBBRAY_GIFT_RULE_TITLE"))
	...
	arg_4_0:nodeByName("left_hua"):setPositionX(arg_4_0:nodeByName("left_hua"):getPositionX() - 20)
	arg_4_0:nodeByName("right_hua"):setPositionX(arg_4_0:nodeByName("right_hua"):getPositionX() + 20)
	...
	var_4_0:addTo(var_4_3)
	var_4_0:setAnchorPoint(cc.p(0, 0))
	var_4_0:setPosition(0, 0)
	var_4_3:setContentSize(700, var_4_0:getContentSize().height)
	var_4_3:addTo(var_4_1)
	var_4_1:setContentSize(700, var_4_0:getContentSize().height + 20)
	var_4_2:addContent(var_4_1)
	var_4_2:setItemSize(700, var_4_0:getContentSize().height + 20)
	arg_4_0.list:addItem(var_4_2)
	arg_4_0.list:reload()
end

function var_0_0.createRuleLabel(arg_6_0)
	local var_6_0 = var_0_1:translation("LIBBRAY_GIFT_RULE")
	local var_6_1 = {
		size = 24,
