local var_0_0 = class("RagnarokMapDetailWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	arg_1_0.mapCampaignType = xyd.CampaignType.RAGNAROK_MAP
...
function var_0_0.baseDefine(arg_4_0)
	...
	arg_4_0.campaignTable = xyd.tables.ragnarokMapCampaignTable
...
function var_0_0.updateEquipPanel(arg_6_0)
	...
	local var_6_2 = arg_6_0.campaignTable:firstDisplay(arg_6_0.campaignID)

	if arg_6_0.star == 0 and var_6_2 and next(var_6_2) then
		var_6_1 = var_6_2

		arg_6_0:nodeByName(arg_6_0.EQUIP_TXT):setString(var_0_1:translation("ACTIVITY_MAP_FIRST_DROP_TXT"))
	end
	...
	for iter_6_0 = 1, #var_6_1 do
		local var_6_3 = cc.Node:create()
		local var_6_4 = display.newNode()
		local var_6_5 = arg_6_0.listview:newItem()

		var_6_3:setContentSize(var_6_0, var_6_0)

		if var_6_1[iter_6_0] == -1 then
			xyd.setItemBorder(var_6_3, -1, nil, nil, starGift)
			xyd.setItemStarOnTop(var_6_3, 3)
		else
			xyd.setItemBorder(var_6_3, var_6_1[iter_6_0])
		end
		...
		var_6_6.noBlock = true

		arg_6_0:addTips(var_6_3, var_6_6)
		var_6_4:addChild(var_6_3)
		var_6_3:setPosition(0, 0)
		var_6_4:setContentSize(var_6_0 + 5, var_6_0)
		var_6_5:addContent(var_6_4)
		var_6_5:setItemSize(var_6_0 + 5, var_6_0)
		arg_6_0.listview:addItem(var_6_5)
	end
...
function var_0_0.updateEnemyPanel(arg_8_0)
	...
	arg_8_0:nodeByName(arg_8_0.ENEMY_TXT):setString(var_0_1:translation("ACTIVITY_MAP_ENEMY_INFO_TXT"))

	local var_8_0 = arg_8_0.campaignTable:monsterDisplay(arg_8_0.campaignID)
	local var_8_1 = arg_8_0.campaignTable:monsterStar(arg_8_0.campaignID)
	local var_8_2 = arg_8_0.campaignTable:monsterQuality(arg_8_0.campaignID)
	local var_8_3 = arg_8_0.campaignTable:monsterLevel(arg_8_0.campaignID)
	local var_8_4 = xyd.tables.campaign:element(arg_8_0.campaignID)
	...
	for iter_8_0 = 1, #var_8_0 do
		...
		if iter_8_0 ~= #var_8_0 then
			...
			var_8_6:setPosition(iter_8_0 * 100 - 50, 15)
		else
			var_8_5.isBoss = true

			var_8_6:setContentSize(107, 107)
			arg_8_0:nodeByName(arg_8_0.PANEL_ENEMY):addChild(var_8_6)
			var_8_6:setPosition(iter_8_0 * 100 - 50, 6)
		end

		if var_8_4 == {} then
			xyd.setAvatarBorderNewUI(var_8_0[iter_8_0], var_8_6, var_8_2[iter_8_0], var_8_1[iter_8_0])
		else
			xyd.setAvatarBorderNewUI(var_8_0[iter_8_0], var_8_6, var_8_2[iter_8_0], var_8_1[iter_8_0], nil, nil, nil, nil, nil, nil, var_8_4[iter_8_0])
		end

		var_8_5.id = var_8_0[iter_8_0]
		var_8_5.lev = var_8_3[iter_8_0]

		dump(var_8_5.lev)

		var_8_5.quality = var_8_2[iter_8_0]
		var_8_5.name = xyd.tables.hero:name(var_8_0[iter_8_0])
		var_8_5.desc = xyd.tables.hero:getDes(var_8_0[iter_8_0])
		var_8_5.stars = var_8_1[iter_8_0]
		var_8_5.isHero = true
		var_8_5.elements = var_8_4[iter_8_0]
...
function var_0_0.updateSweepPanel(arg_10_0)
	...
	var_10_1:getChildByName("once_button"):addTouchEventListener(function(arg_11_0, arg_11_1)
		if arg_11_1 == ccui.TouchEventType.ended then
			...
			var_11_2.campaign_type = xyd.CampaignType.RAGNAROK_MAP
	...
	if arg_10_0.mapCampaignType == xyd.CampaignType.RAGNAROK_MAP then
		var_10_4 = 10
	end
...
function var_0_0.updateStartBtn(arg_16_0)
	...
	arg_16_0:nodeByName(arg_16_0.START_BUTTON):addTouchEventListener(function(arg_17_0, arg_17_1)
		if arg_17_1 == ccui.TouchEventType.ended then
			...
			if arg_16_0.mapCampaignType == xyd.CampaignType.RAGNAROK_MAP then
				var_17_3 = xyd.SelectTeamType.RAGNAROK_MAP
			end
