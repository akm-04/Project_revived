local var_0_0 = class("ZhugeliangGraphicWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.willOpen(arg_2_0, arg_2_1)
	arg_2_0:nodeByName("title"):setString(var_0_1:translation("ZHUGE_GRAPHIC_TITLE"))
...
function var_0_0.updateImg(arg_5_0)
	...
	arg_5_0.img = xyd.AssetLoader.get():loadSprite("windows/zhugeliang/small_house/graphic/img" .. arg_5_0.nowPage .. ".png")
