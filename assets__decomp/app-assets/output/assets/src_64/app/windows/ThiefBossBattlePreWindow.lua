local var_0_0 = class("ThiefBossBattlePreWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.layout(arg_3_0)
	...
	if arg_3_0.NianBoss.total_rank <= 50 then
		arg_3_0:nodeByName("reward_2_num_text"):setString(xyd.tables.thiefBossReward:getDiamond(arg_3_0.NianBoss.total_rank))
		arg_3_0:showAwardItems(arg_3_0.NianBoss.total_rank)
	else
		arg_3_0:nodeByName("reward_2_num_text"):setVisible(false)
		arg_3_0:nodeByName("zuanshi"):setVisible(false)
		arg_3_0:nodeByName("des_words"):setVisible(false)
		arg_3_0:nodeByName("reward_item_num1"):setVisible(false)
		arg_3_0:nodeByName("reward_item_num2"):setVisible(false)
		arg_3_0:nodeByName("reward_item1"):setVisible(false)
		arg_3_0:nodeByName("reward_item2"):setVisible(false)
		arg_3_0:nodeByName("award_none"):setVisible(true)
		arg_3_0:nodeByName("award_none"):setString(var_0_2:translation("THIEF_KEEP_RANK_NONREWARD"))
	end

	arg_3_0:nodeByName("rest_times"):setString(string.format(var_0_2:translation("TRIAL_LEFT_TIMES"), arg_3_0.NianBoss.challenge_times .. "/" .. 3))
end
...
function var_0_0.init(arg_4_0)
	...
	if arg_4_0.NianBoss.total_rank <= 50 then
		...
		arg_4_0:nodeByName("des_words"):setString(var_0_2:translation("THIEF_KEEP_RANK_NONREWARD"))
	end
end
...
function var_0_0.showAwardItems(arg_9_0, arg_9_1)
	if arg_9_1 > 50 then
		for iter_9_0 = 1, 2 do
			...
			arg_9_0:nodeByName("reward_" .. iter_9_0 .. "_num_text"):setVisible(false)
		end

		arg_9_0:nodeByName("jinbi"):setVisible(false)
		arg_9_0:nodeByName("zuanshi"):setVisible(false)

		return
	end

	local var_9_0 = xyd.tables.thiefBossReward:getItems(arg_9_1)
	local var_9_1 = xyd.tables.thiefBossReward:getItemNums(arg_9_1)

	if var_9_0 == 0 then
		for iter_9_1 = 1, 2 do
			arg_9_0:nodeByName("reward_item" .. iter_9_1):setVisible(false)
			arg_9_0:nodeByName("reward_item_num" .. iter_9_1):setVisible(false)
		end
	else
		for iter_9_2 = 1, #var_9_0 do
			local var_9_2 = display.newNode()
			local var_9_3 = arg_9_0:nodeByName("reward_item" .. iter_9_2)
			local var_9_4 = var_9_3:getContentSize().height

			var_9_2:setContentSize(var_9_4, var_9_4)
			xyd.setItemBorder(var_9_2, var_9_0[iter_9_2], false, false, 1)
			var_9_2:addTo(var_9_3)
			var_9_2:setAnchorPoint(cc.p(0, 0))
			arg_9_0:nodeByName("reward_item_num" .. iter_9_2):setString(var_9_1[iter_9_2])

			local var_9_5 = {
				id = var_9_0[iter_9_2],
				lev = xyd.tables.item:level(var_9_0[iter_9_2])
			}

			if xyd.tables.item:type(var_9_0[iter_9_2]) == -1 then
				var_9_5.tipsType = 0
				var_9_5.desc1 = xyd.tables.hero:getDes(var_9_0[iter_9_2])
			else
				var_9_5.tipsType = 1
				var_9_5.desc1 = xyd.tables.item:desc1(var_9_0[iter_9_2])
				var_9_5.desc2 = xyd.tables.item:desc2(var_9_0[iter_9_2])
			end

			var_9_5.hasNum = arg_9_0.player:getBackpack():getItemNumByID(var_9_0[iter_9_2])
			var_9_5.name = xyd.tables.item:name(var_9_0[iter_9_2])

			arg_9_0:addTips(var_9_2, var_9_5)
		end

		for iter_9_3 = #var_9_0 + 1, 2 do
			arg_9_0:nodeByName("reward_item" .. iter_9_3):setVisible(false)
			arg_9_0:nodeByName("reward_item_num" .. iter_9_3):setVisible(false)
		end
	end
end
	...
	arg_12_0:nodeByName("sweep_btn"):addTouchEventListener(function(arg_14_0, arg_14_1)
		if arg_14_1 == ccui.TouchEventType.ended then
			...
			if arg_12_0.NianBoss.challenge_times <= 0 then
				...
				xyd.CommonAlertWindow.open(xyd.CommonAlertType.TWO_BTN, var_0_2:translation("THIEF_BOSS_SWEEP"), function()
					arg_12_0.NianBoss:doSweep({
						campaign_id = arg_12_0.NianBoss.boss_id
					}, function(arg_16_0, arg_16_1)
						if arg_16_0 == xyd.error.OK then
							arg_12_0.awards = arg_16_1.award.awards
							...
							arg_12_0.NianBoss:loadNianBoss(function(arg_17_0, arg_17_1)
								if arg_17_0 == xyd.error.OK then
									...
									for iter_17_0, iter_17_1 in ipairs(arg_12_0.awards) do
										arg_12_0.player:getBackpack():addItemsByID(tonumber(iter_17_1.table_id), tonumber(iter_17_1.item_num))
									end

									xyd.WindowManager.get():openWindow("alert_award", {
										awards = arg_12_0.awards
									})
								end
							end)
						end
		...
		if arg_18_1 == ccui.TouchEventType.ended then
			...
			if arg_12_0.NianBoss.challenge_times <= 0 then
				...
				arg_12_0.guild:loadAllTeamHeros({}, function(arg_19_0)
					...
					local var_19_5 = {
						type = xyd.SelectTeamType.THIEF_BOSS,
						isMercenary = var_19_0,
						allTeamHeros = var_19_1,
						campaignID = arg_12_0.boss_id,
						campaignType = xyd.CampaignType.THIEF_BOSS,
