local var_0_0 = class("NewVipBoxDrawExtraWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.willOpen(arg_2_0, arg_2_1)
	arg_2_0:nodeByName("txt_title"):setString(var_0_2:translation("ACTIVITY_1206_TEXT_3"))
	arg_2_0:nodeByName("txt_scroll"):setString(var_0_2:translation("ACTIVITY_1206_TEXT_4"))
