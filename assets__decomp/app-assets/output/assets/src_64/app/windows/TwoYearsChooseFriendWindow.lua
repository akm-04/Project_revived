local var_0_0 = class("TwoYearsChooseFriendItem", function()
...
function var_0_0.contentView(arg_3_0)
	if arg_3_0.contentView_ == nil then
		...
		arg_3_0.contentView_:setupContentView_(xyd.AssetLoader.get():loadNodeFromJson("windows/activities/1117/friend_item.csb"))
...
function var_0_0.setParams(arg_4_0, arg_4_1)
	...
	if arg_4_1.conquer_lev and arg_4_1.conquer_lev > 0 then
		xyd.setConquerLev(arg_4_1.conquer_lev, arg_4_0.contentView_:nodeByName("lev"), arg_4_0.contentView_:nodeByName("level_bg"), {
			x = -2,
			y = 3
		}, nil, nil, nil, arg_4_1.conquer_loop_id)
	end
	...
	arg_4_0.contentView_:nodeByName("choose_btn"):addTouchEventListener(function(arg_5_0, arg_5_1)
		if arg_5_1 == ccui.TouchEventType.ended then
			arg_4_0.twoYearsModel:getFriendLimit({
				player_id = arg_4_1.player_id
			}, function(arg_6_0, arg_6_1)
				dump(arg_6_1)
				xyd.EventDispatcher.get():dispatchEvent({
					name = xyd.event.TWO_YEARS_CHOOSE_FRIEND,
					params = {
						friend_info = arg_4_1,
						limit = arg_6_1.recieve_num
					}
				})
				xyd.WindowManager.get():closeWindow("two_years_choose_friend")
			end)
		end
	end)
end

local var_0_5 = class("TwoYearsChooseFriendWindow", import("app.common.ui.BaseWindow"))
...
function var_0_5.ctor(arg_7_0, arg_7_1, arg_7_2)
	var_0_5.super.ctor(arg_7_0, arg_7_1, arg_7_2)

	arg_7_0.socialSystem = xyd.ModelManager.get():loadModel(xyd.ModelType.SOCIAL_SYSTEM)
	arg_7_0.twoYearsModel = xyd.ModelManager.get():loadModel(xyd.ModelType.TWO_YEARS)
	arg_7_0.activities = xyd.ModelManager.get():loadModel(xyd.ModelType.ACTIVITIES)
end

function var_0_5.willOpen(arg_8_0, arg_8_1)
	var_0_5.super.willOpen(arg_8_0, arg_8_1)
end

function var_0_5.didOpen(arg_9_0, arg_9_1)
	var_0_5.super.didOpen(arg_9_0, arg_9_1)
	arg_9_0:addBlockLayer()
	arg_9_0:layout()
end

function var_0_5.layout(arg_10_0)
	local var_10_0 = arg_10_0.activities:getActivityInfo(var_0_10)

	arg_10_0:nodeByName("txt_label"):setString(var_0_7:translation("ANNI2_TIPS_TXT17"))
	arg_10_0.socialSystem:loadFriends({}, function(arg_11_0, arg_11_1)
		if arg_11_0 == xyd.error.OK then
			local var_11_0 = arg_10_0.socialSystem.friendlist

			arg_10_0:initFriendList(var_11_0)
		end
	end)
end

function var_0_5.initFriendList(arg_12_0, arg_12_1)
	if not arg_12_0.listView_ then
		...
		}):addTo(arg_12_0:nodeByName("friend_list"))
	else
		arg_12_0.listView_:removeAllItems()
	end

	for iter_12_0, iter_12_1 in pairs(arg_12_1) do
		local var_12_0 = arg_12_0.listView_:newItem()
		local var_12_1 = var_0_0.new()

		var_12_1:setParams(iter_12_1)
		var_12_0:addContent(var_12_1)
		var_12_0:setItemSize(var_12_1:getContentSize().width, var_12_1:getContentSize().height)
		arg_12_0.listView_:addItem(var_12_0)
	end

	arg_12_0.listView_:reload()
end

function var_0_5.willClose(arg_13_0)
	return
end
