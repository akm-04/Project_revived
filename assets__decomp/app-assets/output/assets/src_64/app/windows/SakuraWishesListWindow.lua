local var_0_0 = class("SakuraWishesListWindow", import("app.common.ui.BaseWindow"))
local var_0_1 = xyd.tables.translation
local var_0_2 = xyd.tables.misc
local var_0_3 = xyd.tables.arenaMode
local var_0_4 = xyd.tables.activitySakuraWishesTable
...
function var_0_0.initCell(arg_11_0, arg_11_1, arg_11_2)
	...
	local var_11_1 = xyd.AssetLoader.get():loadNodeFromJson("windows/sakura_wishes/list/sakura_wishes_item.csb")
	...
	local function var_11_3()
		local var_12_0 = "windows/sakura_wishes/list/icon_star.png"
