...
function var_0_0.sortTables(arg_19_0, arg_19_1)
	table.sort(arg_19_1, function(arg_20_0, arg_20_1)
		if arg_20_0:getFirstTableID() == 10001251 or arg_20_1:getFirstTableID() == 10001251 then
			return arg_20_0:getTableID() == 10001251
		end
...
function var_0_0.initHeroCell(arg_22_0, arg_22_1, arg_22_2)
	...
	if var_22_0:getFirstTableID() == 10001251 then
