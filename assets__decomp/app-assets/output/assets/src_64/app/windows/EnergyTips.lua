...
function var_0_0.getRecoverTime(arg_4_0)
	local var_4_0, var_4_1 = arg_4_0.selfPlayer:getNextEnergyCoolTime()
	local var_4_2 = xyd.tables.misc.energyIncrTime / 60
...
function var_0_0.layout(arg_5_0)
	...
	local var_5_0 = arg_5_0.selfPlayer.buyEnergyTimes
	local var_5_1 = xyd.tables.vip:numEnergy(arg_5_0.selfPlayer.vip)

	if arg_5_0.selfPlayer.privilegeLeftCardDay > 0 then
		var_5_1 = var_5_1 + xyd.tables.monthlyPrivilege:numEnergy(1)
	end

	local var_5_2 = string.format(var_0_2:translation("BUY_ENERGY_TIMES"), var_5_0)

	arg_5_0:nodeByName(var_0_0.BUYENERGY_TIMES):setString(var_5_2 .. "/" .. var_5_1)

	if arg_5_0.selfPlayer.energy >= xyd.tables.player:maxEnergy(arg_5_0.selfPlayer.lev) then
		...
		local var_5_3 = var_0_2:translation("ALREADY_RECOVER")

		arg_5_0:nodeByName(var_0_0.RECOVER_DETAIL):setString(var_5_3)
	else
