local var_0_0 = class("AllNightMapStoryWindow", import("app.common.ui.BaseWindow"))
...
local var_0_6 = 2
local var_0_7 = 3
local var_0_8 = xyd.tables.allNightMapStoryTable
...
function var_0_0.onEnded(arg_19_0)
	...
	local var_19_0 = xyd.WindowManager.get():getWindow("all_night_map_story")

	if var_19_0 and not tolua.isnull(var_19_0) then
		xyd.WindowManager.get():closeWindow("all_night_map_story")
	end
end
