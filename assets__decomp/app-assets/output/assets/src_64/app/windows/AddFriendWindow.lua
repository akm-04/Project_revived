local var_0_0 = class("AddFriendWindow", import("app.common.ui.BaseWindow"))
...
function var_0_0.changeRecommendFriends(arg_8_0)
	arg_8_0.socialSystem:getRecommendFriends({}, function(arg_9_0, arg_9_1)
		if arg_9_0 == xyd.error.OK then
			arg_8_0.data = arg_9_1.list or {}
...
function var_0_0.createListContent(arg_11_0, arg_11_1)
	...
	if arg_11_0.socialSystem:isInFriendList(arg_11_1.player_id) or arg_11_0.socialSystem:isInBlackList(arg_11_1.player_id) or arg_11_1.player_id == arg_11_0.selfPlayer.playerID then
	...
	var_11_2:getChildByName("btn"):addTouchEventListener(function(arg_13_0, arg_13_1)
		...
		if arg_13_1 == ccui.TouchEventType.ended then
			...
			xyd.WindowManager.get():openWindow("input_authentic_msg", var_13_0)
		end
	end)
