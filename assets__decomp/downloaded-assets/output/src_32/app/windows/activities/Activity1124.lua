...
local var_0_2 = xyd.tables.activityHotSpring
...
function var_0_0.show(arg_3_0, arg_3_1)
	...
	arg_3_0:layout()
	arg_3_0.nodeDetail:getChildByName("btn_cp"):getChildByName("txt_cp"):setString(var_0_1:translation("ACTIVITY_1124_MID"))
	arg_3_0.nodeDetail:getChildByName("btn_yanliang"):getChildByName("txt_yanliang"):setString(var_0_1:translation("ACTIVITY_1124_LEFT"))
	arg_3_0.nodeDetail:getChildByName("btn_wenchou"):getChildByName("txt_wenchou"):setString(var_0_1:translation("ACTIVITY_1124_RIGHT"))
	...
	arg_3_0.nodeDetail:getChildByName("text"):getChildByName("charge_num"):enableOutline(cc.c4b(125, 188, 254, 255), 2)
end
...
function var_0_0.setButtonClick(arg_4_0)
	arg_4_0.nodeDetail:getChildByName("btn_rule"):addTouchEventListener(function(arg_5_0, arg_5_1)
		...
		if arg_5_1 == ccui.TouchEventType.ended then
			...
			local var_5_0 = {
				title_name = "ACTIVITY_1124_RULE_1",
				rule = "ACTIVITY_1124_RULE_2"
			}
				...
				elseif arg_4_0.details.award_str[arg_4_0.btnState] == 0 and arg_4_0.canGetState[arg_4_0.btnState] == 1 and arg_4_0.details.charge >= var_0_2:charge(arg_4_0.btnState) then
					if arg_4_0.btnState == var_0_6.yanliang and arg_4_0.details.award_str[var_0_6.wenchou] == 0 or arg_4_0.btnState == var_0_6.wenchou and arg_4_0.details.award_str[var_0_6.yanliang] == 0 then
						...
						xyd.CommonAlertWindow.open(xyd.CommonAlertType.TWO_BTN, var_9_1, function()
							local var_10_0 = {
								activity_id = xyd.Activities.HotSpring,
								award_id = arg_4_0.btnState
							}

							xyd.Backend.get():request(xyd.mid.ACTIVITY_1124_AWARD, var_10_0, function(arg_11_0, arg_11_1)
						...
						xyd.Backend.get():request(xyd.mid.ACTIVITY_1124_AWARD, var_9_2, function(arg_13_0, arg_13_1)
...
function var_0_0.layout(arg_15_0)
	arg_15_0.yanliang = xyd.AssetLoader.get():loadSprite("windows/activities/1124/michael.png")
	arg_15_0.wenchou = xyd.AssetLoader.get():loadSprite("windows/activities/1124/lucifer.png")

	arg_15_0.nodeDetail:addChild(arg_15_0.yanliang)
	arg_15_0.yanliang:setAnchorPoint(cc.p(0, 0))
	arg_15_0.yanliang:setPosition(-250, 0)
	...
	arg_15_0.wenchou:setPosition(330, 0)
